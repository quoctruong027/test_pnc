...
class VI_WPRODUCTBUILDER_Admin_Settings {
	...
	public function save_data() {
		...
		if ( isset( $_POST['message_body'] ) ) {
			$_POST['woopb_option-param']['message_body'] = $_POST['message_body'];
		}
		...
		update_option( 'woopb_option-param', $_POST['woopb_option-param'] );
        ...
        <div class="wrap woocommerce-product-builder">
            ...
            <form class="vi-ui form" method="post" action="">
                ...
                <div class="vi-ui top attached tabular menu">
                    ...
                    <a class="item "
                       data-tab="update"><?php esc_html_e( 'Update', 'woocommerce-product-builder' ) ?></a>
                </div>

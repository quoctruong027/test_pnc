...
class ETCPF_FeedRuleConcat extends ETCPF_FeedRule {
...
class ETCPF_FeedRuleDescription extends ETCPF_FeedRule {
...
class ETCPF_FeedRuleDiscount extends ETCPF_FeedRule {
	...
	public function process($product) {
		...
		if ($product->attributes['has_sale_price'] && floatval($product->attributes['sale_price']) < 0) {
...
//***********************************************************
class ETCPF_FeedRuleFindAndSet extends ETCPF_FeedRule {

	public function initialize() {
		parent::initialize();
		if (!isset($this->parameters[0])) //If haystack does not exist, do not proceed
		{
			return;
		}
...
class ETCPF_FeedRuleGooglecombotitle extends ETCPF_FeedRule {
...
class ETCPF_FeedRuleGoogleexacttitle extends ETCPF_FeedRule {

	public function process($product) {

		//Upper case the first character of each word in the title:
		//Etsy doesn't like block letters
...
//***********************************************************
class ETCPF_FeedRulePricestandard extends ETCPF_FeedRule {
...
class ETCPF_FeedRulePricerounding extends ETCPF_FeedRule {
...
class ETCPF_FeedRulePricedecimalseparator extends ETCPF_FeedRule {
...
class ETCPF_FeedRuleNoVariations extends ETCPF_FeedRule {
	...
	public function initialize() {
		...
		//all categories
		if (in_array('*', $this->parameters)) {
			$this->parent_feed->addAttributeDefault('allcat', $this_parameter, 'ETCPF_CatVar');
		} //individual categories
		else {
			foreach ($this->parameters as $this_parameter) {
				if (is_numeric($this_parameter)) {
					$this->parent_feed->addAttributeDefault('xVar', $this_parameter, 'ETCPF_CatVar');
				}
			}
...
class ETCPF_FeedRulePricegroup extends ETCPF_FeedRule {
...
class ETCPF_FeedRuleRemoveEmptyAttributes extends ETCPF_FeedRule {
...
class ETCPF_FeedRuleShipping extends ETCPF_FeedRule {
	...
	public function initialize() {
		...
		*/
		...
		if ($this->parent_feed->providerName == 'Etsy') {
...
class ETCPF_FeedRuleStatusstandard extends ETCPF_FeedRule {
...
class ETCPF_FeedRulePos extends ETCPF_FeedRule {
// public function initialize() {
	// 	$this->order = 190;
	// }
	public function process($product) {
...
//***********************************************************
class ETCPF_FeedRuleSetAll extends ETCPF_FeedRule {
...
class ETCPF_FeedRuleStrlen extends ETCPF_FeedRule {
...
class ETCPF_FeedRuleStrReplace extends ETCPF_FeedRule {
	...
	public function process($product) {
		...
		// 	return;
		if (count($this->parametersV) == 3) {
            $product->attributes[$this->parametersV[2]] = str_replace($this->parametersV[0], $this->parametersV[1], $product->attributes[$this->parametersV[2]]);
		}
...
class ETCPF_FeedRuleSubstr extends ETCPF_FeedRule {
...
class ETCPF_FeedRuleTax extends ETCPF_FeedRule {
	...
	public function initialize() {
		...
		if ($this->parent_feed->providerName == 'Etsy') {
			$this->parent_feed->addAttributeDefault('tax', 'none', 'ETCPF_GoogleTax');
		}
...
class ETCPF_FeedRuleValidalways extends ETCPF_FeedRule {
...
class ETCPF_FeedRuleWeightunit extends ETCPF_FeedRule {
...
class ETCPF_FeedRuleDimensionunit extends ETCPF_FeedRule {
...
class ETCPF_FeedRuleStrip_tags extends ETCPF_FeedRule {
...
//***********************************************************
class ETCPF_FeedRuleRemoveAttributeCondition extends ETCPF_FeedRule {
...
class ETCPF_FeedRuleCSVStandard extends ETCPF_FeedRule {
 ...
 ***********/
class ETCPF_FeedRuleStrictAttribute extends ETCPF_FeedRule {
...
class ETCPF_FeedRuleFindIdentifiers extends ETCPF_FeedRule {
...
class ETCPF_FeedRuleGetSubcategory extends ETCPF_FeedRule {
	...
	public function process($post) {
		...
		usort($pnb_name_arr, function ($a, $b) {
...
class ETCPF_FeedRuleGetPipedImages extends ETCPF_FeedRule {
...
class ETCPF_FeedRuleExcludeoos extends ETCPF_FeedRule {

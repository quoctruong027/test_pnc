...
//        });
        ...
        $(document).on("change", ".discount-action", function (e)
        {
            ...
            {
                $(".percentage-row, .product-action-row, .shipping-action-row, .cheapest-product-row").hide();
                $(".free-gift-row").show();
            ...
            {
                $(".free-gift-row, .shipping-action-row, .cheapest-product-row").hide();
            ...
            else if (selected_value == "percentage-off-cprice" || selected_value == "fixed-amount-off-cprice" || selected_value == "percentage-off-lsubtotal" || selected_value == "fixed-amount-off-lsubtotal")
            {
                ...
                $(".percentage-row, .product-action-row, .cheapest-product-row").show();
                $(".wad-taxable").hide();
                $("#products-list").prop('required', true);
                $("#percentage-amount").prop('required', true);
                $("#shipping-list").prop('required', false);
            ...
            {
                $(".free-gift-row, .product-action-row, .cheapest-product-row").hide();
            ...
            {
                $(".free-gift-row, .product-action-row, .shipping-action-row, .cheapest-product-row").hide();
                $(".percentage-row").show();
                $("#products-list").prop('required', false);
                $("#percentage-amount").prop('required', true);
                $("#shipping-list").prop('required', false);

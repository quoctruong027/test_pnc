...
class Wad {
	...
	private function define_admin_hooks() {
		...
		$this->loader->add_action( 'admin_enqueue_scripts', $plugin_admin, 'enqueue_scripts' );
                ...
                //subscription 
                $this->loader->add_action( 'admin_notices', $plugin_admin, 'wad_get_subscription_notice' );
...
//                $this->loader->add_action( 'init', $plugin_public, 'register_shortcodes' );
                ...
                $this->loader->add_filter( 'woocommerce_add_cart_item_data', $discount, 'add_free_gift_meta_data', 10, 3 );
                // disable quantity selector for free gift on the cart
                $this->loader->add_filter( 'woocommerce_cart_item_quantity', $discount, 'get_free_gift_quantity_html', 10, 2 );
                ...
                $this->loader->add_action( 'woocommerce_review_order_before_payment', $discount, 'get_free_gifts_table'  );
                //add/remove free gift automatically in the cart
                $this->loader->add_action( 'template_redirect', $discount, 'update_free_gifts_in_cart' );
                ...
                //$this->loader->add_filter( 'woocommerce_cart_item_subtotal', $discount, 'get_free_gifts_item_subtotals', 10, 3 );
                ...
                //$this->loader->add_action( 'woocommerce_after_calculate_totals', $discount, 'increase_free_gifts_quantities_in_cart' );
                 ...
                 $this->loader->add_action( 'woocommerce_before_calculate_totals', $discount, 'get_cheapest_products' );
                 
				//subtotal in mini-cart review
				$this->loader->add_filter( 'woocommerce_cart_subtotal', $discount, 'get_cart_subtotal',10 );
                 $this->loader->add_filter( 'woocommerce_widget_cart_item_quantity', $discount, 'update_cart_items_price_html',10,2 );
                ...
                $this->loader->add_filter( 'woocommerce_shortcode_products_query', $discount, 'get_shortcode_products_query' );

                //Get shipping amount
                $this->loader->add_filter( 'woocommerce_shipping_rate_cost', $discount, 'get_shipping_amount',10 ,2);
                
                //show original price on cart
                $this->loader->add_filter( 'woocommerce_cart_item_price', $discount, 'show_original_price_on_cart', 30, 2 );
                $this->loader->add_filter( 'woocommerce_cart_item_subtotal', $discount, 'show_original_total_price_on_checkout', 30, 2 );
                
                //display the total products discount
                $this->loader->add_action( 'woocommerce_cart_totals_before_shipping', $discount, 'display_total_products_discount', 99);
                $this->loader->add_action( 'woocommerce_review_order_before_shipping', $discount, 'display_total_products_discount', 99);
	}

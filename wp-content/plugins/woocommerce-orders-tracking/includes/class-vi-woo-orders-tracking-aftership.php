...
if ( ! class_exists( 'VI_WOOCOMMERCE_ORDERS_TRACKING_AFTERSHIP' ) ) {
	class VI_WOOCOMMERCE_ORDERS_TRACKING_AFTERSHIP {
		...
		public function update( $tracking_number, $carrier_slug, $args ) {
			...
			if ( $this->service_carrier_api_key ) {
				...
				$request = wp_remote_request( $url, array(
					...
					'body'    => json_encode( array('tracking'=>$args) )
				) );
		...
		public static function status_text() {
			return array(
				'inforeceived'         => esc_html__( 'Info Received', 'woocommerce-orders-tracking' ),
				'pending'              => esc_html__( 'Pending', 'woocommerce-orders-tracking' ),
				'intransit'            => esc_html__( 'Intransit', 'woocommerce-orders-tracking' ),
				'available_for_pickup' => esc_html__( 'Available For Pickup', 'woocommerce-orders-tracking' ),
				'outfordelivery'       => esc_html__( 'Out For Delivery', 'woocommerce-orders-tracking' ),
				'failedattempt'        => esc_html__( 'Failed Attempt', 'woocommerce-orders-tracking' ),

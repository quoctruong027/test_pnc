				...
				<tr class="plugin-update-tr">
					<td colspan="<?php echo esc_attr( $wp_list_table->get_column_count() ) ?>"
						...
						<div class="notice inline notice-warning notice-alt">
							<p>
								<?php
								printf( wp_kses_post( __( 'New version of %1$s available. You can download or <a href="%2$s" class="thickbox" title="%3$s">view version %4$s</a>. Please make sure that you fill your purchased code in <a href="%5$s">Setting page</a>.' ) ),

		...
		if ( empty( $fields ) ) {
			...
			if ( ! $check_carrier_id && $check_has_carrier_id ) {
				$results[] = array(
					...
					'title' => esc_html__( '( Order Item ) Carrier Slug', 'woocommerce-orders-tracking' ),
				);
			}
			if ( ! $check_tracking_code && $check_has_tracking_code ) {
				$results[] = array(
					...
					'title' => esc_html__( '( Order Item ) Tracking Number', 'woocommerce-orders-tracking' ),
				);
			}
		}
	...
	public static function get_fields_to_select() {
		$field_other      = array(
			...
			array(
				'type'  => 'wotv_field',
				'key'   => 'carrier_url',
				'title' => esc_html__( '( Order Item ) Tracking URL', 'woocommerce-orders-tracking' ),
			),
			array(
				'type'  => 'wotv_field',
				'key'   => 'carrier_name',
				'title' => esc_html__( '( Order Item ) Carrier Name', 'woocommerce-orders-tracking' ),
			),
			array(
				'type'  => 'wotv_field',
				'key'   => 'order_note',

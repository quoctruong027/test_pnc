...
if ( ! class_exists( 'VI_WOOCOMMERCE_ORDERS_TRACKING_ADMIN_CRON_UPDATE_TRACKING' ) ) {
	class VI_WOOCOMMERCE_ORDERS_TRACKING_ADMIN_CRON_UPDATE_TRACKING {
		...
		public function admin_menu() {
			add_submenu_page( 'woocommerce-orders-tracking', esc_html__( 'Schedule Update', 'woocommerce-orders-tracking' ), esc_html__( 'Schedule Update', 'woocommerce-orders-tracking' ), 'manage_options', 'woocommerce-orders-tracking-cron-update-tracking', array(
				$this,
				'page_callback'
			) );
		}
		...
		public function admin_enqueue_scripts() {
			...
			if ( $pagenow === 'admin.php' && $page === 'woocommerce-orders-tracking-cron-update-tracking' ) {
				...
				wp_enqueue_style( 'woocommerce-orders-tracking-cron-update-tracking', VI_WOOCOMMERCE_ORDERS_TRACKING_CSS . 'cron-update-orders.css' );
				wp_enqueue_script( 'woocommerce-orders-tracking-cron-update-tracking', VI_WOOCOMMERCE_ORDERS_TRACKING_JS . 'cron-update-orders.js', array( 'jquery' ), VI_WOOCOMMERCE_ORDERS_TRACKING_VERSION );
			}
		}
	}
}
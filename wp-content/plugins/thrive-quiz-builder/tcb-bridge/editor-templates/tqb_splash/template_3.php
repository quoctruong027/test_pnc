<div class="thrv_wrapper tve-tqb-page-type tqb-splash-template-3 tve_editor_main_content" style="<?php echo $main_content_style; ?>">
	...
	<div class="tqb-hp2 thrv_wrapper thrv_heading thrv_text_element">
		<h3>We want your feedback about everything</h3>
	</div>

	<div class="thrv_wrapper thrv_text_element">
		<p>We're always working to make the best suite of marketing tools for your website. Your feedback helps us decide which features to build and what improvements should be made to our products.</p>
		<p>To help us make Thrive Themes the best it can be, we want your feedback today. Take a few minutes to fill out our survey and you'll be included in our draw to win $800 Apple voucher.</p>
	</div>

...
?>
<div data-css="tve-u-16d632405fa" class="thrv_wrapper tve-tqb-page-type tqb-optin-template-2 tve_editor_main_content" style="<?php echo $main_content_style; ?>">

	<div data-css="tve-u-16d2038b625" class="thrv_wrapper thrv-columns tve-draggable tve-droppable">
		<div data-css="tve-u-16d204198f1" class="tcb-flex-row tcb--cols--2">
			<div class="tcb-flex-col ui-resizable">
				<div data-css="tve-u-16d2038120d" class="tcb-col">
			...
			<div class="tcb-flex-col ui-resizable">
				<div data-css="tve-u-16d20383b95" class="tcb-col">
					<div class="thrv_wrapper thrv_contentbox_shortcode thrv-content-box tve-draggable tve-droppable" data-css="tve-u-15d9c601f22">
						...
						<div class="tve-cb tve_empty_dropzone" data-css="tve-u-15d9c6036f5">
									...
									<form action="#" method="post" novalidate="novalidate">
										<div class="tve_lead_generated_inputs_container tve_clearfix tve_empty_dropzone">
											<div class="tve_lg_input_container tve_lg_input tve-draggable tve-droppable" data-css="tve-u-15d9c5aced3">
												<input type="text" data-field="name" name="name" placeholder="Name" data-placeholder="Name" data-required="1">
											</div>
							...
							<div class="thrv_wrapper thrv_text_element tve-draggable tve-droppable tve_empty_dropzone">
								<p style="text-align: center;" class="tve-droppable" data-css="tve-u-15d9c642540">

        ...
        if (typeof(FileReader) != "undefined") {
            ...
            reader.onload = function(e) {
                ...
                var tracking_import = jQuery(trackings).each(function(index, element) {
                    ...
                    if (trackings[index]['send_email']) {
                        var send_email = trackings[index]['send_email'];
                    }

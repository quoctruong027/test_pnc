			...
			<tbody>							
				<tr valign="top" class="delivered_row <?php if(!get_option('wc_ast_status_delivered')){echo 'disable_row'; } ?>">
					...
					<td class="forminp">							
						...
						?>
						<fieldset>
							<input class="input-text regular-input color_input" type="text" name="wc_ast_status_label_color" id="wc_ast_status_label_color" style="" value="<?php echo get_option('wc_ast_status_label_color','#c9d7e1')?>" placeholder="">
							<select class="select custom_order_color_select" id="wc_ast_status_label_font_color" name="wc_ast_status_label_font_color">	
								<option value="#fff" <?php if(get_option('wc_ast_status_label_font_color','#000') == '#fff'){ echo 'selected'; }?>><?php _e( 'Light Font', 'woo-advanced-shipment-tracking' ); ?></option>
								<option value="#000" <?php if(get_option('wc_ast_status_label_font_color','#000') == '#000'){ echo 'selected'; }?>><?php _e( 'Dark Font', 'woo-advanced-shipment-tracking' ); ?></option>
							</select>
							...
							<a class='settings_edit' href="<?php echo wcast_initialise_customizer_email::get_customizer_url('customer_delivered_email'); ?>"><?php _e( 'edit email', 'woocommerce' ) ?></a>
						</fieldset>
					</td>
				</tr>
				<tr valign="top" class="partial_shipped_row <?php if(!get_option('wc_ast_status_partial_shipped')){echo 'disable_row'; } ?>">	
					...
					<td class="forminp">								
						...
						?>
						<fieldset>
							<input class="input-text regular-input color_input" type="text" name="wc_ast_status_partial_shipped_label_color" id="wc_ast_status_partial_shipped_label_color" style="" value="<?php echo get_option('wc_ast_status_partial_shipped_label_color','#c9d7e1')?>" placeholder="">
							<select class="select custom_order_color_select" id="wc_ast_status_partial_shipped_label_font_color" name="wc_ast_status_partial_shipped_label_font_color">									
								<option value="#fff" <?php if(get_option('wc_ast_status_partial_shipped_label_font_color','#000') == '#fff'){ echo 'selected'; }?>><?php _e( 'Light Font', 'woo-advanced-shipment-tracking' ); ?></option>
								<option value="#000" <?php if(get_option('wc_ast_status_partial_shipped_label_font_color','#000') == '#000'){ echo 'selected'; }?>><?php _e( 'Dark Font', 'woo-advanced-shipment-tracking' ); ?></option>
							</select>
							<label class="send_email_label">
								...
								<a class='settings_edit' href="<?php echo wcast_initialise_customizer_email::get_customizer_url('customer_partial_shipped_email'); ?>"><?php _e( 'edit email', 'woocommerce' ) ?></a>
						</fieldset>
					</td>
				</tr>
				<tr valign="top" class="updated_tracking_row <?php if(!get_option('wc_ast_status_updated_tracking')){echo 'disable_row'; } ?>">		
					...
					<td class="forminp">							
						...
						<fieldset>
							<input class="input-text regular-input color_input" type="text" name="wc_ast_status_updated_tracking_label_color" id="wc_ast_status_updated_tracking_label_color" style="" value="<?php echo get_option('wc_ast_status_updated_tracking_label_color','#c9d7e1')?>" placeholder="">
							<select class="select custom_order_color_select" id="wc_ast_status_updated_tracking_label_font_color" name="wc_ast_status_updated_tracking_label_font_color">									
								<option value="#fff" <?php if(get_option('wc_ast_status_updated_tracking_label_font_color','#000') == '#fff'){ echo 'selected'; }?>><?php _e( 'Light Font', 'woo-advanced-shipment-tracking' ); ?></option>
								<option value="#000" <?php if(get_option('wc_ast_status_updated_tracking_label_font_color','#000') == '#000'){ echo 'selected'; }?>><?php _e( 'Dark Font', 'woo-advanced-shipment-tracking' ); ?></option>
							</select>
							<label class="send_email_label">
							...
							<a class='settings_edit' href="<?php echo wcast_initialise_customizer_email::get_customizer_url('customer_updated_tracking_email'); ?>"><?php _e( 'edit email', 'woocommerce' ) ?></a>
						</fieldset>
					</td>
				</tr>

...
class wcast_onhold_customizer_email {
	...
	*/
	...
	public static function is_own_customizer_request() {
		return isset( $_REQUEST['email'] ) && $_REQUEST['email'] === 'customer_onhold_email';
	}	
	...
	*/
	...
	public function wcast_register_sample_default_controls( $wp_customize ) {		
		...
		*/
		...
		$wp_customize->add_setting( 'onhold_order_email_heading',
			array(
				'default' => '',
		...
		$wp_customize->add_control( new WP_Customize_Heading_Control( $wp_customize, 'onhold_order_email_heading',
			array(
				'label' => __( 'On Hold email', 'woo-advanced-shipment-tracking' ),
				'description' => '',
				'section' => 'customer_onhold_email'
			)
		) );		
		...
		$wp_customize->add_setting( 'wcast_onhold_email_preview_order_id',
			array(
				'default' => 'mockup',
				'transport' => 'refresh',				
				'sanitize_callback' => ''
		...
		$wp_customize->add_control( new Skyrocket_Dropdown_Select_Custom_Control( $wp_customize, 'wcast_onhold_email_preview_order_id',
			array(
	...
	*/
	public function preview_onhold_email(){
		...
		$preview_id     = get_theme_mod('wcast_onhold_email_preview_order_id');

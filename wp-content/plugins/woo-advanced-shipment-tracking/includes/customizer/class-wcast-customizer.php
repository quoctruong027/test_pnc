...
class WC_Advanced_Shipment_Tracking_Customizer {
	...
	*/
	...
	public function wcast_add_customizer_panels( $wp_customize ) {
		...
		*/
		...
		$wp_customize->add_panel( 'wcast_admin_emails_panel',
			array(
				'title' => __( 'Admin Notifications', 'woo-advanced-shipment-tracking' ),
				'description' => esc_html__( '', 'woo-advanced-shipment-tracking' )
			)
		);
	}
	...
	public function wcast_add_customizer_sections( $wp_customize ) {	
		...
		$wp_customize->add_section( 'ast_tracking_table_section',
			array(
				'title' => __( 'Table layout design', 'woo-advanced-shipment-tracking' ),
				'description' => '',
				'panel' => 'ast_tracking_display_panel'
			)
		);
		
		$wp_customize->add_section( 'ast_tracking_simple_section',
			array(
				'title' => __( 'Simple layout design', 'woo-advanced-shipment-tracking' ),
				'description' => '',
				'panel' => 'ast_tracking_display_panel'
			)
		);

	...
	public function wcast_register_sample_default_controls( $wp_customize ) {		
		...
		*/
		...
		$wp_customize->add_control( new WP_Customize_Heading_Control( $wp_customize, 'wcast_outfordelivery_email_settings[outfordelivery_order_email_heading]',
			array(
				'label' => __( 'Out For Delivery email', 'woo-advanced-shipment-tracking' ),
				'description' => '',
		...
		// Preview Order		
		$wp_customize->add_setting( 'wcast_outfordelivery_email_preview_order_id',
			array(
				'default' => 'mockup',
				'transport' => 'refresh',
				'sanitize_callback' => ''
		...
		$wp_customize->add_control( new Skyrocket_Dropdown_Select_Custom_Control( $wp_customize, 'wcast_outfordelivery_email_preview_order_id',
			array(

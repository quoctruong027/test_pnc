...
class wcast_availableforpickup_customizer_email {
	...
	*/
	...
	public static function is_own_customizer_request() {
		return isset( $_REQUEST['email'] ) && $_REQUEST['email'] === 'customer_availableforpickup_email';
	}
	...
	*/
	...
	public function wcast_register_sample_default_controls( $wp_customize ) {		
		...
		*/
		...
		// Preview Order		
		$wp_customize->add_setting( 'wcast_availableforpickup_email_preview_order_id',
			array(
				'default' => 'mockup',
				'transport' => 'refresh',
				'sanitize_callback' => ''
		...
		$wp_customize->add_control( new Skyrocket_Dropdown_Select_Custom_Control( $wp_customize, 'wcast_availableforpickup_email_preview_order_id',
			array(

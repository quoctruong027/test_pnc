...
class wcast_returntosender_customizer_email {
	...
	*/	
	...
	public static function is_own_customizer_request() {
		return isset( $_REQUEST['email'] ) && $_REQUEST['email'] === 'customer_returntosender_email';
	}
	...
	public function wcast_register_sample_default_controls( $wp_customize ) {		
		...
		*/
		...
		$wp_customize->add_control( new WP_Customize_Heading_Control( $wp_customize, 'wcast_returntosender_email_settings[returntosender_order_email_heading]',
			array(
				'label' => __( 'Return To Sender email', 'woo-advanced-shipment-tracking' ),
				'description' => '',
		...
		// Preview Order		
		$wp_customize->add_setting( 'wcast_returntosender_email_preview_order_id',
			array(
				'default' => 'mockup',
				'transport' => 'refresh',
				'sanitize_callback' => ''
		...
		$wp_customize->add_control( new Skyrocket_Dropdown_Select_Custom_Control( $wp_customize, 'wcast_returntosender_email_preview_order_id',
			array(

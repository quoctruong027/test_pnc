<table class="form-table">
  <tr valign="top">
    ...
    <td>
      <?php if (metadata_exists('post', $post->ID, '_enable_question')): ?>
        <input type="checkbox" name="enable_question" value="1" <?php checked(get_post_meta($post->ID, '_enable_question', true), 1); ?> />
      <?php else: ?>
        <input type="checkbox" name="enable_question" value="1" checked />
      <?php endif; ?>
    </td>
  </tr>
  <tr valign="top">

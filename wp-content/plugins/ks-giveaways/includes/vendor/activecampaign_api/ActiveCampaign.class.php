...
class KS_Giveaways_Vendor_ActiveCampaign extends KS_Giveaways_Vendor_AC_Connector {
	...
	function api($path, $post_data = array()) {
		...
		$class = "KS_Giveaways_Vendor_AC_" . $class;
		// IE: new Contact();

		$add_tracking = false;
		if ($class == "KS_Giveaways_Vendor_AC_Tracking") $add_tracking = true;
		if ($class == "KS_Giveaways_Vendor_AC_Tags") {
			$class = "KS_Giveaways_Vendor_AC_Tag";
		}

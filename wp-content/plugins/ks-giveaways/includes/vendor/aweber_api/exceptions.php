...
class KS_Giveaways_Vendor_AWeberException extends Exception { }
 ...
 * @version $id$
 */
class KS_Giveaways_Vendor_AWeberAPIException extends KS_Giveaways_Vendor_AWeberException {
 ...
 * @version $id$
 */
class KS_Giveaways_Vendor_AWeberResourceNotImplemented extends KS_Giveaways_Vendor_AWeberException {
 ...
 * @version $id$
 */
class KS_Giveaways_Vendor_AWeberMethodNotImplemented extends KS_Giveaways_Vendor_AWeberException {
 ...
 * @version $id$
 */
class KS_Giveaways_Vendor_AWeberOAuthException extends KS_Giveaways_Vendor_AWeberException {
 ...
 * @version $id$
 */
class KS_Giveaways_Vendor_AWeberOAuthDataMissing extends KS_Giveaways_Vendor_AWeberException {
 ...
 * @version $id$
 */
class KS_Giveaways_Vendor_AWeberResponseError extends KS_Giveaways_Vendor_AWeberException {

<?php
class KS_Giveaways_Vendor_AWeberCollection extends KS_Giveaways_Vendor_AWeberResponse implements ArrayAccess, Iterator, Countable {
     ...
     * @access public
     * @return KS_Giveaways_Vendor_AWeberEntry
     */
     ...
     * @return KS_Giveaways_Vendor_AWeberEntry(Resource) The new resource created
     */
    ...
    public function offsetGet($offset) {
        ...
        return new KS_Giveaways_Vendor_AWeberEntry($entry, $entry_url, $this->adapter);
    }

...
class wfocu_Input_Geo_Postal_Code_Entry {
	...
	public function render( $field, $value = null ) {
        ...
        <table style="width:100%;">
            <tr>
                <td style="width:162px;"><?php _e( 'Distance ( km )', 'woofunnels-upstroke-one-click-upsell' ); ?></td>
                <td><?php _e( 'Zip/Postal code ( One per line )', 'woofunnels-upstroke-one-click-upsell' ); ?></td>
            </tr>
            <tr>

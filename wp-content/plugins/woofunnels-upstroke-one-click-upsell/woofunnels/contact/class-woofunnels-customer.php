...
class WooFunnels_Customer {
    ...
    public function get_purchased_products() {
        ...
        return empty( $products ) ? $db_products : $products;
    }
    ...
    public function get_purchased_products_cats() {
        ...
        return empty( $purchased_products_cats ) ? $db_purchased_products_cats : $purchased_products_cats;
    ...
    public function get_purchased_products_tags() {
        ...
        return empty( $purchased_products_tags ) ? $db_purchased_products_tags : $purchased_products_tags;

...
?>
<div class="wfocu-landing-section wfocu-product-section wfocu-product-sec-style7 wfocu-pkey-<?php echo $product_key; ?>" data-scrollto="wfocu_product_product_<?php echo $product_key; ?>" data-key="<?php echo $product_key; ?>" data-id="<?php echo $product_id; ?>">

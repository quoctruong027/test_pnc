<?php
/**
 * Automatic postMessage scripts calculation for WFOCUKirki controls.
 *
 * @package     WFOCUKirki
 * @category    Modules
...
class WFOCUKirki_Modules_PostMessage {
	...
	public function postmessage() {
		...
		wp_enqueue_script( 'wfocukirki_auto_postmessage', trailingslashit( WFOCUKirki::$url ) . 'modules/postmessage/postmessage.js', array( 'jquery', 'customize-preview' ), WFOCU_KIRKI_VERSION, true );

jQuery( document ).ready( function() {
	...
	wp.customize.section.each( function( section ) {
		...
		if ( sectionLi.hasClass( 'control-section-wfocukirki-expanded' ) ) {
...
( function() {
	...
	wp.customize.bind( 'pane-contents-reflowed', function() {
		...
		wp.customize.section.each( function( section ) {
			...
			if ( 'wfocukirki-nested' !== section.params.type || _.isUndefined( section.params.section ) ) {
				return;
			}
		...
		wp.customize.panel.each( function( panel ) {
			if ( 'wfocukirki-nested' !== panel.params.type || _.isUndefined( panel.params.panel ) ) {
				return;
			}
			panels.push( panel );
		} );
	...
	wp.customize.Panel = wp.customize.Panel.extend( {
		attachEvents: function() {
			...
			if ( 'wfocukirki-nested' !== this.params.type || _.isUndefined( this.params.panel ) ) {
		...
		isContextuallyActive: function() {
			...
			if ( 'wfocukirki-nested' !== this.params.type ) {
	...
	wp.customize.Section = wp.customize.Section.extend( {
		attachEvents: function() {
			...
			if ( 'wfocukirki-nested' !== this.params.type || _.isUndefined( this.params.section ) ) {

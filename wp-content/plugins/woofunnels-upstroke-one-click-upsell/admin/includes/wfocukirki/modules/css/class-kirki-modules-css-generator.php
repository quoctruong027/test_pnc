...
final class WFOCUKirki_Modules_CSS_Generator {
	...
	private function __construct() {
		if ( is_null( self::$google_fonts ) ) {
			self::$google_fonts = WFOCUKirki_Fonts::get_google_fonts();
		}
		if ( is_null( self::$backup_fonts ) ) {
			self::$backup_fonts = WFOCUKirki_Fonts::get_backup_fonts();
		}
	}
	...
	public static function css( $field ) {
		...
		self::$value = WFOCUKirki_Values::get_sanitized_field_value( $field );
	...
	public static function styles_parse( $css = array() ) {
		...
		// Pass our styles from the wfocukirki_styles_array filter.
		$css = apply_filters( 'wfocukirki_styles_array', $css );

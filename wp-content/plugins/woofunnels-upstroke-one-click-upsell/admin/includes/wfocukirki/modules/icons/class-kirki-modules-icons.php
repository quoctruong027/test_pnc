...
class WFOCUKirki_Modules_Icons {
	...
	public function customize_controls_enqueue_scripts() {
		...
		$sections = WFOCUKirki::$sections;
		$panels   = WFOCUKirki::$panels;
		...
		wp_enqueue_script( 'wfocukirki_panel_and_section_icons', trailingslashit( WFOCUKirki::$url ) . 'modules/icons/icons.js', array( 'jquery', 'customize-base', 'customize-controls' ), WFOCU_KIRKI_VERSION, true );
		wp_localize_script( 'wfocukirki_panel_and_section_icons', 'wfocukirkiIcons', self::$icons );

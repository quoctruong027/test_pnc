...
final class WFOCUKirki_Config {
	...
	/**
	 * Set to true if you want to completely disable any WFOCUKirki-generated CSS.
	 *
	 * @access protected
	 * @var bool
	 */
	...
	private function __construct( $config_id = 'global', $args = array() ) {
		...
		// Apply any wfocukirki_config global filters.
		$defaults = apply_filters( 'wfocukirki_config', $defaults );

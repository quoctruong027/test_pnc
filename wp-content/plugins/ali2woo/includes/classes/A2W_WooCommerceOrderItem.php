...
if (!class_exists('A2W_WooCommerceOrderItem')):
	...
	class A2W_WooCommerceOrderItem {
        ...
        public function get_A2W_ShippingTitle()
        {
            $shipping_title= '';
        ...
        public function get_A2W_ShippingCode()
        {
            ...
            if (isset($this->orderItem['item_meta']['a2w_shipping_code'])) {

                if (is_array($this->orderItem['item_meta']['a2w_shipping_code'])) {
                    $shipping_code = $this->orderItem['item_meta']['a2w_shipping_code'][0];
                } else {
                    $shipping_code = $this->orderItem['item_meta']['a2w_shipping_code'];
                }
            }

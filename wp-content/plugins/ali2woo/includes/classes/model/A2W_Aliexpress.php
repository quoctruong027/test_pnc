                        ...
                        if(!$desc_url){
                            ...
                            if (!is_wp_error($response)) {
                                ...
                                if($response['response']['code'] == 200 && strpos($content_type, "application/json") !== false){
                                    ...
                                    error_log("Load product description meta error: " . $response->get_error_message($response->get_error_code()));
                                }
                            } else {
                                error_log("Load product description gloabl meta error: " . $response->get_error_message($response->get_error_code()));
                            }
                        }
                        if($desc_url){
                            $desc_url .= "&v=1";

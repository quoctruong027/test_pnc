<div class="a2w-content">
                            ...
                            <div class='product' data-id="<?php echo $product['import_id']; ?>" data-country="<?php echo $product['shipping_to_country']; ?>">
                                ...
                                <div class="tabs-content" rel="specs">
                                    ...
                                    <div class="specs-wrap">
                                        ...
                                        <div class="specs-actions"><a href="#" class="add-spec">+ Add spec</a></div>
                                    </div>
                                </div>
                                            ...
                                            <tbody>
                                                ...
                                                <?php foreach ($product['sku_products']['variations'] as $i => $var): ?>
                                                    ...
                                                    <tr data-id="<?php echo $var['id']; ?>" class="var_data">
                                                        ...
                                                        <td>
                                                            <?php if (isset($var['image'])): ?><img class="border-img lazy-in-container" style="max-width: 100px; max-height: 100px; margin: 5px" src="<?php echo A2W()->plugin_url() . '/assets/img/blank_image.png'; ?>" data-id="<?php echo md5($var['image']);?>" data-original="<?php echo isset($product['tmp_edit_images'][md5($var['image'])]['attachment_url']) ? $product['tmp_edit_images'][md5($var['image'])]['attachment_url'] : a2w_image_url($var['image']); ?>"><?php endif; ?>
                                                        </td>
                                                        <td>
    ...
    <script>
        var a2w_fulfillment_prefship = '<?php echo a2w_get_setting('fulfillment_prefship');?>';
            ...
            $('.product .nav-tabs a').click(function () {
                ...
                if ($(this).attr("rel") === 'variants') {
                    ...
                    if(!tmp_data.shipping){
                        a2w_load_shipping_info($(product).attr('data-id'), tmp_data.country, 'import', function(state, items){
                            if (state != 'error') {

...
<div class="panel panel-primary mt20" id="phrase_list">
    <div class="panel-heading">
        <h3 class="panel-title"><?php _ex('Phrase Filtering (case sensitive)', 'Setting title', 'ali2woo'); ?></h3>
        <span class="pull-right">
            <a class="disabled" style="display: none;"><?php _e('You have unsaved changes', 'ali2woo'); ?></a>
            <a href="#" class="apply-phrase-rules btn"><?php _e('Apply Filter to your Shop', 'ali2woo'); ?></a></span>
    </div>


    <div class="panel-body">
        <div class="panel panel-default" id="a2w-panel-info" style="display: none;">
            <div class="panel-heading"><?php _e('Applying filter progress', 'ali2woo'); ?>  <button type="button" class="close" data-target="#a2w-panel-info" data-dismiss="alert"> <span aria-hidden="true">&times;</span><span class="sr-only"><?php _e('Close'); ?></span>
        ...
        <div class="row">
            <div class="col-md-4 pb20">
                <strong><?php _e('Phrase', 'ali2woo'); ?></strong>
            </div>
            <div class="col-md-8 pb20">
                <strong><?php _e('Replacement', 'ali2woo'); ?></strong>   
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group input-block no-margin">
                        <input type="text" value="<?php echo $phrase->phrase; ?>" class="form-control small-input a2w_phrase" placeholder="<?php _e('some phrase or word', 'ali2woo'); ?>" />
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group input-block no-margin">
                        <input type="text" value="<?php echo $phrase->phrase_replace; ?>" class="form-control small-input a2w_phrase_replace" placeholder="<?php _e('sreplacement or empty', 'ali2woo'); ?>" />
                    </div>   
                </div>
                <div class="col-md-4">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group input-block no-margin">
                    <input type="text" class="form-control small-input a2w_phrase" placeholder="<?php _e('some phrase or word', 'ali2woo'); ?>" />
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group input-block no-margin">
                    <input type="text" class="form-control small-input a2w_phrase_replace" placeholder="<?php _e('sreplacement or empty', 'ali2woo'); ?>" />
                </div>   
            </div>
            <div class="col-md-4">
...
<div class="container-fluid">
    <div class="row pt20 border-top">
        <div class="col-sm-12">
            <input class="btn btn-success" id="save-phrases"  type="submit" value="<?php _e('Save settings', 'ali2woo'); ?>"/>
        </div>
    </div>
</div>
...
<div class="modal-overlay modal-apply-phrases">
    <div class="modal-content">
        <div class="modal-header">
            <h3 class="modal-title"><?php _e('Apply Filter to your Shop', 'ali2woo'); ?></h3>
            <a class="modal-btn-close" href="#"><svg><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#icon-cross"></use></svg></a>
        </div>
        <div class="modal-body">
            <label><?php _e('Select the update type', 'ali2woo'); ?></label>
            <div style="padding-bottom: 20px;">
                <div class="type btn-group" role="group">
                    <button type="button" class="btn btn-default" value="products"><?php _ex('Products', 'Apply Phrases', 'ali2woo'); ?></button>
                    <button type="button" class="btn btn-default" value="reviews"><?php _ex('Reviews', 'Aplly Phrases', 'ali2woo'); ?></button>
                    <?php /*
                      <button type="button" class="btn btn-default" value="shippings"><?php _ex('Shipping methods', 'Apply Phrases', 'ali2woo'); ?></button>
                     */ ?>
                    <button type="button" class="btn btn-default" value="all_types"><?php _ex('All', 'Apply Phrases', 'ali2woo'); ?></button>
                </div>
            </div>
            <div class="scope">
                <label><?php _e('Select the update scope', 'ali2woo'); ?></label>
                <div>
                    <div class="scope btn-group" role="group">
                        <button type="button" class="btn btn-default" value="shop"><?php _ex('Shop', 'Apply Phrases', 'ali2woo'); ?></button>
                        <button type="button" class="btn btn-default" value="import"><?php _ex('Import List', 'Apply Phrases', 'ali2woo'); ?></button>
                        <button type="button" class="btn btn-default" value="all"><?php _ex('Shop and Import List', 'Apply Phrases', 'ali2woo'); ?></button>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    (function ($) {
        ...
        $(".apply-phrase-rules").on("click", function () {
            ...
            $(".modal-apply-phrases").fadeIn(400);
            return false;
        });
        ...
        $(".modal-apply-phrases .close-btn").on("click", function () {
            $(".modal-apply-phrases").fadeOut(400);
            return false;
        });

...
class WOOMULTI_CURRENCY_Admin_Admin {
	...
	function __construct() {
		...
		add_filter(
			'plugin_action_links_woocommerce-multi-currency/woocommerce-multi-currency.php', array(
				$this,
				'settings_link'
			)
		);
	...
	*/
	...
	public function admin_init() {
		...
		new VillaTheme_Plugin_Check_Update (
			WOOMULTI_CURRENCY_VERSION,                    // current version
	...
	public function admin_enqueue_scripts() {
		...
		if ( $page == 'woocommerce-multi-currency' ) {
			...
			wp_enqueue_style( 'woocommerce-multi-currency', WOOMULTI_CURRENCY_CSS . 'woocommerce-multi-currency-admin.css' );
	...
	public function menu_page() {
		add_menu_page(
			esc_html__( 'WooCommerce Multi Currency', 'woocommerce-multi-currency' ),
			esc_html__( 'Multi Currency', 'woocommerce-multi-currency' ),
			'manage_woocommerce',
			'woocommerce-multi-currency',
			array( 'WOOMULTI_CURRENCY_Admin_Settings', 'page_callback' ),

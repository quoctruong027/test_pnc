...
if ( $quick_view_text == '' ) {
	$quick_view_text = __( 'Quick View', 'powerpack' );
}
...
$out_of_stock_string = apply_filters( 'pp_woo_out_of_stock_string', __( 'Out of stock', 'powerpack' ) );
	...
	<div class="pp-woo-product-wrapper">
		...
		if ( 'yes' === $settings['link_image'] ) {
			...
			if( 'yes' === $settings['link_image_target']){
				echo '<a href="' . get_the_permalink() . '" target="_blank" class="woocommerce-LoopProduct-link">'; 
		...
		if ( '' !== $quick_view_type ) {
			...
			echo '<div class="pp-quick-view-btn-wrap">';
			echo '<div class="pp-quick-view-btn" data-product_id="' . $post_id . '">';
				echo '<span class="pp-qv-icon fa fa-eye"></span>';
				echo '<span class="pp-qv-text">' . $quick_view_text . '</span>';
			echo '</div>';
			echo '</div>';
		}
				...
				switch ( $value ) {
					case 'title':
						...
						if ( 'yes' === $settings['link_title'] ) {
							...
							echo '<a href="' . esc_url( apply_filters( 'pp_woo_title_link', get_the_permalink() ) ) . '"'. $target .' class="pp-loop-product__link">';

				...
				foreach ( $pp_social_links as $icon_id => $icon_url ) {
					if ( $icon_url ) {
						if ( $icon_id == 'envelope' ) {
							...
							printf( '<li><a href="tel:%1$s"><span class="pp-tm-social-icon-wrap"><span class="pp-tm-social-icon fas fa fa-' . esc_attr( $icon_id ) . '"></span></span></a></li>', $icon_url );
						} else {
				...
				<div class="pp-tm-social-links-wrap">
					<ul class="pp-tm-social-links">
						...
						<# if ( phone ) { #>
							<li>
								<a href="tel:{{ phone }}">
									<span class="pp-tm-social-icon-wrap"><span class="pp-tm-social-icon fas fa fa-phone-alt"></span></span>
								</a>
							</li>
						<# } #>
					</ul>

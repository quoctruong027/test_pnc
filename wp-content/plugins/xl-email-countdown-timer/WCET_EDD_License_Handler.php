...
if (!class_exists('WCET_EDD_License')) :

    /**
     * EDD_License Class
     */
    class WCET_EDD_License
    {
        ...
        {
            if (!class_exists('WCET_EDD_SL_Plugin_Updater'))
                require_once 'WCET_EDD_SL_Plugin_Updater.php';
        }
        ...
        private function auto_updater()
        {
            ...
            // Setup the updater
            $edd_updater = new WCET_EDD_SL_Plugin_Updater(

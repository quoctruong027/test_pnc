...
class caddy_cart_widget extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		$cart_widget_title = apply_filters( 'widget_title', $instance['cart_widget_title'] );
		...
		$cart_items_link = sprintf(
			...
			( 'on' == $instance['cc_cart_icon'] ) ? '' : '<i class="ccicon-cart"></i>',
			esc_html( $instance['cart_text'] ),
			$cc_cart_class,
			esc_html( $cart_count )
		);
	...
	public function form( $instance ) {
		...
		$cc_cart_icon      = ( 'on' == $instance['cc_cart_icon'] ) ? ' checked="checked"' : '';
		?>
		<p>

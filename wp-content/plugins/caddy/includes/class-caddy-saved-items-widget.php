...
class caddy_saved_items_widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			...
			__( 'Caddy Saved Items Widget', 'caddy' ),
			array( 'description' => __( 'Caddy saved items widget', 'caddy' ), )
		);
	}
	...
	public function widget( $args, $instance ) {
		$si_widget_title = apply_filters( 'widget_title', $instance['si_widget_title'] );
	...
	public function form( $instance ) {
		...
		$si_icon_checked = ( 'on' == $instance['cc_si_icon'] ) ? ' checked="checked"' : '';
		?>
		<p>

                ...
                <form class="vi-ui form" method="post">
                    ...
                    <div class="vi-ui bottom attached tab segment active" data-tab="sidebar_cart">
                        ...
                        <table class="form-table">
                            ...
                            <tr>
                                <th>
                                    <label for="vi-wcaio-sc_enable-checkbox"><?php esc_html_e( 'Mobile enable', 'woo-cart-all-in-one' ); ?></label>
                                </th>
                                <td>
                                    <div class="vi-ui checkbox toggle">
                    ...
                    <div class="vi-ui bottom attached tab segment" data-tab="recently_viewed">
                        <table class="form-table">
                            <tr>
                                <th>
                                    <label for="vi-wcaio-vp_enable-checkbox"><?php esc_html_e( 'Enable', 'woo-cart-all-in-one' ); ?></label>
                                </th>
                                <td>
                                    <a class="vi-ui button" href="https://1.envato.market/bW20B"
                                       target="_blank"><?php esc_html_e( 'Unlock This Feature', 'woo-cart-all-in-one' ); ?> </a>
                            ...
                            <tr>
                                <th>
                                    <label for="vi-wcaio-vp_mobile_enable-checkbox"><?php esc_html_e( 'Mobile enable', 'woo-cart-all-in-one' ); ?></label>
                                </th>
                                <td>
                                    <a class="vi-ui button" href="https://1.envato.market/bW20B"
                                       target="_blank"><?php esc_html_e( 'Unlock This Feature', 'woo-cart-all-in-one' ); ?> </a>
                            ...
                            <tr>
                                <th>
                                    <label for="vi-wcaio-vp_single_position"><?php esc_html_e( 'Position on single product page', 'woo-cart-all-in-one' ); ?></label>
                                </th>
                                <td>
                                    <a class="vi-ui button" href="https://1.envato.market/bW20B"
                                       target="_blank"><?php esc_html_e( 'Unlock This Feature', 'woo-cart-all-in-one' ); ?> </a>
                            ...
                            <tr>
                                <th>
                                    <label for="vi-wcaio-vp_title"><?php esc_html_e( 'Title', 'woo-cart-all-in-one' ); ?></label>
                                </th>
                                <td>
                                    <a class="vi-ui button" href="https://1.envato.market/bW20B"
                                       target="_blank"><?php esc_html_e( 'Unlock This Feature', 'woo-cart-all-in-one' ); ?> </a>
                            ...
                            <tr>
                                <th>
                                    <label for="vi-wcaio-vp_pd_limit"><?php esc_html_e( 'Products limit', 'woo-cart-all-in-one' ); ?></label>
                                </th>
                                <td>
                                    <a class="vi-ui button" href="https://1.envato.market/bW20B"
                                       target="_blank"><?php esc_html_e( 'Unlock This Feature', 'woo-cart-all-in-one' ); ?> </a>
                            ...
                            <tr>
                                <th>
                                    <label for="vi-wcaio-vp_pd_column"><?php esc_html_e( 'Number of columns', 'woo-cart-all-in-one' ); ?></label>
                                </th>
                                <td>
                                    <a class="vi-ui button" href="https://1.envato.market/bW20B"
                                       target="_blank"><?php esc_html_e( 'Unlock This Feature', 'woo-cart-all-in-one' ); ?> </a>
                            ...
                            <tr>
                                <th>
                                    <label for="vi-wcaio-vp_slider_loop-checkbox"><?php esc_html_e( 'Infinite loop', 'woo-cart-all-in-one' ); ?></label>
                                </th>
                                <td>
                                    <a class="vi-ui button" href="https://1.envato.market/bW20B"
                                       target="_blank"><?php esc_html_e( 'Unlock This Feature', 'woo-cart-all-in-one' ); ?> </a>
                            ...
                            <tr>
                                <th>
                                    <label for="vi-wcaio-vp_slider_move"><?php esc_html_e( 'Number of carousel items that should move on animation', 'woo-cart-all-in-one' ); ?></label>
                                </th>
                                <td>
                                    <a class="vi-ui button" href="https://1.envato.market/bW20B"
                                       target="_blank"><?php esc_html_e( 'Unlock This Feature', 'woo-cart-all-in-one' ); ?> </a>
                            ...
                            <tr>
                                <th>
                                    <label for="vi-wcaio-vp_slider_auto-checkbox"><?php esc_html_e( 'Autoplay', 'woo-cart-all-in-one' ); ?></label>
                                </th>
                                <td>
                                    <a class="vi-ui button" href="https://1.envato.market/bW20B"
                                       target="_blank"><?php esc_html_e( 'Unlock This Feature', 'woo-cart-all-in-one' ); ?> </a>
                            ...
                            <tr>
                                <th>
                                    <label for="vi-wcaio-vp_slider_speed"><?php esc_html_e( 'Slideshow speed(milliseconds)', 'woo-cart-all-in-one' ); ?></label>
                                </th>
                                <td>
                                    <a class="vi-ui button" href="https://1.envato.market/bW20B"
                                       target="_blank"><?php esc_html_e( 'Unlock This Feature', 'woo-cart-all-in-one' ); ?> </a>
                            ...
                            <tr>
                                <th>
                                    <label for="vi-wcaio-vp_slider_pause-checkbox"><?php esc_html_e( 'Pause on hover', 'woo-cart-all-in-one' ); ?></label>
                                </th>
                                <td>
                                    <a class="vi-ui button" href="https://1.envato.market/bW20B"
                                       target="_blank"><?php esc_html_e( 'Unlock This Feature', 'woo-cart-all-in-one' ); ?> </a>

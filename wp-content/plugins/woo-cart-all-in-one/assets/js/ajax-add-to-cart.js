...
jQuery(document).ready(function () {
    ...
    if ( viwcaio_ajax_atc_params.ajax_atc == 1) {
        jQuery(document).on('click', 'form .single_add_to_cart_button:not(.vi-wcaio-product-bt-atc-loading)', function (e) {
            e.preventDefault();
            e.stopPropagation();
    ...
    jQuery(document).on('click', '.vi-wcaio-product-bt-atc:not(.vi-wcaio-product-bt-not-atc):not(.vi-wcaio-product-bt-atc-loading):not(.vi-wcaio-product-bt-atc-non-ajax)', function (e) {
        e.preventDefault();
        e.stopPropagation();

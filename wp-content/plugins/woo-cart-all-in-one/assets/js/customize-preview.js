(function () {
        ...
        value.bind(function (newval) {
            ...
            if (newval) {
                jQuery.ajax({
                    ...
                    success: function (response) {
                        if (response && response.status === 'success') {
                            jQuery('.vi-wcaio-sidebar-cart-footer-pd-wrap-wrap').html(response.message);
    ...
    wp.customize('woo_cart_all_in_one_params[sc_footer_pd_plus1]', function (value) {
        value.bind(function (newval) {
            jQuery('.vi-wcaio-sidebar-cart-footer-pd-plus-wrap > div').addClass('vi-wcaio-disabled');
            jQuery('.vi-wcaio-sidebar-cart-footer-pd-' + newval).removeClass('vi-wcaio-disabled');
            jQuery('.vi-wcaio-sidebar-cart').removeClass('vi-wcaio-sidebar-cart-init');
        });
    });
    wp.customize('woo_cart_all_in_one_params[sc_footer_best_selling_text]', function (value) {
        value.bind(function (newval) {
            jQuery('.vi-wcaio-sidebar-cart-footer-pd-best_selling .vi-wcaio-sidebar-cart-footer-pd-plus-title').html(newval);
            jQuery('.vi-wcaio-sidebar-cart').removeClass('vi-wcaio-sidebar-cart-init');
        });
    });
    wp.customize('woo_cart_all_in_one_params[sc_footer_viewed_product_text]', function (value) {
        value.bind(function (newval) {
            jQuery('.vi-wcaio-sidebar-cart-footer-pd-viewed_product .vi-wcaio-sidebar-cart-footer-pd-plus-title').html(newval);
            jQuery('.vi-wcaio-sidebar-cart').removeClass('vi-wcaio-sidebar-cart-init');
        });
    });
    wp.customize('woo_cart_all_in_one_params[sc_footer_product_rating_text]', function (value) {
        value.bind(function (newval) {
            jQuery('.vi-wcaio-sidebar-cart-footer-pd-product_rating .vi-wcaio-sidebar-cart-footer-pd-plus-title').html(newval);
            jQuery('.vi-wcaio-sidebar-cart').removeClass('vi-wcaio-sidebar-cart-init');
        });
    });
    ...
    vi_wcaio_add_preview_control('sc_icon_border_radius', '.vi-wcaio-sidebar-cart .vi-wcaio-sidebar-cart-icon-wrap', 'border-radius', 'px');
    vi_wcaio_add_preview_control('sc_icon_bg_color', '.vi-wcaio-sidebar-cart .vi-wcaio-sidebar-cart-icon-wrap', 'background', '');
    vi_wcaio_add_preview_control('sc_icon_color', '.vi-wcaio-sidebar-cart .vi-wcaio-sidebar-cart-icon-wrap .vi-wcaio-sidebar-cart-icon i', 'color', '');
    vi_wcaio_add_preview_control('sc_icon_count_bg_color', '.vi-wcaio-sidebar-cart .vi-wcaio-sidebar-cart-icon-wrap .vi-wcaio-sidebar-cart-count-wrap', 'background', '');
    vi_wcaio_add_preview_control('sc_icon_count_color', '.vi-wcaio-sidebar-cart .vi-wcaio-sidebar-cart-icon-wrap .vi-wcaio-sidebar-cart-count-wrap', 'color', '');
    vi_wcaio_add_preview_control('sc_icon_count_border_radius', '.vi-wcaio-sidebar-cart .vi-wcaio-sidebar-cart-icon-wrap .vi-wcaio-sidebar-cart-count-wrap', 'border-radius', 'px');

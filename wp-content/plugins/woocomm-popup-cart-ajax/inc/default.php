...
if ( ! function_exists( 'wcspc_get_default_options' ) ) :
	...
	function wcspc_get_default_options() {
		...
		// Slider Section.
        $defaults['_wcspc_auto_show_ajax']				= esc_attr('no');
        $defaults['_wcspc_auto_show_normal']			= esc_attr('no');
        ...
        $defaults['_wcspc_buttons']						= esc_attr('02');
        ...
        $defaults['_wcspc_count']						= esc_attr('no');

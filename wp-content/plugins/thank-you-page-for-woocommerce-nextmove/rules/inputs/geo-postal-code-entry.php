...
class xlwcty_Input_Geo_Postal_Code_Entry {
	...
	public function render( $field, $value = null ) {
        ...
        <table style="width:100%;">
            <tr>
                <td style="width:162px;"><?php _e( 'Distance ( km )', 'thank-you-page-for-woocommerce-nextmove' ); ?></td>
                <td><?php _e( 'Zip/Postalcode ( One per line )', 'thank-you-page-for-woocommerce-nextmove' ); ?></td>
            </tr>
            <tr>

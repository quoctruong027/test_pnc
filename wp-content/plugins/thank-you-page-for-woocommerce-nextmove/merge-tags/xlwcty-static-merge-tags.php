...
class XLWCTY_Static_Merge_Tags {
	...
	public static function get_all_tags() {
		...
		$tags = array(
			array(
				'name' => __( 'Shop Title', 'thank-you-page-for-woocommerce-nextmove' ),
				'tag'  => 'shop_title',
			),
			array(
				'name' => __( 'Home Url', 'thank-you-page-for-woocommerce-nextmove' ),
				'tag'  => 'home_url',
			),
			array(
				'name' => __( 'Shop URL', 'thank-you-page-for-woocommerce-nextmove' ),
				'tag'  => 'shop_url',
			),
			array(
				'name' => __( 'Shop Admin Email', 'thank-you-page-for-woocommerce-nextmove' ),

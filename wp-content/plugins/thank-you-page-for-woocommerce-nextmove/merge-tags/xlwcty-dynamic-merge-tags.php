...
class XLWCTY_Dynamic_Merge_Tags {
	...
	public static function get_all_tags() {
		...
		$tags = array(
			array(
				'name' => __( 'Customer ID', 'thank-you-page-for-woocommerce-nextmove' ),
				'tag'  => 'customer_user_id',
			),
			array(
				'name' => __( 'Customer First Name', 'thank-you-page-for-woocommerce-nextmove' ),
				'tag'  => 'customer_first_name',
			),
			array(
				'name' => __( 'Customer Last Name', 'thank-you-page-for-woocommerce-nextmove' ),
				'tag'  => 'customer_last_name',
			),
			array(
				'name' => __( 'Customer Full Name', 'thank-you-page-for-woocommerce-nextmove' ),
				'tag'  => 'customer_full_name',
			),
			array(
				'name' => __( 'Customer First Name Uppercase', 'thank-you-page-for-woocommerce-nextmove' ),
				'tag'  => 'customer_first_name_cap',
			),
			array(
				'name' => __( 'Customer Last Name Uppercase', 'thank-you-page-for-woocommerce-nextmove' ),
				'tag'  => 'customer_last_name_cap',
			),
			array(
				'name' => __( 'Customer Full Name Uppercase', 'thank-you-page-for-woocommerce-nextmove' ),
				'tag'  => 'customer_full_name_cap',
			),
			array(
				'name' => __( 'Customer Email', 'thank-you-page-for-woocommerce-nextmove' ),
				'tag'  => 'customer_email',
			),
			array(
				'name' => __( 'Customer Phone', 'thank-you-page-for-woocommerce-nextmove' ),
				'tag'  => 'customer_phone',
			),
			array(
				'name' => __( 'Order Number', 'thank-you-page-for-woocommerce-nextmove' ),
				'tag'  => 'order_no',
			),
			array(
			...
			array(
				'name' => __( 'Order Date', 'thank-you-page-for-woocommerce-nextmove' ),
				'tag'  => 'order_date',
			),
			array(
				'name' => __( 'Order Total', 'thank-you-page-for-woocommerce-nextmove' ),
				'tag'  => 'order_total',
			),
			array(
				'name' => __( 'Order Total Raw', 'thank-you-page-for-woocommerce-nextmove' ),
				'tag'  => 'order_total_raw',
			),
			array(
				'name' => __( 'Order Items Count', 'thank-you-page-for-woocommerce-nextmove' ),
				'tag'  => 'order_itemscount',
			),
			array(
				'name' => __( 'Order Shipping method', 'thank-you-page-for-woocommerce-nextmove' ),
				'tag'  => 'order_shipping_method',
			),
			array(
				'name' => __( 'Order payment method', 'thank-you-page-for-woocommerce-nextmove' ),
				'tag'  => 'order_payment_method',
			),
			array(
				'name' => __( 'Order Billing Country', 'thank-you-page-for-woocommerce-nextmove' ),
				'tag'  => 'order_billing_country',
			),
			array(
				'name' => __( 'Order Shipping Country', 'thank-you-page-for-woocommerce-nextmove' ),
				'tag'  => 'order_shipping_country',
			),
			array(
				'name' => __( 'Order Billing Address', 'thank-you-page-for-woocommerce-nextmove' ),
				'tag'  => 'order_billing_address',
			),
			array(
				'name' => __( 'Order Shipping Address', 'thank-you-page-for-woocommerce-nextmove' ),
				'tag'  => 'order_shipping_address',
			),
			array(
				'name' => __( 'Order Coupon', 'thank-you-page-for-woocommerce-nextmove' ),
				'tag'  => 'order_coupon',
			),
			array(
				'name' => __( 'Users IP Address', 'thank-you-page-for-woocommerce-nextmove' ),
				'tag'  => 'order_ip',
			),
			array(
				'name' => __( 'Customer Provided Note', 'thank-you-page-for-woocommerce-nextmove' ),
				'tag'  => 'customer_provided_note',
			),
			array(
				'name' => __( 'Subscription ID', 'thank-you-page-for-woocommerce-nextmove' ),
				'tag'  => 'subscription_id',
			),
			array(
				'name' => __( 'Subscription Status', 'thank-you-page-for-woocommerce-nextmove' ),
				'tag'  => 'subscription_status',
			),
			array(
				'name' => __( 'Subscription Start Date', 'thank-you-page-for-woocommerce-nextmove' ),
				'tag'  => 'subscription_start_date',
			),
			array(
				'name' => __( 'Subscription Next Payment Date', 'thank-you-page-for-woocommerce-nextmove' ),
				'tag'  => 'subscription_next_payment_date',
			),
			array(
				'name' => __( 'Subscription End Date', 'thank-you-page-for-woocommerce-nextmove' ),
				'tag'  => 'subscription_end_date',
			),
			array(
				'name' => __( 'Coupon Expiry Date', 'thank-you-page-for-woocommerce-nextmove' ),
				'tag'  => 'coupon_expiry_date',
				'desc' => __( 'This tag will only work inside Smart Bribe or Dynamic Coupon components.', 'thank-you-page-for-woocommerce-nextmove' ),
			),
			array(
				'name' => __( 'Coupon Value', 'thank-you-page-for-woocommerce-nextmove' ),
				'tag'  => 'coupon_value',
				'desc' => __( 'This tag will only work inside Smart Bribe or Dynamic Coupon components.', 'thank-you-page-for-woocommerce-nextmove' ),
			),
		);
	...
	public static function order_coupon() {
		$order = XLWCTY_Core()->data->get_order();
		if ( ! $order instanceof WC_Order ) {
			return __return_empty_string();
		}
		...
		return implode( '<br/>', $coupon_codes );
	}

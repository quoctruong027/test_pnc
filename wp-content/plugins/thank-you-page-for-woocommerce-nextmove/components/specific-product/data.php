...
$config['fields']   = array(
	...
	'fields'                 => array(
		...
		array(
			'name'            => __( 'Choose Prodcuts', 'thank-you-page-for-woocommerce-nextmove' ),
			'id'              => $config['slug'] . 's',
			'type'            => 'xlwcty_post_select',
			'row_classes'     => array( '' ),
			'options_name_cb' => array( 'XLWCTY_Admin_CMB2_Support', 'cmb2_product_title' ),
			'attributes'      => array(
				'data-conditional-id'    => $config['slug'] . '_enable',
				'data-conditional-value' => '1',
				'multiple'               => 'multiple',
				...
				'data-placeholder'       => __( 'Search For a Product...', 'thank-you-page-for-woocommerce-nextmove' ),
			),
		),
		array(

...
$source_left     = ! empty( $this->data->{$index}->img_r_source ) ? $this->data->{$index}->img_r_source : '';
$left_image_link = ! empty( $this->data->{$index}->img_r_link ) ? $this->data->{$index}->img_r_link : 'javascript:void(0)';

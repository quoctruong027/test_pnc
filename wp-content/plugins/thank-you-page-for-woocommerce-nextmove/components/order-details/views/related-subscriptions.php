		...
		<?php foreach ( $subscriptions as $subscription_id => $subscription ) : ?>
            <tr class="order">
                <td data-title="Subscription" class="subscription-id order-number xlwcty_left">
					...
					<?php if ( function_exists( 'wcs_get_subscription_status_name' ) ) { ?>
                        <small>( <?php echo esc_attr( wcs_get_subscription_status_name( $subscription->get_status() ) ); ?>)</small>
					<?php } else { ?>
                        <small>( <?php echo esc_attr( $subscription->get_status() ); ?>)</small>
					<?php } ?>
                </td>
                ...
                <td data-title="Action" class="subscription-actions order-actions xlwcty_center">
                    <a href="<?php echo esc_url( $subscription->get_view_order_url() ); ?>"
                       class="button view"><?php echo esc_html_x( 'View', 'view a subscription', 'woocommerce-subscriptions' ); ?></a>
                </td>
            </tr>
		<?php endforeach; ?>
        </tbody>

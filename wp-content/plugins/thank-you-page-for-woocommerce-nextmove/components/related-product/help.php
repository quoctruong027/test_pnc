...
?>
    <div style="display:none;" class="xlwcty_tb_content" id="xlwcty_component_settings<?php echo $config['slug']; ?>_help">
        ...
        <p class="xlwcty_center"><img src="//storage.googleapis.com/xl-nextmove/related-products.jpg"/></p>
        <table align="center" width="650" class="xlwcty_modal_table">
            ...
            <tr>
                <td>4.</td>
                <td><strong>Display Count:</strong> Here you can choose number of products to display</td>
            </tr>
            <tr>
                <td>5.</td>

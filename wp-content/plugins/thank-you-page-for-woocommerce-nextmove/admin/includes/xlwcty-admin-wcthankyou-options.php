...
class XLWCTY_Admin_Post_Options {
	...
	public static function setup_fields() {
		...
		$box_options         = array(
			...
			'title'      => __( 'Component Builder Settings', 'thank-you-page-for-woocommerce-nextmove' ),
		...
		$box_options_global         = array(
			...
			'title'   => __( 'Global Settings', 'thank-you-page-for-woocommerce-nextmove' ),
			'classes' => 'xlwcty_options_common',
			'hookup'  => false,
			'show_on' => array(
				'key'   => 'options-page',
		...
		remove_filter( 'intermediate_image_sizes', array( __CLASS__, 'xlwcty_modify_intermediate_image_sizes' ), 10, 1 );
		...
		$box_options_debug          = array(
			...
			'title'      => __( 'Debug Settings', 'thank-you-page-for-woocommerce-nextmove' ),
			'classes'    => 'xlwcty_options_common',
			'show_names' => true,
			'context'    => 'normal',
			'priority'   => 'high',
	...
	public static function menu_order_metabox_fields() {
		...
		$box_options = array(
			...
			'title'        => __( 'Thank You Page Priority', 'thank-you-page-for-woocommerce-nextmove' ),
			'classes'      => 'xlwcty_options_common',
		...
		$priority_desc      = __( 'Page Priority features come into play when multiple Thank You pages are set.', 'thank-you-page-for-woocommerce-nextmove' );
		$priority_desc      .= '<br/><br/>' . __( 'Priority works in ascending order. Lower the number higher the priority.', 'thank-you-page-for-woocommerce-nextmove' );
		...
		$priority_desc      .= '<br/><br/>' . __( 'Need Help with priority? ', 'thank-you-page-for-woocommerce-nextmove' ) . '<a href="' . $priority_desc_link . '" target="_blank">';
		$priority_desc      .= __( 'Read Docs', 'thank-you-page-for-woocommerce-nextmove' );
		$priority_desc      .= '</a>';
		...
		$shortcode_box = array(
			array(
				...
				'fields'   => array(
					array(
						'name'            => __( 'Page Priority', 'thank-you-page-for-woocommerce-nextmove' ),
						'desc'            => $priority_desc,
	...
	public static function quick_view_metabox_fields() {
		...
		$box_options   = array(
			...
			'title'        => __( 'Quick View', 'thank-you-page-for-woocommerce-nextmove' ),
			'classes'      => 'xlwcty_options_common',
			'object_types' => array( XLWCTY_Common::get_thank_you_page_post_type_slug() ),
			'show_names'   => true,
			'context'      => 'side',
	...
	public static function xlwcty_button_html() {
		...
		if ( is_array( $customization_fields ) && count( $customization_fields ) > 0 ) {
			...
			if ( is_array( $get_choosed_templ_components ) && count( $get_choosed_templ_components ) > 0 ) {
	...
	public static function xlwcty_builder_html() {
        ...
        <div class="xlwcty_clear_20"></div>
        <div class="xlwcty_arrange_title">For Desktop</div>
        <div class="xlwcty_clear_20"></div>
        ...
        <div class="xlwcty_clear_20"></div>
        <div class="xlwcty_arrange_title">For Mobile</div>
        <div class="xlwcty_clear_20"></div>
        <div class="xlwcty_template_preview">
            <div class="xlwcty_template_wrap">
                <div class="xlwcty_layout_prev_header">Header</div>
                <div class="xlwcty_default_layout">
                    <ul class="xlwcty_layout_mobile_content xlwcty_layout_prev_content_basic xlTemplateMobileUi">
                        <li class="xlwcty_layout_components" ng-repeat="comp in builder_componets.mobile.first" data-slug="{{comp.slug}}" data-component="{{comp.component}}"
                            data-title="{{comp.name}}">
                            {{comp.name}}
                        </li>
                    </ul>

jQuery(document).ready(function ($) {
     ...
     */
    window.xlwctyCMB2ConditionalsInit = function (changeContext, conditionContext) {
...
//        console.log(evt);
            ...
            dependants = xlwctyCMB2ConditionalsFindDependants(fieldName, elm, conditionContext);
            ...
            if (dependants.length > 0) {
                ...
                if ('checkbox' === elm.attr('type')) {
                    ...
                    elmValue = xlwctyCMB2ConditionalsStringToUnicode(evt.currentTarget.value);
                }
                ;
                ...
                dependants.each(function (i, e) {
                    ...
                    if ('undefined' !== typeof currentFieldName && '' !== currentFieldName && $.inArray(currentFieldName, dependantsSeen) < 0) {
                        ...
                        if (false === shouldShow) {
                            xlwctyCMB2ConditionalsRecursivelyHideDependants(currentFieldName, current, conditionContext);
                        }
                    ...
                    changeContext.trigger("xlwcty_conditional_runs", [current, currentFieldName, requiredValue, currentParent, shouldShow, elm, elmValue]);
        ...
        //     if ($(this).hasClass("xlwcty_custom_wrapper_group")) {
        //         return;
        //     }
        ...
        $('[data-conditional-id]', conditionContext).not(".xlwcty_custom_wrapper_group").parents('.cmb-row:first').hide({
            "complete": function () {
                $("body").trigger("xlwcty_trigger_conditional_on_load");
     ...
     */
    function xlwctyCMB2ConditionalsFindDependants(fieldName, elm, context) {
     ...
     */
    function xlwctyCMB2ConditionalsRecursivelyHideDependants(fieldName, elm, context) {
        var dependants = xlwctyCMB2ConditionalsFindDependants(fieldName, elm, context);
        ...
        if (dependants.length > 0) {
            dependants.each(function (i, e) {
                ...
                xlwctyCMB2ConditionalsRecursivelyHideDependants(dependantName, dependant, context);
            });
        }
    }


    function xlwctyCMB2ConditionalsStringToUnicode(string) {
        var i, result = '',

...
class XLWCTY_Post_Table extends WP_List_Table {
	...
	public function no_items() {
		echo wpautop( __( 'No Page Available', 'thank-you-page-for-woocommerce-nextmove' ) );
	}
	...
	public function column_status( $item ) {
		if ( $item['trigger_status'] == XLWCTY_SHORT_SLUG . 'disabled' ) {
			$text = __( 'Deactivated', 'thank-you-page-for-woocommerce-nextmove' );
			$link = get_post_permalink( $item['id'] );
		} else {
			$text = __( 'Activated', 'thank-you-page-for-woocommerce-nextmove' );
			$link = get_post_permalink( $item['id'] );
		}
	...
	public function get_columns() {
		$columns = array(
			'check-column' => __( '&nbsp;', 'thank-you-page-for-woocommerce-nextmove' ),
			'name'         => __( 'Title', 'thank-you-page-for-woocommerce-nextmove' ),
			'component'    => __( 'Components', 'thank-you-page-for-woocommerce-nextmove' ),
			'layout'       => __( 'Layout', 'thank-you-page-for-woocommerce-nextmove' ),
			'template'     => __( 'Template', 'thank-you-page-for-woocommerce-nextmove' ),
			'status'       => __( 'Status', 'thank-you-page-for-woocommerce-nextmove' ),
			'priority'     => __( 'Priority', 'thank-you-page-for-woocommerce-nextmove' ),
		);

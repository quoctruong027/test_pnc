...
class xlwcty_Admin {
	...
	public function hooks() {
		 ...
		 */
		add_filter( 'xl_cmb2_add_conditional_script_page', array(
			'XLWCTY_Admin_CMB2_Support',
			'xlwcty_push_support_form_cmb_conditionals',
		) );
		/**
		 ...
		 */
		add_filter( 'postbox_classes_product_xlwcty_product_option_tabs', array(
			$this,
			'xlwcty_metabox_always_open',
		) );
		/**
		 ...
		 */
		add_action( 'woocommerce_settings_' . XLWCTY_Common::get_wc_settings_tab_slug(), array(
			$this,
			'xlwcty_woocommerce_options_page',
		) );
		/**
		...
		add_action( 'save_post_' . XLWCTY_Common::get_thank_you_page_post_type_slug(), array(
			$this,
			'save_menu_order',
		), 10, 2 );
		...
		add_action( 'xlwcty_add_on_setting-xlwcty_settings', array( $this, 'xlwcty_admin_page_settings_render' ) );
		add_action( 'admin_init', array( $this, 'maybe_show_wizard' ) );
		add_action( 'xl_license_activated', array( $this, 'maybe_run_install' ) );

		add_filter( 'theme_' . XLWCTY_Common::get_thank_you_page_post_type_slug() . '_templates', array(
			$this,
			'allow_page_templates_on_thankyou_post_types',
		), 10, 4 );
		...
		/**
		 * Deleting nextmove transient when cmb2 saved
		 */
	...
	public static function handle_activation() {
					...
					'basic'      => array(
						'first' => array(
							array(
								'slug'      => '_xlwcty_order',
								'component' => '_xlwcty_order',
								'name'      => __( 'Order Confirmation', 'thank-you-page-for-woocommerce-nextmove' ),
							),
							array(
								'slug'      => '_xlwcty_order_details',
								'component' => '_xlwcty_order_details',
								'name'      => __( 'Order Details', 'thank-you-page-for-woocommerce-nextmove' ),
							),
							array(
								'slug'      => '_xlwcty_customer_information',
								'component' => '_xlwcty_customer_information',
								'name'      => __( 'Customer Details', 'thank-you-page-for-woocommerce-nextmove' ),
							),
							array(
								'slug'      => '_xlwcty_additional_info',
								'component' => '_xlwcty_additional_info',
								'name'      => __( 'Additional Information', 'thank-you-page-for-woocommerce-nextmove' ),
							),
						),
					),
					'two_column' => array(
		...
		if ( 'no' == $is_default_added ) {
			foreach ( $defaults as $key => $default_setup ) {
				$id = wp_insert_post( array(
					'post_type'    => XLWCTY_Common::get_thank_you_page_post_type_slug(),
					'post_title'   => __( 'Thank You', 'thank-you-page-for-woocommerce-nextmove' ),
					'post_name'    => sanitize_title( __( 'Thank You', 'thank-you-page-for-woocommerce-nextmove' ) ),
	...
	public static function add_metaboxes() {
		 ...
		 * Add Rules metabox
		 */
		add_meta_box( 'xlwcty_rules', __( 'Rules', 'thank-you-page-for-woocommerce-nextmove' ), array(
			__CLASS__,
			'rules_metabox',
		 ...
		 */
		add_meta_box( 'xlwcty-custom-page', __( 'Select Custom Page', 'thank-you-page-for-woocommerce-nextmove' ), array(
			__CLASS__,
		 ...
		 */
		add_meta_box( 'xlwcty_shortcodes', __( 'Active Components Shortcodes', 'thank-you-page-for-woocommerce-nextmove' ), array(
			__CLASS__,
	...
	public static function add_metaboxes_newpost() {
		if ( ! isset( $_GET['post'] ) && empty( $_GET['post'] ) ) {
			add_meta_box( 'xlwcty_new_post', 'Getting Started', array(
				__CLASS__,
				'new_post_metabox',
			), XLWCTY_Common::get_thank_you_page_post_type_slug(), 'normal', 'high' );
		}
	...
	public static function xlwcty_select_custom_thank_you_page() {
		?>
        <p><strong><?php echo __( 'Redirect to Custom Page', 'thank-you-page-for-woocommerce-nextmove' ); ?></strong></p>
        <select name="xlwcty_custom_thank_you_page" id="xlwcty_custom_thank_you_page">
            <option value=""><?php echo esc_attr( __( 'Use current page', 'thank-you-page-for-woocommerce-nextmove' ) ); ?></option>
        ...
        <p><?php echo __( 'Choose a page above if you want to redirect buyer to a custom thank you page. This page will show once rules are validated.', 'thank-you-page-for-woocommerce-nextmove' ); ?></p>
        <script>
	...
	public static function available_shortcodes_metabox() {
		...
		echo '<thead>';
		echo '<tr>';
		echo '<th><strong>' . __( 'Component', 'thank-you-page-for-woocommerce-nextmove' ) . '</strong></th>';
		echo '<th><strong>' . __( 'Shortcode', 'thank-you-page-for-woocommerce-nextmove' ) . '</strong></th>';
		echo '</tr>';
		echo '</thead>';

		echo '<tbody>';
		echo '<tr>';
		echo '<td>' . __( 'All Components', 'thank-you-page-for-woocommerce-nextmove' ) . '</td>';
		echo '<td><input type="text" style="width: 75%;" onClick="this.select()" readonly value="[xlwcty_load]"><br> <span class="desc">' . __( 'This shortcode is used to display the whole thank you page layout according to the selected template', 'thank-you-page-for-woocommerce-nextmove' ) . '</span></td>';
		echo '</tr>';
	...
	public static function new_post_metabox() {
		ob_start();
		?>
        <h3><?php _e( "Congrats! You're on your way to creating a new Thank You Page. Follow these 4 simple steps:", 'thank-you-page-for-woocommerce-nextmove' ); ?></h3>
        <ul>
            <li>
                <strong><?php _e( 'Step 1', 'thank-you-page-for-woocommerce-nextmove' ); ?></strong>: <?php _e( 'Enter the page title above to name your Thank you page.', 'thank-you-page-for-woocommerce-nextmove' ); ?>
            </li>
            <li>
                <strong><?php _e( 'Step 2', 'thank-you-page-for-woocommerce-nextmove' ); ?></strong>: <?php _e( 'Select the Rules below. The page will open when set rules were matched.', 'thank-you-page-for-woocommerce-nextmove' ); ?>
            </li>
            <li>
                <strong><?php _e( 'Step 3', 'thank-you-page-for-woocommerce-nextmove' ); ?></strong>: <?php _e( 'Input the page priority on the right sidebar.', 'thank-you-page-for-woocommerce-nextmove' ); ?>
            </li>
            <li>
                <strong><?php _e( 'Step 4', 'thank-you-page-for-woocommerce-nextmove' ); ?></strong>: <?php _e( 'Press the Publish button on the top right sidebar. You will be automatically redirected to a components UI.', 'thank-you-page-for-woocommerce-nextmove' ); ?>
            </li>
            <li>
                <strong><?php _e( 'Step 5', 'thank-you-page-for-woocommerce-nextmove' ); ?></strong>: <?php _e( "Choose the components you'd like to display, edit and arrange them in order.", 'thank-you-page-for-woocommerce-nextmove' ); ?>
            </li>
            <li>
                <strong><?php _e( 'Step 6', 'thank-you-page-for-woocommerce-nextmove' ); ?></strong>: <?php _e( "Hit Preview and you're all set to go live!", 'thank-you-page-for-woocommerce-nextmove' ); ?>
            </li>
        </ul>
		<?php
	}
	...
	public function xlwcty_woocommerce_options_page() {
		...
		$sections         = array_merge( $sections, apply_filters( 'xlwcty_section_pages', array() ) );
		?>
        <style>
            body {
                position: relative;
        ...
        <div class="wrap cmb2-options-page xlwcty_global_option">
			...
			if ( is_array( $sections ) && count( $sections ) > 0 ) {
				foreach ( $sections as $key => $pages ) {
					if ( filter_input( INPUT_GET, 'section' ) == $key && filter_input( INPUT_GET, 'tab' ) == 'xl-thank-you' ) {
						$addon_found = true;
						do_action( 'xlwcty_add_on_setting-' . $pages );
						break;
					}
				}
			}
	...
	public function admin_page() {
		?>
        <h1 class="wp-heading-inline"><?php echo __( 'Thank You Pages', 'thank-you-page-for-woocommerce-nextmove' ); ?></h1>
		<?php
		$tabs = array(
			array(
				'title' => __( 'Add New', 'thank-you-page-for-woocommerce-nextmove' ),
				'link'  => admin_url( 'post-new.php?post_type=' . XLWCTY_Common::get_thank_you_page_post_type_slug() ),
			),
			array(
				'title' => __( 'Settings', 'thank-you-page-for-woocommerce-nextmove' ),
				'link'  => admin_url( 'admin.php?page=wc-settings&tab=xl-thank-you&section=settings' ),
				'class' => array( 'xlwcty-a-blue' ),
			),
		);

		$tabs = apply_filters( 'xlwcty_setting_option_tabs', $tabs );
		if ( is_array( $tabs ) && count( $tabs ) > 0 ) {
			foreach ( $tabs as $key => $val ) {
				$extra_class = ( isset( $val['class'] ) && is_array( $val['class'] ) ) ? ' ' . implode( ' ', $val['class'] ) : '';
				?>
                <a href="<?php echo $val['link']; ?>"
                   class="page-title-action<?php echo $extra_class; ?>"><?php echo $val['title']; ?></a>
				<?php
			}
		}
		?>
	...
	public function xlwcty_admin_page_settings_render() {
		$xlwcty_faq = array(
			__( 'I was unable to set up Thank You Page?', 'thank-you-page-for-woocommerce-nextmove' )                                        => __( 'Kindly visit our <a href="https://xlplugins.com/documentation/nextmove-woocommerce-thank-you-page/getting-started/">documentation</a> to know more about how to setup thank you pages. ', 'thank-you-page-for-woocommerce-nextmove' ),
			__( 'Thank You page is not coming on frontend?', 'thank-you-page-for-woocommerce-nextmove' )                                     => __( 'Visit this step-by-step <a href="https://xlplugins.com/documentation/nextmove-woocommerce-thank-you-page/troubleshooting-guides/thank-you-page-didnt-show/">documentation guide</a> to uncover the reasons for why Thank You Page may not be showing up.. ', 'thank-you-page-for-woocommerce-nextmove' ),
			__( 'Who is Next Move ideal for?', 'thank-you-page-for-woocommerce-nextmove' )                                                   => __( 'Next Move is for WooCommerce store owners who want to generate repeat orders on autopilot. They understand the real potential of Thank You pages in the funnel but never had the right tools to exploit it.', 'thank-you-page-for-woocommerce-nextmove' ),
			__( 'Does NextMove Modify existing Thank You page or creates a new Thank You page?', 'thank-you-page-for-woocommerce-nextmove' ) => __( 'NextMove generates a new thank you page and adds components as defined by you.', 'thank-you-page-for-woocommerce-nextmove' ),
			__( 'What is referred to as a component?', 'thank-you-page-for-woocommerce-nextmove' )                                           => __( 'Each section on the WooCommerce Thank You page such as Order Confirmation, Items, Billing Information, Text, Image, HTML, Videos etc are referred to as a component.', 'thank-you-page-for-woocommerce-nextmove' ),
			__( 'What kind of components can I add to my Thank You Pages?', 'thank-you-page-for-woocommerce-nextmove' )                      => __( "There are 17 different components or what we call the building blocks in Thank You pages. See the pricing table to refer. You can choose and add whatever components you want on your Thank You Pages. It's as zippy and hassle-free as it sounds!", 'thank-you-page-for-woocommerce-nextmove' ),
			__( "Can I customize the components to match my site's themes?", 'thank-you-page-for-woocommerce-nextmove' )                     => __( "Yes, all the components of Next Move can be customized. Match the skin colors to your store's theme, add borders, change the font size and more. Nothing is rigid here.", 'thank-you-page-for-woocommerce-nextmove' ),
			__( 'Can I turn off individual components?', 'thank-you-page-for-woocommerce-nextmove' )                                         => __( 'Absolutely! You can turn off different components based your choice and requirements.', 'thank-you-page-for-woocommerce-nextmove' ),
			__( 'Can I set up multiple Thank You Pages based on product or categories?', 'thank-you-page-for-woocommerce-nextmove' )         => __( 'Yes, You can set up as many Thank you pages as you like. You can dive deep and show Thank you pages to customers based on their order value, items purchased, payment gateways, shipping methods used, country of visitor and other parameters. Sky is the limit. Quite literally.', 'thank-you-page-for-woocommerce-nextmove' ),
			__( 'What is Rule Builder?', 'thank-you-page-for-woocommerce-nextmove' )                                                         => __( 'Rule builder allows you set up different rules and only when conditions are met a particular thank you page is shown.<br/>Say you want to show specific thank you page based on different items purchased. You can set up the rule to show different pages when rules are met.', 'thank-you-page-for-woocommerce-nextmove' ),
			__( 'Do I need to make an order every time to preview the page?', 'thank-you-page-for-woocommerce-nextmove' )                    => __( 'No, We have the feature to choose the preview order and look at how Thank You page would look. Once you are satisfied with the look, you can switch it.', 'thank-you-page-for-woocommerce-nextmove' ),
			__( 'Can I build Thank You page in sandbox mode until I finalized the page?', 'thank-you-page-for-woocommerce-nextmove' )        => __( "Yes, There is a global setting in which you can choose to switch NextMove Mode to sandbox mode while building pages. Don't forget to switch to Live mode when done :)", 'thank-you-page-for-woocommerce-nextmove' ),
			__( 'I run my website in a different language. Can I change the text?', 'thank-you-page-for-woocommerce-nextmove' )              => __( 'Yes, you can easily create Thank You Pages in your language. We are also compatible with WPML.', 'thank-you-page-for-woocommerce-nextmove' ),
		);
		?>
        <div class="notice">
            <p><?php _e( 'Back to <a href="' . admin_url( 'admin.php?page=wc-settings&tab=' . XLWCTY_Common::get_wc_settings_tab_slug() . '' ) . '">' . XLWCTY_FULL_NAME . '</a> listing.', 'thank-you-page-for-woocommerce-nextmove' ); ?></p>
        </div>
            ...
            <div class="wrap cmb2-options-page xlwcty_global_option">
                ...
                <div class="xlwcty-help-half-right xlwcty-debug-wrap">
                    <div id="poststuff" class="wrap">
                        <h3> <?php _e( 'Troubleshoot Your Page', 'thank-you-page-for-woocommerce-nextmove' ); ?></h3>
                        <div class="postbox-container">
                            ...
                            <div class="accordion-container">
                                <h3> <?php _e( 'FAQs', 'thank-you-page-for-woocommerce-nextmove' ); ?></h3>
	...
	public function xlwcty_enqueue_admin_assets() {
		if ( XLWCTY_Common::is_load_admin_assets( 'all' ) ) {
			...
			if ( XLWCTY_Common::is_load_admin_assets( 'builder' ) ) {
				...
				wp_enqueue_script( 'xlwcty-swal-js', $this->get_admin_url() . '/assets/js/sweetalert.min.js', array(), XLWCTY_VERSION );
			}
			...
			wp_enqueue_script( 'xlwcty_admin-js', $this->get_admin_url() . '/assets/js/xlwcty-admin' . $min . '.js', array(
				'jquery',
				'cmb2-scripts',
			...
			if ( XLWCTY_Common::is_load_admin_assets( 'builder' ) ) {
				wp_enqueue_script( 'xlwcty-mCustomScrollbar-js', $this->get_admin_url() . '/assets/js/jquery.mCustomScrollbar.concat.min.js', array(), XLWCTY_VERSION );
			}

			wp_localize_script( 'xlwcty_admin-js', 'xlwcty_localized_texts', array(
				'no_orders'        => array(
					'title' => __( 'Oops!', 'thank-you-page-for-woocommerce-nextmove' ),
					'text'  => __( 'We do not have any orders to generate preview.', 'thank-you-page-for-woocommerce-nextmove' ),
				),
				'no_component'     => array(
					'title' => __( 'Oops!', 'thank-you-page-for-woocommerce-nextmove' ),
					'text'  => __( 'Please chose at least one component.', 'thank-you-page-for-woocommerce-nextmove' ),
				),
				'changes'          => array(
					'title'             => __( 'Changes have been made!', 'thank-you-page-for-woocommerce-nextmove' ),
					'text'              => __( 'You need to save changes before generating preview.', 'thank-you-page-for-woocommerce-nextmove' ),
					'confirmButtonText' => __( 'Yes, Save It!', 'thank-you-page-for-woocommerce-nextmove' ),
				),
				'no_orders'        => array(
					'title' => __( 'Oops!', 'thank-you-page-for-woocommerce-nextmove' ),
					'text'  => __( 'We do not have any orders to generate preview.', 'thank-you-page-for-woocommerce-nextmove' ),
				...
				'saving'           => array(
					'title' => __( 'Saving Your Data', 'thank-you-page-for-woocommerce-nextmove' ),
					'text'  => '',
				),
				'reset_permalinks' => array(
					'title' => __( 'Warning', 'thank-you-page-for-woocommerce-nextmove' ),
					'text'  => __( 'You would need to reset permalinks to generate Preview. Go to Admin -> Settings -> Permalinks and Reset. ', 'thank-you-page-for-woocommerce-nextmove' ),
				),

			) );

			wp_localize_script( 'xlwcty_admin-js', 'builder_page_url', admin_url( 'admin.php?page=xlwcty_builder' ) );
			wp_localize_script( 'xlwcty_admin-js', 'xlwcty_site_url', site_url() );
			wp_localize_script( 'xlwcty_admin-js', 'xlwcty_admin_permalink', admin_url( 'options-permalink.php' ) );
			wp_localize_script( 'xlwcty_admin-js', 'xlwcty_id', filter_input( INPUT_GET, 'id' ) );
			...
			wp_localize_script( 'xlwcty_admin-js', 'xlwcty_layout_preview', $template_previews );
			wp_localize_script( 'xlwcty_admin-js', 'xlwcty_layout_preview_template', $template_previews_template );
			wp_localize_script( 'xlwcty_admin-js', 'xlwcty_layout_preview_default', $template_previews_default );
			...
			if ( is_array( $g_settings ) && count( $g_settings ) > 0 ) {
				...
				if ( empty( $g_settingsp['fb_app_id'] ) ) {
					$xlwcty_components_message['_xlwcty_social_coupons'] = __( 'Facebook App ID not present in settings' );
				}
				if ( is_array( $xlwcty_components_message ) && count( $xlwcty_components_message ) > 0 ) {
	...
	public function modify_woocommerce_settings( $settings ) {
		$settings[ XLWCTY_Common::get_wc_settings_tab_slug() ] = __( 'NextMove: XLPlugins', 'thank-you-page-for-woocommerce-nextmove' );
	...
	public function xlwcty_post_xlwcty_load_assets( $handle ) {
		...
		if ( XLWCTY_Common::is_load_admin_assets( 'all' ) ) {
			...
			wp_enqueue_style( 'jquery-confirm', $this->get_admin_url() . '/assets/css/jquery-confirm.min.css', array(), XLWCTY_VERSION );
			...
			if ( is_rtl() ) {
				wp_register_script( 'xl-chosen-rtl', $this->get_admin_url() . '/assets/js/chosen/chosen-rtl.js', array(), XLWCTY_VERSION );
			...
			wp_enqueue_script( 'jquery-confirm', $this->get_admin_url() . '/assets/js/jquery.jquery-confirm.min.js', array( 'jquery' ), XLWCTY_VERSION );
			...
			$data = array(
				...
				'text_or'               => __( 'or', 'thank-you-page-for-woocommerce-nextmove' ),
				'text_apply_when'       => __( 'Open this page when these conditions are matched', 'thank-you-page-for-woocommerce-nextmove' ),
				'remove_text'           => __( 'Remove', 'thank-you-page-for-woocommerce-nextmove' ),
			);
	...
	public function post_updated_messages( $messages ) {
		...
		$messages[ XLWCTY_Common::get_thank_you_page_post_type_slug() ] = array(
			...
			1  => sprintf( __( 'Thankyou Pages updated.', 'thank-you-page-for-woocommerce-nextmove' ), admin_url( 'admin.php?page=wc-settings&tab=' . XLWCTY_Common::get_wc_settings_tab_slug() . '' ) ),
			2  => __( 'Custom field updated.', 'thank-you-page-for-woocommerce-nextmove' ),
			3  => __( 'Custom field deleted.', 'thank-you-page-for-woocommerce-nextmove' ),
			4  => sprintf( __( 'Thankyou Pages updated. ', 'thank-you-page-for-woocommerce-nextmove' ), admin_url( 'admin.php?page=wc-settings&tab=' . XLWCTY_Common::get_wc_settings_tab_slug() . '' ) ),
			5  => isset( $_GET['revision'] ) ? sprintf( __( 'Trigger restored to revision from %s', 'thank-you-page-for-woocommerce-nextmove' ), wp_post_revision_title( (int) $_GET['revision'], false ) ) : false,
			6  => sprintf( __( 'Thankyou Pages updated. ', 'thank-you-page-for-woocommerce-nextmove' ), admin_url( 'admin.php?page=wc-settings&tab=' . XLWCTY_Common::get_wc_settings_tab_slug() . '' ) ),
			7  => sprintf( __( 'Trigger saved. ', 'thank-you-page-for-woocommerce-nextmove' ), admin_url( 'admin.php?page=wc-settings&tab=' . XLWCTY_Common::get_wc_settings_tab_slug() . '' ) ),
			8  => sprintf( __( 'Thankyou Pages updated. ', 'thank-you-page-for-woocommerce-nextmove' ), admin_url( 'admin.php?page=wc-settings&tab=' . XLWCTY_Common::get_wc_settings_tab_slug() . '' ) ),
			9  => sprintf( __( 'Trigger scheduled for: <strong>%1$s</strong>.', 'thank-you-page-for-woocommerce-nextmove' ), date_i18n( 'M j, Y @ G:i', strtotime( $post->post_date ) ) ),
			10 => __( 'Trigger draft updated.', 'thank-you-page-for-woocommerce-nextmove' ),
			11 => sprintf( __( 'Thankyou Pages updated. ', 'thank-you-page-for-woocommerce-nextmove' ), admin_url( 'admin.php?page=wc-settings&tab=' . XLWCTY_Common::get_wc_settings_tab_slug() . '' ) ),
		);
	...
	public function maybe_activate_post() {
		if ( isset( $_GET['action'] ) && $_GET['action'] == 'xlwcty-post-activate' ) {
			if ( wp_verify_nonce( $_GET['_wpnonce'], 'xlwcty-post-activate' ) ) {
				...
				die( __( 'Unable to Activate', 'thank-you-page-for-woocommerce-nextmove' ) );
			}
		}
	}
	...
	public function maybe_deactivate_post() {
		if ( isset( $_GET['action'] ) && $_GET['action'] == 'xlwcty-post-deactivate' ) {
			...
			if ( wp_verify_nonce( $_GET['_wpnonce'], 'xlwcty-post-deactivate' ) ) {
				...
				die( __( 'Unable to Deactivate', 'thank-you-page-for-woocommerce-nextmove' ) );
			}
		}
	}
	...
	public function save_menu_order( $post_id, $post = null ) {
		...
		remove_action( 'save_post_' . XLWCTY_Common::get_thank_you_page_post_type_slug(), array(
			$this,
			'save_menu_order',
		) );
		...
		if ( $post && $post->post_type === XLWCTY_Common::get_thank_you_page_post_type_slug() ) {
			...
			/**
			 * Clear transient when thank you page is saved
			 */
	...
	public function xlwcty_wc_admin_menu() {
		add_submenu_page( 'woocommerce', __( 'Thank You Page', 'thank-you-page-for-woocommerce-nextmove' ), __( 'Thank You Page', 'thank-you-page-for-woocommerce-nextmove' ), 'manage_woocommerce', 'admin.php?page=wc-settings&tab=' . XLWCTY_Common::get_wc_settings_tab_slug(), false );
	}
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" style="width: 75%;" onClick="this.select()" readonly
                                   value='{{coupon_name}}'/>
                            <p>
                                This will display the coupon name generated by the NextMove thank you page.<br/>
                            </p>
                        </td>
                    </tr>
					<?php
	...
	public function xlwcty_plugin_row_actions( $links, $file ) {
		if ( $file == XLWCTY_PLUGIN_BASENAME ) {
			$links[] = '<a href="' . add_query_arg( array(
					...
					'utm_term'     => 'Docs',
				), 'https://xlplugins.com/documentation/nextmove-woocommerce-thank-you-page/' ) . '">' . esc_html__( 'Docs', 'thank-you-page-for-woocommerce-nextmove' ) . '</a>';
			$links[] = '<a href="' . admin_url( 'admin.php?page=xlplugins&tab=support' ) . '">' . esc_html__( 'Support', 'thank-you-page-for-woocommerce-nextmove' ) . '</a>';
		}
	...
	public function xlwcty_add_editor_button() {
		if ( XLWCTY_Common::is_load_admin_assets( 'single' ) && filter_input( INPUT_GET, 'post' ) !== null ) {
            ...
            <div class="xlwcty-builder-button-wrap">
                <button id="xlwcty-builder-button-primary"
                        class="xlwcty-builder-button button button-primary button-hero xlwcsy_nav_editor">
                    <i class=""></i>
					<?php _e( '<span>XL</span> Manage Components', 'thank-you-page-for-woocommerce-nextmove' ); ?>
                </button>
            </div>
			<?php
		}
	...
	public function xlwcty_builder() {
		$page_title = __( 'Thank You Page Builder', 'thank-you-page-for-woocommerce-nextmove' );
	...
	public function xlwcty_admin_page_builder_render() {
		if ( ! isset( $_GET['id'] ) ) {
			wp_redirect( 'admin.php?page=wc-settings&tab=' . XLWCTY_Common::get_wc_settings_tab_slug() );
			exit;
		}
		?>
	...
	public function get_xlwcty_loading_screen() {
		if ( isset( $_GET['id'] ) ) {
			$xlwcty_screen_load_style = 'position:fixed;top:0;right:0;bottom:0;left:0;background-color:#fff;z-index:999999;width:100vw;height:100vh;';
			?>
            <div style="<?php echo $xlwcty_screen_load_style; ?>" class="xlwcty_screen_load">
                <div class="xlwcty_screen_wrap">
					...
					<?php if ( isset( $_COOKIE['xlwcty_preview_data'] ) && $_COOKIE['xlwcty_preview_data'] !== '' ) { ?>
                        <div class="xlwcty_load_info">
							<?php _e( "Your preview will open in new window automatically.<br/>If it doesn't click on Preview button again or allow Pop-ups for your domain.", 'thank-you-page-for-woocommerce-nextmove' ); ?>
                        </div>
                        <a style="visibility:hidden;" target="_blank"
                           href="<?php echo $_COOKIE['xlwcty_preview_data']; ?>"></a>
					<?php } ?>
                </div>
            </div>
			<?php
                ...
                <div class="xlwcty_table">
                    <div class="xlwcty_table_cell">
                        <div class="xlwcty_fl_lt">
                            <a href="<?php echo admin_url( 'admin.php?page=wc-settings&tab=xl-thank-you' ); ?>"
                               class="button"><i class="dashicons dashicons-arrow-left-alt" style="
	margin-top: 2px;
"></i></a>
							<?php
                        ...
                        <div class="xlwcty_fl_rt">
							...
							if ( is_array( $templates ) && count( $templates ) > 0 ) {
								...
								?>
                                <form target="_blank" id="choose_template_form"
                                      action="<?php echo get_the_permalink( $_GET['id'] ); ?>">
                                    <label>Template &nbsp;</label>
                                    <select id="_xlwcty_choose_template"
                                            data-placeholder="<?php echo __( 'Choose a Template' ); ?>">
										<?php
                            ...
                            <form target="_blank" id="order_preview_form" action="<?php echo $preview_action; ?>">
								...
								?>
                                <select class="preview_order_id" data-placeholder="<?php echo __( 'Choose an Order' ); ?>">
									<?php
	...
	public function maybe_show_wizard() {
		if ( ! isset( $_GET['tab'] ) || empty( $_GET['page'] ) || 'wc-settings' !== $_GET['page'] ) {
			return;
		}
		if ( empty( $_GET['tab'] ) || XLWCTY_Common::get_wc_settings_tab_slug() !== $_GET['tab'] ) {
			return;
		}
		if ( strpos( $_GET['tab'], 'wizard' ) !== false ) {
			return;
		}
		if ( XLWCTY_Core()->xl_support->is_license_present() === false ) {
			wp_redirect( admin_url( 'admin.php?page=xlplugins&tab=' . XLWCTY_SHORT_SLUG . '-wizard' ) );
		}
	}

	public function maybe_run_install( $pluginbase ) {
		if ( XLWCTY_PLUGIN_BASENAME === $pluginbase ) {
	...
	/**
	 * @hooked over `generate_rewrite_rules`
	 * Resets our ket when permalik structure created in WordPress
	 */
	public function unset_permalink_error_state() {
		update_option( '_xlwcty_page_permalink_state', 'yes' );
	}
	...
	public function admin_footer_text( $footer_text ) {
		if ( XLWCTY_Common::is_load_admin_assets( 'all' ) ) {
			$msg = 'If you like <strong>' . XLWCTY_FULL_NAME . '</strong>, please leave us a <a href="https://wordpress.org/support/plugin/woo-thank-you-page-nextmove-lite/reviews/?rate=5#new-post" target="_blank" class="wc-rating-link" data-rated="Thanks :)">&#9733;&#9733;&#9733;&#9733;&#9733;</a> rating. A huge thanks in advance!';
			...
			if ( isset( $plugins->response ) && is_array( $plugins->response ) ) {
				...
				if ( is_array( $plugins ) && count( $plugins ) > 0 && in_array( XLWCTY_PLUGIN_BASENAME, $plugins ) ) {
                    ...
                    <div class="notice notice-warning is-dismissible">
                        <p>
							<?php
							_e( sprintf( 'Attention: There is an update available of <strong>%s</strong> plugin. &nbsp;<a href="%s" class="">Go to updates</a>', XLWCTY_FULL_NAME, admin_url( 'plugins.php?s=nextmove&plugin_status=all' ) ), 'thank-you-page-for-woocommerce-nextmove' );
							?>
                        </p>
                    </div>
					<?php

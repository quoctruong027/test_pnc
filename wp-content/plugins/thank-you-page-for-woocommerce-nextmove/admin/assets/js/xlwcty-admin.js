...
var xlwctyCookieName = "xlwcty_cook_post_tab_open_" + xlwcty_id;
...
//                $.post(ajaxurl, {"action":"xlwcty_get_passes_cookie"}, function(){
//                    console.log(CookieVal);
//                         var win = window.open(CookieVal, '_blank');
//                    win.focus();
//                });
            }, 600);
        }
    ...
    $(document).on("click", ".xlwcsy_nav_editor", function (e) {
        e.preventDefault();
        document.location.href = builder_page_url + "&id=" + $("input[name='post_ID']").val();
        return false;
    });
    ...
    $("form#order_preview_form").submit(function (e) {
...
(function ($) {
    $(document).on('cmb_init', function (e, cmb) {

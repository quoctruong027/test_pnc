...
class XLWCTY_Wizard {
	...
	public static function setup_wizard_header() {
        ...
        <h1 id="wc-logo"><img width="200px;" src="//storage.googleapis.com/xlplugins/xlplugins-w200.png"/>
			<?php
			//			$image_url = do_shortcode(get_theme_mod( 'site_logo', get_template_directory_uri().'/assets/img/logo.png'));
			//			$image_url = apply_filters('xlwcty_setup_logo_image',$image_url);
			//			if ( $image_url ) {
			//				$image = '<img class="site-logo" src="%s" alt="%s" style="width:%s; height:auto" />';
			//				printf(
			//					$image,
			//					$image_url,
			//					get_bloginfo( 'name' ),'200px'
			//				);
			//			}
			?>
        </h1>
	...
	public static function xlwcty_setup_ready() {
        ...
        <ul>
            <li>
                <a target="_blank" href="https://xlplugins.com/documentation/nextmove-woocommerce-thank-you-page/getting-started/">
            ...
            <li>
                <a target="_blank" href="https://xlplugins.com/documentation/nextmove-woocommerce-thank-you-page/troubleshooting-guides/">Troubleshooting guides to solve common issues</a>
            </li>
	...
	public static function xlwcty_setup_activate() {
        ...
        <form id="xlwcty_verify_license" action="" method="POST">
            ...
            <p>
                ...
                Follow <a target="_blank" href="https://xlplugins.com/documentation/nextmove-woocommerce-thank-you-page/getting-started/">this step by step

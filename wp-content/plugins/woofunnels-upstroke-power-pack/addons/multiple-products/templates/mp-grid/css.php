...
if ( isset( $css['pblock_header_color'] ) && is_array( $css['pblock_header_color'] ) && count( $css['pblock_header_color'] ) > 0 ) {
	foreach ( $css['pblock_header_color'] as $pro_key => $val ) {
		$output[ '.wfocu-pkey-' . $pro_key . ' .wfocu-pblock-header' ]['background-color'] = $val;
	}
}

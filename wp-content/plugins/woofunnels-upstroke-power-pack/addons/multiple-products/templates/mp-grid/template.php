...
/**
 * Class WFOCU_Template_MP_Grid
 */
class WFOCU_Template_MP_Grid extends WFOCU_Customizer_Common {

	private static $ins = null;
	public $template_slug = 'mp-grid';
	...
	public function add_styles( $styles ) {
		...
		$styles['mp-grid-css']              = array(
			'path'      => plugin_dir_url( WFOCU_MP_PLUGIN_FILE ) . 'templates/mp-grid/css/style.css',
		...
		$styles['mp-grid-urgency-bar-css']  = array(
			'path'      => plugin_dir_url( WFOCU_MP_PLUGIN_FILE ) . 'templates/mp-grid/css/urgency-bar.css',
			'version'   => WFOCU_VERSION,
			'in_footer' => false,
			'supports'  => array(
				'customizer',
		...
		$styles['mp-grid-product-grid-css'] = array(
			'path'      => plugin_dir_url( WFOCU_MP_PLUGIN_FILE ) . 'templates/mp-grid/css/product-grid.css',
			'version'   => WFOCU_VERSION,
			'in_footer' => false,
			'supports'  => array(
				'customizer',
					...
					'heading' => array(
						...
						'fields' => array(
							...
							'head'           => array(
								...
								'default'       => __( "Wait <span class=\"wfocu-highlight\">{{customer_first_name}}</span>! We've got a special offer for you that complements your purchase.", 'woofunnels-upstroke-power-pack' ),
								'transport'     => 'postMessage',
								'wfocu_partial' => array(
					...
					'guarantee' => array(
						...
						'fields' => array(
							...
							'additional_text'    => array(
								...
								'label'           => __( 'Additional Text', 'woofunnels-upstroke-power-pack' ),
								'description'     => $merge_tags_description,
								'default'         => esc_attr__( 'Got a guarantee or a solid return/refun policy? Highlight them all here to arrest your buyers\'s last-minute objections. Reinforce the trust.', 'woofunnels-upstroke-power-pack' ),
								'transport'       => 'postMessage',
								'wfocu_transport' => array(
									array(
										'type'       => 'html',
						...
						'fields' => array(
							...
							'layout'            => array(
								...
								'choices'  => array(
									'style1' => array(
										'label' => __( 'Style 1', 'woofunnels-upstroke-power-pack' ),
										'path'  => WFOCU_MP_ADMIN_ASSETS_URL . '/img/mp_grid_col3.svg',
									),
									'style2' => array(
										'label' => __( 'Style 2', 'woofunnels-upstroke-power-pack' ),
										'path'  => WFOCU_MP_ADMIN_ASSETS_URL . '/img/mp_grid_col2.svg',
									),
								),
								'priority' => 20,
							),
				...
				if ( isset( $product->id ) && $product->id > 0 ) {
					...
					$product_panel['wfocu_product']['sections'][ 'product_' . $hash_key ] = array(
						...
						'fields' => array(
							...
							'desc_talign'            => array(
								'type'            => 'radio-buttonset',
								'label'           => __( 'Description Alignment', 'woofunnels-upstroke-power-pack' ),
								'default'         => 'wfocu-text-center',
								'choices'         => array(
									'wfocu-text-left'   => 'Left',
									'wfocu-text-center' => 'Center',
								...
								'wfocu_transport' => array(
									array(
										'type'   => 'class',
										'elem'   => '.wfocu-pkey-' . $hash_key . ' .wfocu-pblock-detail',
										'remove' => array( 'wfocu-text-left', 'wfocu-text-center', 'wfocu-text-right' ),
									),
								),
								'priority'        => 200,
							...
							'header_bg_color'        => array(
								'type'            => 'color',
								'label'           => esc_attr__( 'Header Background Color', 'woofunnels-upstroke-power-pack' ),
								'default'         => '#ffffff',
								'choices'         => array(
									'alpha' => true,
								),
								...
								'wfocu_transport' => array(
									array(
										'type' => 'css',
										'prop' => array( 'background-color' ),
										'elem' => '.wfocu-pkey-' . $hash_key . ' .wfocu-pblock-header',
									),
								),
							),
							'title_color'            => array(
	...
	public function maybe_set_template_path( $existing, $slug ) {
		...
		if ( '/product-grids/style1' === $slug ) {
			return plugin_dir_path( WFOCU_MP_PLUGIN_FILE ) . 'templates/mp-grid/views' . $slug . '.php';
		}
...
return WFOCU_Template_MP_Grid::get_instance();

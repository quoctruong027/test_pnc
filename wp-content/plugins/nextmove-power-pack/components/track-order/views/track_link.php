    ...
    <table role="presentation" cellpadding="0" cellspacing="0" style="font-size:0px;width:100%;background:#fff;" align="center" border="0">
        ...
        <tr>
            <td style="text-align:center;vertical-align:top;direction:ltr;font-size:0px;padding:0px">
                ...
                <![endif]-->
                <div style="margin:0px auto;max-width:600px;background:<?php echo $section_bg_color; ?>;">
                    <table role="presentation" cellpadding="0" cellspacing="0" style="font-size:0px;width:100%;background:<?php echo $section_bg_color; ?>;" align="center" border="0">
                        <tbody>
                        <tr>
                                        ...
                                        <tr>
                                            <td style="word-wrap:break-word;font-size:0px;padding:10px 25px;padding-top:0px;padding-bottom:0px;padding-right:0px;padding-left:0px;" align="center">
                                                <table role="presentation" cellpadding="0" cellspacing="0" style="border-collapse:separate;width:100%;" align="center" border="0">
                                                    <tbody>
                                                    <tr>
                                                        <td style="border:none;border-radius:6px;color:#FFFFFF;cursor:auto;padding:10px 25px;" align="center" valign="middle" bgcolor="<?php echo $bg_color; ?>">
                                                            <a href="<?php echo $url; ?>" style="display:block;text-decoration:none;color:<?php echo $text_color; ?>;font-family: Arial, sans-serif;font-size:16px;line-height:16px;font-weight:600;text-transform:none;margin:0px;" target="_blank"><?php echo $button_text; ?></a>
                                                        </td>
                                                    </tr>
                                                    </tbody>
                                                </table>

                ...
                <div class="wcct_pro_table">
                    <div class="wcct_pro_tableCell wcct_contentBox">
                        <div class="wcct_innerBox">
                            <h2 class="wcct_pro_title"><a
                                        href="<?php echo $product_link; ?>"><?php echo $product->get_title(); ?></a>
                            </h2>
							<?php
							if ( 'on' !== $hide_rating ) {
                            ...
                            <div class="wcct_hide_tab">
                                <div class="wcct_col50_wrap">
                                    <div class="wcct_col50 wcct_bottom_20">
                                        <div class="wcct_col50Cell wcct_left_align <?php echo intval( $is_show_bar ) !== 1 ? 'wcct_pro_row_full_width' : ''; ?>">
											<?php
                                        ...
                                        <div class="wcct_col50Cell wcct_right_align">
                                    ...
                                    <div class="wcct_tableCell_50 wcct_cell_right">
                                        <div class="wcct_hide_desktop">
                                            <div class="wcct_pro_price_wrap">
                                                ...
                                                <span class="wcct_pro_save">
													<span class="wcct_save_text"><?php printf( '%s', nl2br( $yousave_text ) ); ?></span>
													<span class="wcct_save_percent"><?php echo wcct_get_product_savings( $product, $yousave_value ); ?></span>
												</span>
                                            </div>
                                        </div>

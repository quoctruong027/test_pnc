    ...
    function getLineItemsDetails()
    {
        ...
        if (!empty($order_items)) {
            foreach ($order_items as $item_id => $item) {
                ...
                $items[] = array(
                    'image_url' => apply_filters('woocommerce_order_item_thumbnail', (self::$woocommerce->getItemImageId($product)) ? current(wp_get_attachment_image_src(self::$woocommerce->getItemImageId($product), 'thumbnail')) : self::$woocommerce->getPlaceHolderImage()),

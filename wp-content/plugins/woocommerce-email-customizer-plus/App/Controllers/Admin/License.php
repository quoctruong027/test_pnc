...
class License
{
    ...
    function loadEmailCustomizerDescription($pluginInfo, $result)
    {
        ...
        $pluginInfo->last_updated = "2020-8-4 5:30";
        $pluginInfo->version = WECP_PLUGIN_VERSION;
        $pluginInfo->active_installs = 300;
        return $pluginInfo;
    }
...
Create professional, beautiful transactional emails for your WooCommerce Online store.</p>
    ...
    {
        return '<ul>
                    <li>Improvement: Woocommerce bookings compatibility added</li>

                        ...
                        <div id="amazon-marketplace-select" class="amazon-marketplace-common amazon-marketplace_select"
                            ...
                            <div class="">
                                ...
                                <div class="table-block">
                                    ...
                                    <a id="submit_after_skip" onclick="return amwscp_AddMarketplaceCodeOption();"
                                       class="skip-btn-KTG button button-primary button-hero" style="display: none;"
                                       href="#connect_amazon"
                                        ...
                                        <div class="carousel-inner">
                                            ...
                                            <div class="item">
                                                <div id="message_box_for_default_account"
                                                    ...
                                                    <p> We’re still working on <span id=merchant_name>Australia</span>
                                                        Connection for direct products upload and sync features.
                                                        Please click Save button to create your product feed for <span
                                                                id=merchant_name>Australia</span> and upload the product
                                                        feed to your Seller Central.
                                                        We’ll notify you once we release the Direct Upload feature for
                                                        <span id=merchant_name>Australia</span>
                                                    </p>
                                                </div>
                                            </div>
                                            <div class="item active">
                                                <div id="message_box_for_default_account"
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li>Enter <b>ExportFeed</b> in the Developer’s Name text box.
                                                        </li>
                                                        <li class="developerID">Enter
                                                            <div class="tooltip" id="copyDeveloperID"
                                                                 onclick="copy(this);">349543377271
                                                            </div>
                                                            <span class="tooltiptext">Click to copy</span> in the
                                                            Developer’s ID box.
                                                        </li>

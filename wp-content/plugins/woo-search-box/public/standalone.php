...
<div style="width:100%" class="search-form" action="" method="get">
  <label>
    ...
    style="width: 100%;float:left; padding: 13px 15px 12px 15px;" name="s" type="search"  placeholder="Search..." autocomplete="off" value="<?php echo $gws;?>"></label>
...
<script>
maxcount_standalone=0;
jQuery(function(){
  maxcount_standalone=guaven_woos.maxcount;
...
var blocker_timeout='';
guaven_woos_suggestion_standalone_blocker=0;
   ...
   if (jQuery('#guaven_woos_suggestion_standalone_bottom').isOnScreen() == true) {
     if (guaven_woos_suggestion_standalone_blocker==0){
       guaven_woos_suggestion_standalone_blocker=1;
        guaven_woos.maxcount=guaven_woos.maxcount+maxcount_standalone;
       guaven_woos_runner();
       jQuery("#guaven_woos_standalone_s").trigger("keyup");

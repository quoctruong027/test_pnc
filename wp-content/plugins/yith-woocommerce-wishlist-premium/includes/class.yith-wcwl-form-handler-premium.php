	...
	class YITH_WCWL_Form_Handler_Premium {
		...
		public static function add_all_to_cart() {
			...
			if ( ! empty( $processed ) ) {
				...
				wc_add_notice( __( apply_filters( 'yith_wcwl_add_all_to_cart_error_message', 'An error occurred while adding the items to the cart; please, try again later.' ), 'yith-woocommerce-wishlist' ), 'error' );
			}

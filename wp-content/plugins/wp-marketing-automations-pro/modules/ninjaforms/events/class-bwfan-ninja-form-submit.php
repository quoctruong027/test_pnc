...
final class BWFAN_Ninja_Form_Submit extends BWFAN_Event {
	...
	private function __construct() {
		$this->event_merge_tag_groups = array( 'ninjaforms' );
		...
		$this->event_rule_groups      = array( 'ninjaforms', 'bwf_contact' );
	...
	public function get_view_data() {
		...
		global $wpdb;
		$all_forms = $wpdb->get_results( 'SELECT id, title FROM `' . $wpdb->prefix . 'nf3_forms` ORDER BY title', ARRAY_A );

...
final class BWFAN_LD_Enroll_User_Into_Course extends BWFAN_Action {
	...
	protected function __construct() {
		$this->action_name     = __( 'Enroll User into Course(s)', 'autonami-automations-pro' );
		$this->action_desc     = __( 'This action enrolls a user into a selected courses', 'wp-marketing-automations' );
	...
	public function execute_action( $action_data ) {
		...
		return array(
			'status'  => 4,
			'message' => ( is_array( $result ) && isset( $result['bwfan_response'] ) ) ? $result['bwfan_response'] : __( 'User couldn\'t be enrolled in the course.', 'autonami-automations-pro' ),
		);
	}

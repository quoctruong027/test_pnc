...
final class BWFAN_LD_User_Enrolled_Into_Course extends BWFAN_Event {
	...
	private function __construct() {
		...
		$this->event_name             = __( 'User Enrolled into a Course', 'autonami-automations-pro' );
		$this->event_desc             = esc_html__( 'This event runs when the user is enrolled into a course.', 'autonami-automations-pro' );

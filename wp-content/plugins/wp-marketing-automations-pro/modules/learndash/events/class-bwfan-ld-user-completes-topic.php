...
final class BWFAN_LD_User_Completes_Topic extends BWFAN_Event {
	...
	private function __construct() {
		$this->event_merge_tag_groups = array( 'learndash_user', 'learndash_topic' );
		$this->event_name             = __( 'User Completes a Topic', 'autonami-automations-pro' );
		$this->event_desc             = esc_html__( 'This event runs when the user completes a topic.', 'autonami-automations-pro' );
		$this->event_rule_groups      = array( 'learndash_lesson', 'learndash_course', 'learndash_topic' );

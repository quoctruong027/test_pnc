...
final class BWFAN_AFFWP_Application_Approved extends BWFAN_Event {
	...
	private function __construct() {
		...
		$this->event_name             = esc_html__( 'Application Approved', 'autonami-automations-pro' );
		$this->event_desc             = esc_html__( 'This event runs after an affiliate application is approved.', 'autonami-automations-pro' );

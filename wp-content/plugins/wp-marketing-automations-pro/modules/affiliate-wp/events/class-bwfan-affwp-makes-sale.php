...
final class BWFAN_AFFWP_Makes_Sale extends BWFAN_Event {
	...
	private function __construct() {
		...
		$this->event_name             = esc_html__( 'Affiliate Makes A Sale', 'autonami-automations-pro' );
		$this->event_desc             = esc_html__( 'This event runs after an affiliate makes a sale.', 'autonami-automations-pro' );

...
final class BWFAN_UpStroke_Funnel_Started extends BWFAN_Event {
	...
	private function __construct() {
		...
		$this->event_name             = esc_html__( 'Funnel Started', 'autonami-automations-pro' );
		$this->event_desc             = esc_html__( 'This event runs after an upsell funnel is started.', 'autonami-automations-pro' );
	...
	public function load_hooks() {
		add_action( 'wfocu_funnel_init_event', [ $this, 'funnel_started' ], 999, 4 );
	}
	...
	public function funnel_started( $funnel_id, $order_id, $user_email, $payment_method ) {
...
if ( bwfan_is_woocommerce_active() && bwfan_is_woofunnels_upstroke_active() ) {
	return 'BWFAN_UpStroke_Funnel_Started';
}

...
final class BWFAN_WPFORMS_Form_Submit extends BWFAN_Event {
	...
	private function __construct() {
		$this->event_merge_tag_groups = array( 'wpforms' );
		...
		$this->event_rule_groups      = array( 'wpforms', 'bwf_contact' );
	...
	public function load_hooks() {
		...
		add_action( 'wp_ajax_bwfan_get_wpforms_form_fields', array( $this, 'bwfan_get_wpforms_form_fields' ) );
	...
	public function get_view( $db_eventmeta_saved_value ) {
        ...
        <script type="text/html" id="tmpl-event-<?php echo esc_html__( $this->get_slug() ); ?>">
            ...
            <div class="bwfan-col-sm-12 bwfan-p-0 bwfan-mt-15 bwfan-mb-15">
                ...
                <select id="bwfan-wpforms_form_submit_form_id" class="bwfan-input-wrapper" name="event_meta[form_id]">
        ...
        <script>
            jQuery(document).on('change', '#bwfan-wpforms_form_submit_form_id', function () {
                ...
                jQuery.ajax({
                    ...
                    datatype: "JSON",
                    data: {
                        action: 'bwfan_get_wpforms_form_fields',
                        id: selected_id,
                    },
	...
	public function bwfan_get_wpforms_form_fields() {
...
if ( bwfan_is_wpforms_active() ) {
	return 'BWFAN_WPFORMS_Form_Submit';
}

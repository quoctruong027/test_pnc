...
class BWFAN_WCS_Payment_Method extends BWFAN_Merge_Tag {
	...
	public function __construct() {
		...
		$this->tag_description = __( 'Subscription Payment Method', 'autonami-automations-pro' );
	...
	public function parse_shortcode( $attr ) {
		...
		$payment_method = BWFAN_Merge_Tag_Loader::get_data( 'wc_subscription' )->get_payment_method_to_display();
	...
	public function get_dummy_preview() {
		return __( 'Manual Renewal', 'autonami-automations-pro' );
	}
...
if ( bwfan_is_woocommerce_active() && bwfan_is_woocommerce_subscriptions_active() ) {
	BWFAN_Merge_Tag_Loader::register( 'wc_subscription', 'BWFAN_WCS_Payment_Method' );
}

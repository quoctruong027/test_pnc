...
class BWFAN_GF_Form_Field extends BWFAN_Merge_Tag {
	...
	public function get_view() {
        ...
        <select id="" class="bwfan-input-wrapper bwfan-mb-15 bwfan_tag_select bwfan_gf_form_fields" name="field"></select>
		<?php
...
if ( bwfan_is_gforms_active() ) {
	BWFAN_Merge_Tag_Loader::register( 'gforms', 'BWFAN_GF_Form_Field' );
}

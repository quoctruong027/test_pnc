...
class BWFAN_Fluent_Form_Field extends BWFAN_Merge_Tag {

	private static $instance = null;

	public function __construct() {
		$this->tag_name        = 'fluent_form_field';
		$this->tag_description = __( 'Form Field', 'autonami-automations-pro' );
		add_shortcode( 'bwfan_fluent_form_field', array( $this, 'parse_shortcode' ) );
	}
	...
	public function get_view() {
        ...
        <select id="" class="bwfan-input-wrapper bwfan-mb-15 bwfan_tag_select bwfan_fluent_form_fields" name="field"></select>
		<?php
	...
	public function parse_shortcode( $attr ) {
		...
		} else if ( strpos( $attr['field'], ':' ) !== false ) {
			$fieldsgroup      = explode( ':', $attr['field'] );
...
if ( bwfan_is_fluent_forms_active() ) {
	BWFAN_Merge_Tag_Loader::register( 'fluentforms', 'BWFAN_Fluent_Form_Field' );
}

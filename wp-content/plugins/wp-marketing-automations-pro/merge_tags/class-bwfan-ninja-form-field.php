...
class BWFAN_Ninja_Form_Field extends BWFAN_Merge_Tag {

	private static $instance = null;

	public function __construct() {
		$this->tag_name        = 'ninja_form_field';
		$this->tag_description = __( 'Form Field', 'autonami-automations-pro' );
		add_shortcode( 'bwfan_ninja_form_field', array( $this, 'parse_shortcode' ) );
	}
	...
	public function get_view() {
        ...
        <select id="" class="bwfan-input-wrapper bwfan-mb-15 bwfan_tag_select bwfan_ninja_form_fields" name="field"></select>
		<?php
...
if ( bwfan_is_ninja_forms_active() ) {
	BWFAN_Merge_Tag_Loader::register( 'ninjaforms', 'BWFAN_Ninja_Form_Field' );
}

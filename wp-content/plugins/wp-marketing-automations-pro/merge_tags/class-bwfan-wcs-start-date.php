...
class BWFAN_WCS_Start_Date extends BWFAN_Merge_Tag {
	...
	public function __construct() {
		...
		$this->tag_description = __( 'Subscription Start Date', 'autonami-automations-pro' );
	...
	public function parse_shortcode( $attr ) {
		...
		$date = $this->format_datetime( BWFAN_Merge_Tag_Loader::get_data( 'wc_subscription' )->get_date_created(), $parameters );
...
if ( bwfan_is_woocommerce_active() && bwfan_is_woocommerce_subscriptions_active() ) {
	BWFAN_Merge_Tag_Loader::register( 'wc_subscription', 'BWFAN_WCS_Start_Date' );
}

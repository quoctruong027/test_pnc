...
class BWFAN_AWP_Referrer_ID extends BWFAN_Merge_Tag {

	private static $instance = null;

	public function __construct() {
		$this->tag_name        = 'awp_referrer_id';
		$this->tag_description = __( 'Referrer ID', 'autonami-automations-pro' );
		add_shortcode( 'bwfan_awp_referrer_id', array( $this, 'parse_shortcode' ) );
	}
...
if ( bwfan_is_affiliatewp_active() ) {
	BWFAN_Merge_Tag_Loader::register( 'wc_aff_affiliate', 'BWFAN_AWP_Referrer_ID' );
}

...
final class BWFAN_Klaviyo_Integration extends BWFAN_Integration {
	private static $ins = null;
	protected $connector_slug = 'bwfco_klaviyo';
 ...
 */
BWFAN_Load_Integrations::register( 'BWFAN_Klaviyo_Integration' );
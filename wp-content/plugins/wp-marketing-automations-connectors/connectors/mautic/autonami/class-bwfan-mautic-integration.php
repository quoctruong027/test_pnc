...
final class BWFAN_Mautic_Integration extends BWFAN_Integration {
	private static $ins = null;
	protected $connector_slug = 'bwfco_mautic';
 ...
 */
BWFAN_Load_Integrations::register( 'BWFAN_Mautic_Integration' );

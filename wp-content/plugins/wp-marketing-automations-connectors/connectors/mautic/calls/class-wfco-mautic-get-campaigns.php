...
class WFCO_Mautic_Get_Campaigns extends WFCO_Mautic_Call {
	...
	public function get_endpoint() {
		return $this->data['site_url'] . '/api/campaigns?access_token=' . $this->data['access_token'];
	}

}

return 'WFCO_Mautic_Get_Campaigns';

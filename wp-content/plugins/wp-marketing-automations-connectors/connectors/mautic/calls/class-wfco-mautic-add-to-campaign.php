...
class WFCO_Mautic_Add_To_Campaign extends WFCO_Mautic_Call {
	...
	public function get_endpoint() {
		return $this->data['site_url'] . '/api/campaigns/' . absint( $this->campaign_id ) . '/contact/' . absint( $this->contact_id ) . '/add';
	}

}

return 'WFCO_Mautic_Add_To_Campaign';

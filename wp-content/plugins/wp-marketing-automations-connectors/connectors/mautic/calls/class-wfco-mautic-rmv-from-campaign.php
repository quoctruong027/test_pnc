...
class WFCO_Mautic_Rmv_From_Campaign extends WFCO_Mautic_Call {
	...
	public function __construct() {
		...
		$this->required_fields = array( 'site_url', 'access_token', 'email', 'campaign_id' );
	}
	...
	public function get_endpoint() {
		return $this->data['site_url'] . '/api/campaigns/' . absint( $this->campaign_id ) . '/contact/' . absint( $this->contact_id ) . '/remove';
	}

}

return 'WFCO_Mautic_Rmv_From_Campaign';

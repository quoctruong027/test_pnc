...
class WFCO_Mautic_Add_Points extends WFCO_Mautic_Call {
	...
	public function get_endpoint() {
		return $this->data['site_url'] . '/api/contacts/' . $this->contact_id . '/points/plus/' . $this->points;
	}

}

return 'WFCO_Mautic_Add_Points';

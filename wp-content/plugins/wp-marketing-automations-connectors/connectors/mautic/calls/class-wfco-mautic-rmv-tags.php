...
class WFCO_Mautic_Rmv_Tags extends WFCO_Mautic_Call {
	...
	public function process() {
		...
		/** Remove tags API call require tags to be appended by '-' (minus) */
		$this->data['tags'] = array_map( function ( $tag ) {
			return '-' . $tag;
		}, $this->data['tags'] );

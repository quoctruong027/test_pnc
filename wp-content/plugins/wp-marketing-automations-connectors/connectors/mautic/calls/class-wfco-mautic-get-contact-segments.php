...
class WFCO_Mautic_Get_Contact_Segments extends WFCO_Mautic_Call {
	...
	public function get_endpoint() {
		return $this->data['site_url'] . '/api/contacts/' . $this->contact_id . '/segments?access_token=' . $this->data['access_token'];
	}

}

return 'WFCO_Mautic_Get_Contact_Segments';

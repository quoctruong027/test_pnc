...
final class BWFAN_GR_Remove_From_List extends BWFAN_Action {
	...
	protected function handle_response( $result, $call_object = null ) {
		...
		if ( isset( $result['response'] ) && 204 === absint( $result['response'] ) ) {
			return array(
				'status'  => 3,
				'message' => isset( $result['body']['result_message'] ) ? $result['body']['result_message'] : __( 'Removed from list successfully!', 'autonami-automations-connectors' ),
			);
		}
 ...
 */
return 'BWFAN_GR_Remove_From_List';

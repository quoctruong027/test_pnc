...
final class BWFAN_Twilio_Message_Received extends BWFAN_Event {
	...
	public function load_hooks() {
		...
		add_action( 'bwfan_webhook_twilio_sms_received', array( $this, 'process' ), 10, 7 );
	}
	...
	public function process( $twilio_data, $automation_key, $automation_id ) {
		...
		$data['twilio_id']      = $automation_id;
		$data['automation_key'] = $automation_key;
		$data['twilio_data']    = $twilio_data;
	...
	public function capture_async_data() {
		$this->twilio_id      = BWFAN_Common::$events_async_data['twilio_id'];
		$this->automation_key = BWFAN_Common::$events_async_data['automation_key'];
		$this->twilio_data    = BWFAN_Common::$events_async_data['twilio_data'];

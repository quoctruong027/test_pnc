...
final class BWFAN_Twilio_Source extends BWFAN_Source {
...
if ( array_key_exists( 'bwfco_twilio', $saved_connectors ) && class_exists( 'BWFAN_Load_Sources' ) ) {
	BWFAN_Load_Sources::register( 'BWFAN_Twilio_Source' );
}

...
<div class="wfco-form-group featured field-input">
    <label for="automation-name"><?php echo esc_html__( 'Enter API URL', 'autonami-automations-connectors' ); ?></label>
    <div class="field-wrap">
        <div class="wrapper">
            <input type="text" name="api_url" placeholder="<?php echo esc_attr__( 'Enter API URL', 'autonami-automations-connectors' ); ?>" class="form-control" required value="<?php echo $api_url; //phpcs:ignore WordPress.Security.EscapeOutput ?>">
        </div>
    </div>
</div>
<div class="wfco-form-group featured field-input">

...
final class BWFAN_Mailerlite_Create_Subscriber extends BWFAN_Action {

	private static $instance = null;

	private function __construct() {
		$this->action_name     = __( 'Create Subscriber', 'autonami-automations-connectors' );
		$this->action_desc     = __( 'This action creates a subscriber', 'autonami-automations-connectors' );
	...
	public function make_data( $integration_object, $task_meta ) {
		...
		$data_to_set['name']      = BWFAN_Common::decode_merge_tags( $task_meta['data']['first_name'] );
 ...
 */
return 'BWFAN_Mailerlite_Create_Subscriber';

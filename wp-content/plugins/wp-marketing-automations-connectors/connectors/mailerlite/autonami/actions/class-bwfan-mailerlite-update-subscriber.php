...
final class BWFAN_Mailerlite_Update_Subscriber extends BWFAN_Action {
	...
	public function get_view_data() {
		$custom_fields = WFCO_Common::get_single_connector_data( $this->connector, 'subscriber_fields' );
 ...
 */
return 'BWFAN_Mailerlite_Update_Subscriber';

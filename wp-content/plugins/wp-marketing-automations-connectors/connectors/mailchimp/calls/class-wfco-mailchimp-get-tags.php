...
class WFCO_Mailchimp_Get_Tags extends WFCO_Call {
	...
	public function get_endpoint() {
		...
		return BWFCO_Mailchimp::get_endpoint( $data_center ) . 'lists/' . $this->data['list_id'] . '/segments?type=static';
	}

}

return 'WFCO_Mailchimp_Get_Tags';

...
class WFCO_Mailchimp_Get_Automations extends WFCO_Call {
	...
	public function get_endpoint() {
		...
		return BWFCO_Mailchimp::get_endpoint( $data_center ) . 'automations';
	}

}

return 'WFCO_Mailchimp_Get_Automations';

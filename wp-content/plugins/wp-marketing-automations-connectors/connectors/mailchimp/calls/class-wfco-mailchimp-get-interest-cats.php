...
class WFCO_Mailchimp_Get_Interest_Cat extends WFCO_Call {

	private static $ins = null;

	public function __construct() {

		$this->required_fields = array( 'api_key', 'list_id' );
	}
	...
	public function get_endpoint() {
		...
		return BWFCO_Mailchimp::get_endpoint( $data_center ) . 'lists/' . $this->data['list_id'] . '/interest-categories';
	}

}

return 'WFCO_Mailchimp_Get_Interest_Cat';

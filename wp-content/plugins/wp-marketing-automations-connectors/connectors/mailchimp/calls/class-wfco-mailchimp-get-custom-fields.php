...
class WFCO_Mailchimp_Get_Custom_Fields extends WFCO_Call {
	...
	public function get_endpoint() {
		...
		return BWFCO_Mailchimp::get_endpoint( $data_center ) . 'lists/' . $this->data['list_id'] . '/merge-fields';
	}

}

return 'WFCO_Mailchimp_Get_Custom_Fields';

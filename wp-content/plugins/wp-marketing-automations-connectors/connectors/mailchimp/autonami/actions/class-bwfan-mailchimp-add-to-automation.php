...
final class BWFAN_Mailchimp_Add_To_Automation extends BWFAN_Action {

	private static $ins = null;

	private function __construct() {
		$this->action_name     = __( 'Add Contact to Automation', 'autonami-automations-connectors' );
		$this->action_desc     = __( 'This action adds the contact to the selected automation', 'autonami-automations-connectors' );
	...
	public function get_view() {
        ...
        <script type="text/html" id="tmpl-action-<?php echo esc_attr__( $unique_slug ); ?>">
            ...
            <label for="" class="bwfan-label-title">
	            ...
	            $message = __( 'Select automation to add contact to and if unable to locate then sync the connector.', 'autonami-automations-connectors' );
	...
	protected function handle_response( $result, $call_object = null ) {
		...
		$error_title  = ( is_array( $result['body'] ) && isset( $result['body'][0] ) ) ? $result['body'][0] : false;
 ...
 */
return 'BWFAN_Mailchimp_Add_To_Automation';

...
final class BWFAN_Mailchimp_Add_Tags extends BWFAN_Action {
	...
	protected function handle_response( $result, $call_object = null ) {
		...
		if ( isset( $result['response'] ) && 204 === absint( $result['response'] ) ) {
			return array(
				'status'  => 3,
				'message' => __( 'Tags added successfully!', 'autonami-automations-connectors' ),
			);
		}
 ...
 */
return 'BWFAN_Mailchimp_Add_Tags';

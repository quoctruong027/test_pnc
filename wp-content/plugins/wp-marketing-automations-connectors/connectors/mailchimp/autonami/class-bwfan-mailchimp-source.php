...
final class BWFAN_Mailchimp_Source extends BWFAN_Source {
...
if ( array_key_exists( 'bwfco_mailchimp', $saved_connectors ) && class_exists( 'BWFAN_Load_Sources' ) ) {
	BWFAN_Load_Sources::register( 'BWFAN_Mailchimp_Source' );
}

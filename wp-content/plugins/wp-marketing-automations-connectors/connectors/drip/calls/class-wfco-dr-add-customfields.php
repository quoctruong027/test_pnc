...
class WFCO_DR_Add_Customfields extends WFCO_Call {

	private static $ins = null;

	public function __construct() {

		$this->required_fields = array( 'email', 'access_token', 'account_id', 'custom_fields' );
	}
	...
	/**
	 * Add customfields to a subscriber in the account. If subscriber with email is not made, then a new subscriber is made
	 * else the subscriber is updated.
	 * subscriber_email and customfields array is required.
	...
	public function add_update_subscriber_to_account() {
		$params = array(
			...
			'custom_fields' => (object) $this->data['custom_fields'], // API wants this as an object
		);
...
return 'WFCO_DR_Add_Customfields';

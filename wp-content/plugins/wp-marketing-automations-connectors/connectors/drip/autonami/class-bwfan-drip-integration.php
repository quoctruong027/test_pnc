...
final class BWFAN_Drip_Integration extends BWFAN_Integration {
	private static $ins = null;
	protected $connector_slug = 'bwfco_drip';
 ...
 */
BWFAN_Load_Integrations::register( 'BWFAN_Drip_Integration' );

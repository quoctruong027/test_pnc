...
if (in_array('woocommerce/woocommerce.php', apply_filters('active_plugins', get_option('active_plugins')))) {
    ...
    function woocommerce_sezzlepay_init()
    {
        ...
        class WC_Gateway_Sezzlepay extends WC_Payment_Gateway
        {
            ...
            const SANDBOX_GATEWAY_URL = "https://sandbox.gateway.sezzle.com/v1";
            const LIVE_GATEWAY_URL = "https://gateway.sezzle.com/v1";
            ...
            function get_base_url()
            {
                ...
                if ($transaction_mode == self::TRANSACTION_MODE_LIVE) {
                    return self::LIVE_GATEWAY_URL;
                }
                return self::SANDBOX_GATEWAY_URL;
            }

(function($, app) {
    ...
    WpfFrontendPage.prototype.sendFiltersOptionsByAjax = (function($filtersDataBackend, $queryVars, $filterSettings, $generalSettings, $woocommerceSettings, $shortcodeAttr) {
        ...
        function loadVariationScript() {
            jQuery.getScript("/wp-content/themes/flatsome/assets/js/woocommerce.js");
            jQuery(".quick-view").each(function(t, e) {
                jQuery(e).hasClass("quick-view-added") || (jQuery(e).click(function(t) {
                    if ("" != jQuery(this).attr("data-prod")) {
                        ...
                        jQuery.post(flatsomeVars.ajaxurl, i, function(t) {
                            jQuery(".processing").removeClass("processing"), jQuery.magnificPopup.open({ removalDelay: 300, autoFocusLast: !1, closeMarkup: flatsomeVars.lightbox.close_markup, closeBtnInside: flatsomeVars.lightbox.close_btn_inside, items: { src: '<div class="product-lightbox lightbox-content">' + t + "</div>", type: "inline" } });
                            ...
                            r.on("show_variation", function(t, e) { e.image.src ? (a.attr("src", e.image.src).attr("srcset", ""), s.attr("href", e.image_link), c.selectSliderFirstImage(), c.resize()) : e.image_src && (a.attr("src", e.image_src).attr("srcset", ""), s.attr("href", e.image_link), c.selectSliderFirstImage(), c.resize()) }), r.on("hide_variation", function(t, e) { a.attr("src", n).attr("srcset", ""), c.resize() }), r.on("click", ".reset_variations", function() { a.attr("src", n).attr("srcset", ""), c.selectSliderFirstImage(), c.resize() }), jQuery(".product-lightbox .quantity").addQty()
                        }), t.preventDefault()
                    }

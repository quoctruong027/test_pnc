    ...
    <div class="panel-body">
        <div class="container-flex flex-between"> 
            <div class="container-flex">
                ...
                <span class="display-block"><strong><?php _e('Save time adding and ordering products by using the MA Aliexpress Dropship Chrome Extension!', 'ali2woo-lite'); ?></strong></span>
            </div>
            <div class="container-flex">
                <a class="btn btn-primary btn-sm chrome-install mr10" target="_blank" href="<?php echo A2WL()->chrome_url; ?>"><?php _e('Get Chrome Extension', 'ali2woo-lite'); ?></a>

...
<div class="a2wl_product_tab general">
    <div class="options_group">
        ...
        woocommerce_wp_text_input(array(
            ...
            'label' => __('External Id', 'ali2woo-lite'),
            'desc_tip' => true,
            'description' => __('External Aliexpress Product Id', 'ali2woo-lite'),
        ));

        woocommerce_wp_text_input(array(
            'id' => '_a2w_orders_count',
            'value' => get_post_meta($post_id, '_a2w_orders_count', true),
            'label' => __('Orders count', 'ali2woo-lite'),
            'desc_tip' => true,
            'description' => __('Aliexpress orders count', 'ali2woo-lite'),
        ...
        woocommerce_wp_checkbox(array(
            ...
            'label' => __('Disable synchronization?', 'ali2woo-lite'),
            'description' => __('Disable global synchronization for this product', 'ali2woo-lite'),
        ));
        ?>
        ...
        woocommerce_wp_checkbox(array(
            ...
            'label' => __('Disable price change?', 'ali2woo-lite'),
            'description' => __('Disable variations price change', 'ali2woo-lite'),
        ));
        woocommerce_wp_checkbox(array(
            'id' => '_a2w_disable_var_quantity_change',
            'value' => get_post_meta($post_id, '_a2w_disable_var_quantity_change', true) ? 'yes' : 'no',
            'label' => __('Disable quantity change?', 'ali2woo-lite'),
            'description' => __('Disable variations quantity change', 'ali2woo-lite'),
        ));
        woocommerce_wp_checkbox(array(
            'id' => '_a2w_disable_add_new_variants',
            'value' => get_post_meta($post_id, '_a2w_disable_add_new_variants', true) ? 'yes' : 'no',
            'label' => __('Disable add new variants?', 'ali2woo-lite'),
            'description' => __('Disable add new variants if they appear.', 'ali2woo-lite'),
        ));
        ...
        woocommerce_wp_text_input(array(
            ...
            'label' => __('Product url', 'ali2woo-lite'),
            'desc_tip' => true,
            'description' => __('Affiliate product url', 'ali2woo-lite'),
            'custom_attributes' => array('readonly'=>'readonly'),
        ));
        ...
        woocommerce_wp_text_input(array(
            ...
            'label' => __('Original product url', 'ali2woo-lite'),
            'desc_tip' => true,
            'description' => __('Original product url', 'ali2woo-lite'),
            'custom_attributes' => array('readonly'=>'readonly'),
        ));
        ?>
    </div>
...
<div class="a2wl_product_tab variations" style="display:none">
    <div class="options_group">
        <p class="form-field _a2wl_deleted_variations_attributes">
            ...
            <span id="_a2w_deleted_variations_attributes">
                ...
                if (empty($deleted_variations_attributes)) {
                    echo '<i>' . __('No deleted attributes of variations', 'ali2woo-lite') . '</i>';
                } else {
        ...
        <script>jQuery("#_a2wl_deleted_variations_attributes > span > a").click(function () {var this_v_a = jQuery(this).parents("span.va");jQuery.post(ajaxurl, {"action": "a2wl_data_remove_deleted_attribute", "post_id":<?php echo $post_id; ?>, "id":jQuery(this_v_a).attr("data-attr-id")}).done(function (response) {jQuery(this_v_a).remove(); if(jQuery("#_a2wl_deleted_variations_attributes > span").length==0){jQuery("#_a2wl_deleted_variations_attributes").html("<i>' . __('No deleted attributes of variations', 'ali2woo-lite') . '</i>");} }).fail(function (xhr, status, error) {console.log(error);});return false;});</script>
    </div>
        ...
        <p class="form-field _a2wl_deleted_variations">
            ...
            if (!empty($skip_meta['skip_vars']) && is_array($skip_meta['skip_vars'])) {
                ...
                foreach ($skip_meta['skip_vars'] as $v) {
                    ...
                    echo '<i>' . __('No deleted variations', 'ali2woo-lite') . '</i>';
            }
            ?>
            </span>
        </p>

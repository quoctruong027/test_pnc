 ...
 * Product Changes
 *
 * This template can be overridden by copying it to yourtheme/ali2woo-lite/emails/product-changes.php
 *
 *
 */
?>
...
<div style="margin-bottom: 40px;">
	<table class="td" cellspacing="0" cellpadding="6" style="width: 100%; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif;" border="1">
		<thead>
			<tr>
				<th class="td" scope="col" style="text-align:5px;"><?php esc_html_e( 'Product', 'ali2woo-lite' ); ?></th>
				<th class="td" scope="col" style="text-align:5px;"><?php esc_html_e( 'Quantity', 'ali2woo-lite' ); ?></th>
				<th class="td" scope="col" style="text-align:5px;"><?php esc_html_e( 'Price', 'ali2woo-lite' ); ?></th>
				<th class="td" scope="col" style="text-align:5px;"><?php esc_html_e( 'New variant', 'ali2woo-lite' ); ?></th>
			</tr>
		</thead>
		<tbody>
            ...
            <?php foreach ($items as $item ) : ?>
				...
				*/?>
				<?php if ($item['not_available_product']) : ?>
					<strong><?php esc_html_e( 'Product is not available on AliExpress!', 'ali2woo-lite' ); ?></strong>
				<? else: ?>
					<strong><?php esc_html_e( 'Link to AliExpress'); ?>:</strong> <a href="<?php echo $item['original_url']; ?>"><?php esc_html_e( 'click here', 'ali2woo-lite' ); ?></a>
				<?php endif; ?>
				</td>
				...
				<?php if ($item['has_new_variants']) : ?>
					<?php esc_html_e( 'yes', 'ali2woo-lite' ); ?>
				<?php else: ?>

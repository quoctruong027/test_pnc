                    ...
                    <div class="col-lg-6 col-md-12 space-top">
                        <div class="a2wl-addon-block">
                            ...
                            <div class="description">
                                <?php echo $addon['description']; ?> <a href="<?php echo $addon['url']; ?>" target="_blank"><?php _e('Read more...', 'ali2woo-lite'); ?></a>
                            </div>
                            <div class="price">

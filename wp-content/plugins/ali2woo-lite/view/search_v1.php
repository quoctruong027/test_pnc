    ...
    <div class="page-main">
        ...
        <form class="search-panel" method="GET" id="a2wl-search-form">
            ...
            <div class="search-panel-header">
                <h3 class="search-panel-title"><?php _e('Search for products', 'ali2woo-lite'); ?></h3>
                <button class="btn btn-default to-right modal-search-open" type="button"><?php _e('Import product by URL or ID', 'ali2woo-lite'); ?></button>
            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-9 col-sm-9">
                            <div class="input-group">
                                <input class="form-control" type="text" name="a2wl_keywords" id="a2wl_keywords" placeholder="<?php _e('Enter Keywords', 'ali2woo-lite'); ?>" value="<?php echo esc_attr(isset($filter['keywords']) ? $filter['keywords'] : ""); ?>">
                        ...
                        <div class="col-lg-3 col-sm-4">
                            <div class="search-panel-buttons">
                                <button class="btn btn-info no-outline" id="a2wl-do-filter" type="button"><?php _e('Search', 'ali2woo-lite'); ?></button>
                ...
                <div class="search-panel-advanced" <?php if ($adv_search): ?>style="display: block;"<?php endif; ?>>
                    <div class="search-panel-row">
                        <div class="search-panel-col">
                            <label><?php _e('Price', 'ali2woo-lite'); ?></label>
                            <input type="text" class="form-control" name="a2wl_min_price" placeholder="<?php _e('Price from', 'ali2woo-lite'); ?>" value="<?php echo esc_attr(isset($filter['min_price']) ? $filter['min_price'] : ""); ?>">
                            <input type="text" class="form-control" name="a2wl_max_price" placeholder="<?php _e('Price to', 'ali2woo-lite'); ?>" value="<?php echo esc_attr(isset($filter['max_price']) ? $filter['max_price'] : ""); ?>">
                        </div>
                        <div class="search-panel-col">
                            <label><?php _e("Seller's Feedback score", 'ali2woo-lite'); ?></label>
                            <input type="text" class="form-control" name="a2wl_min_feedback" placeholder="<?php _e('Score from 0', 'ali2woo-lite'); ?>" value="<?php echo esc_attr(isset($filter['min_feedback']) ? $filter['min_feedback'] : ""); ?>">
                            <input type="text" class="form-control" name="a2wl_max_feedback" placeholder="<?php _e('Score to 400 000+', 'ali2woo-lite'); ?>" value="<?php echo esc_attr(isset($filter['max_feedback']) ? $filter['max_feedback'] : ""); ?>">
                        </div>
                        <div class="search-panel-col">
                            <label><?php _e('Sold in 30 days', 'ali2woo-lite'); ?></label>
                            <input type="text" class="form-control" name="a2wl_volume_from" placeholder="<?php _e('Orders count from', 'ali2woo-lite'); ?>" value="<?php echo esc_attr(isset($filter['volume_from']) ? $filter['volume_from'] : ""); ?>">
                            <input type="text" class="form-control" name="a2wl_volume_to" placeholder="<?php _e('Orders count to', 'ali2woo-lite'); ?>" value="<?php echo esc_attr(isset($filter['volume_to']) ? $filter['volume_to'] : ""); ?>">
                        </div>
                    </div>
                </div>
                <div class="search-panel__row"><span class="country-select-title"><?php _e('Show shipping price to', 'ali2woo-lite'); ?></span>
                    <div class="country-select" id="my-list">
                        <select name="a2wl_country" class="form-control country_list">
                    ...
                    </div><span class="country-select-descr"><?php _e('We will display the cheapest shipping option on the results page', 'ali2woo-lite'); ?></span>
                </div>
            </div>
            ...
            <div class="modal-overlay modal-search">
                <div class="modal-content">
                    <div class="modal-header">
                        <h3 class="modal-title"><?php _e('Import product by URL or ID', 'ali2woo-lite'); ?></h3>
                        <a class="modal-btn-close" href="#"><svg><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#icon-cross"></use></svg></a>
                    </div>
                    <div class="modal-body">
                        <label><?php _e('Product URL', 'ali2woo-lite'); ?></label>
                        <input class="form-control" type="text" id="url_value">
                        <div class="separator"><?php _e('or', 'ali2woo-lite'); ?></div>
                        <label><?php _e('Product ID', 'ali2woo-lite'); ?></label>
        ...
        <div>
            ...
            <div class="sort-panel">
                <label for="a2wl-sort-selector"><?php _e('Sort by:', 'ali2woo-lite'); ?></label>
                <select class="form-control" id="a2wl-sort-selector">
                    <option value="bestMatch" <?php if ($filter['sort'] == 'bestMatch'): ?>selected="selected"<?php endif; ?>><?php _ex('Best Match', 'sort by', 'ali2woo-lite'); ?></option>
                    <option value="orignalPriceUp" <?php if ($filter['sort'] == 'orignalPriceUp'): ?>selected="selected"<?php endif; ?>><?php _ex('Lowest price', 'sort by', 'ali2woo-lite'); ?></option>
                    <option value="orignalPriceDown" <?php if ($filter['sort'] == 'orignalPriceDown'): ?>selected="selected"<?php endif; ?>><?php _ex('Highest price', 'sort by', 'ali2woo-lite'); ?></option>
                    <!--
                    <option value="sellerRateDown" <?php if ($filter['sort'] == 'sellerRateDown'): ?>selected="selected"<?php endif; ?>><?php _ex("Seller's feedback score", 'sort by', 'ali2woo-lite'); ?></option>
                    <option value="commissionRateUp" <?php if ($filter['sort'] == 'commissionRateUp'): ?>selected="selected"<?php endif; ?>><?php _ex('Lowest commission rate', 'sort by', 'ali2woo-lite'); ?></option>
                    <option value="commissionRateDown" <?php if ($filter['sort'] == 'commissionRateDown'): ?>selected="selected"<?php endif; ?>><?php _ex('Highest commission rate', 'sort by', 'ali2woo-lite'); ?></option>
                    -->
                    <option value="volumeDown" <?php if ($filter['sort'] == 'volumeDown'): ?>selected="selected"<?php endif; ?>><?php _ex('Orders count', 'sort by', 'ali2woo-lite'); ?></option>
                    <option value="validTimeUp" <?php if ($filter['sort'] == 'validTimeUp'): ?>selected="selected"<?php endif; ?>><?php _ex('Lowest valid time', 'sort by', 'ali2woo-lite'); ?></option>
                    <option value="validTimeDown" <?php if ($filter['sort'] == 'validTimeDown'): ?>selected="selected"<?php endif; ?>><?php _ex('Highest valid time', 'sort by', 'ali2woo-lite'); ?></option>
                </select>
            </div>
        ...
        <div class="search-result">
            ...
            <?php $localizator = A2WL_AliexpressLocalizator::getInstance(); ?>
                        ...
                        <article class="product-card<?php if ($product['post_id'] || $product['import_id']): ?> product-card--added<?php endif; ?>" data-id="<?php echo $product['id'] ?>">
                            ...
                            <div class="product-card__body">
                                ...
                                <div class="product-card__price-wrapper">
                                    ...
                                    <div>
                                        <div class="product-card-shipping-info"<?php if (isset($product['shipping_to_country'])): ?> data-country="<?php echo $product['shipping_to_country'] ?>"<?php endif; ?>>
                                            <div class="shipping-title"><?php _e('Choose shipping country', 'ali2woo-lite'); ?></div>
                                ...
                                <div class="product-card__actions">
                                    <button class="btn <?php echo ($product['post_id'] || $product['import_id']) ? 'btn-default' : 'btn-success'; ?> no-outline btn-icon-left"><span class="title"><?php if ($product['post_id'] || $product['import_id']): ?><?php _e('Remove from import list', 'ali2woo-lite'); ?><?php else: ?><?php _e('Add to import list', 'ali2woo-lite'); ?><?php endif; ?></span>

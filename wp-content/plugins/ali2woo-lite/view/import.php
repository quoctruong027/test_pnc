<div class="a2wl-content">
    <div class="container">
        ...
        <div id="a2wl-import-empty" class="panel panel-default margin-top"<?php if ($serach_query || count($product_list) !== 0): ?> style="display:none;"<?php endif; ?>>
            <div class="panel-body">
                <?php _e('Your Import List is Empty.', 'ali2woo-lite'); ?>
                <br/>
                <br/>
                <?php _e('You can add products to this list from the “Search Products” page, or import products while browsing AliExpress using free chrome extension.', 'ali2woo-lite'); ?>
            </div>
        </div>
        ...
        <div id="a2wl-import-content"<?php if (!$serach_query && count($product_list) === 0): ?> style="display:none;"<?php endif; ?>>
            <div id="a2wl-import-filter">
                <div class="row">
                    <div class="col-md-6">
                        <h3><?php _e('Import List', 'ali2woo-lite'); ?></h3>
                    </div>
                    <div class="col-md-6">
                        <form method="GET" action="<?php echo admin_url('admin.php'); ?>">
                            ...
                            <table class="float-right">
                                <tr>
                                    ...
                                    <td><input type="submit" class="btn btn-default" value="<?php _e('Search products', 'ali2woo-lite'); ?>"></td>
                                </tr>
                            </table>
                        </form>
                    </div>
            ...
            <div id="a2wl-import-actions">
                <div class="row">
                    <div class="col-lg-5 col-md-12 space-top">
                        <div class="container-flex" style="height: 32px;">
                            <div class="margin-right">
                                <input type="checkbox" class="check-all form-control"><span class="space-small-left"><strong><?php _e('Select All Products', 'ali2woo-lite'); ?></strong></span>
                            </div>
                            <div class="action-with-check" style="display: none;">
                                <select class="form-control">
                                    <option value="0">Bulk Actions (0 selected)</option>
                                    <option value="remove"><?php _e('Remove from Import List', 'ali2woo-lite'); ?></option>
                                    <option value="push"><?php _e('Push Products to Shop', 'ali2woo-lite'); ?></option>
                                    <option value="link-category"><?php _e('Link to category', 'ali2woo-lite'); ?></option>
                                </select>
                    ...
                    <div class="col-lg-7 col-md-12 space-top align-right">
                        <a href="#" class="btn btn-default link_category_all"><?php _e('Link All products to category', 'ali2woo-lite'); ?></a>
                        <a href="<?php echo admin_url('admin.php?page=' . $_REQUEST['page']) . '&action=delete_all'; ?>" class="btn btn-danger margin-small-left delete_all"><?php _e('Remove All Products', 'ali2woo-lite'); ?></a>
                        <button type="button" class="btn btn-success no-outline btn-icon-left margin-small-left push_all">
                            ...
                            <span class="btn-icon-wrap add"><svg><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#icon-add"></use></svg></span><?php _e('Push All Products to Shop', 'ali2woo-lite'); ?>
                        </button>
                    </div>
            ...
            <div class="panel panel-default margin-top"<?php if (count($product_list) !== 0): ?> style="display:none;"<?php endif; ?>>
                <div class="panel-body">
                    <?php _e('No products found.', 'ali2woo-lite'); ?>
                </div>
            </div>
                        ...
                        <div class='col-xs-12'>
                            <div class='product' data-id="<?php echo $product['import_id']; ?>" data-country="<?php echo $product['shipping_to_country']; ?>">
                                <div class="row">
                                    <div class="col-lg-7 col-sm-7">
                                        <ul class="nav nav-tabs">
                                            ...
                                            <li class="active"><a href="#" rel="product"><?php _e('Product', 'ali2woo-lite'); ?></a></li>
                                            <li> <a href="#" rel="description"><?php _e('Description', 'ali2woo-lite'); ?></a></li>
                                            <li> <a href="#" rel="specs"><?php _e('Specs', 'ali2woo-lite'); ?></a></li>
                                            <li <?php if (a2wl_check_defined('A2WL_DO_NOT_IMPORT_VARIATIONS')): ?>style="display:none;"<?php endif; ?>> <a href="#" rel="variants"><?php _e('Variants', 'ali2woo-lite'); ?> <span class="badge badge-tab margin-small-left variants-count"><?php echo count($product['sku_products']['variations']) ?></span></a></li>
                                            <li> <a href="#" rel="images"><?php _e('Images', 'ali2woo-lite'); ?></a></li> 
                                        </ul>
                                    </div>
                                    <div class="col-lg-5 col-sm-5 align-right" style="margin-top:15px">
                                        <div class="actions">
                                            <span class="margin-small-right"><?php _e('External Id', 'ali2woo-lite'); ?>: <b><?php echo $product['id']; ?></b></span>
                                            <div class="btn-group margin-small-right">
                                                <button type="button" class="btn btn-default dropdown-toggle btn-icon-right" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                    <?php _e('Action', 'ali2woo-lite'); ?> <span class="caret"></span>
                                                </button>
                                                <ul class="dropdown-menu">
                                                    <?php if(empty($product['override_product_id'])):?>
                                                        <li><a href="#" class="product-card-override-product"><?php _e('Select Product to Override', 'ali2woo-lite'); ?></a></li>
                                                    <?php endif;?>
                                                    <?php if(count($product['sku_products']['variations'])>1):?>
                                                        <li><a href="#" class="product-card-split-product"><?php _e('Split Product', 'ali2woo-lite'); ?></a></li>
                                                    <?php endif;?>
                                                    <li><a href="<?php echo admin_url('admin.php?page=' . $_REQUEST['page']) . '&delete_id=' . $product['import_id']; ?>"><?php _e('Remove Product', 'ali2woo-lite'); ?></a></li>
                                                </ul>
                                            </div>
                                            ...
                                            <button type="button" class="btn btn-success no-outline btn-icon-left margin-right post_import">
                                                ...
                                                <span class="btn-title"><?php echo isset($product['override_product_id'])?__('Override', 'ali2woo-lite'):__('Push to Shop', 'ali2woo-lite');?></span>
                                            </button>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3 col-xs-4">
                                            <div class="product-img">
                                                <img class="border-img lazy" src="<?php echo A2WL()->plugin_url() . '/assets/img/blank_image.png'; ?>" data-id="<?php echo md5($product['thumb']);?>" data-original="<?php echo isset($product['tmp_edit_images'][md5($product['thumb'])]['attachment_url']) ? $product['tmp_edit_images'][md5($product['thumb'])]['attachment_url'] : a2wl_image_url($product['thumb']); ?>" alt="<?php echo $product['title']; ?>">
                                        ...
                                        <div class="col-md-9 col-xs-8">
                                            ...
                                            <div class="row product-edit">
                                                <div class="col-md-12 input-block">
                                                    <label><?php _e('Change name', 'ali2woo-lite'); ?>:</label><input type="text" class="form-control title" maxlength="255" value="<?php echo $product['title']; ?>">
                                                </div>
                                                <div>
                                                    <div class="col-md-4 input-block js-choosen-parent">
                                                        <label><?php _e('SKU', 'ali2woo-lite'); ?>:</label>
                                                        <input type="text" class="form-control sku" maxlength="255" value="<?php echo empty($product['sku'])?$product['id']:$product['sku']; ?>"/>
                                                    </div>
                                                    <div class="col-md-4 input-block js-choosen-parent">
                                                        <label><?php _e('Status', 'ali2woo-lite'); ?>:</label>
                                                        <select class="form-control select2 status" data-placeholder="<?php _e('Choose Status', 'ali2woo-lite'); ?>">
                                                    ...
                                                    <div class="col-md-4 input-block js-choosen-parent">
                                                        <label><?php _e('Type', 'ali2woo-lite'); ?>:</label>
                                                        <select class="form-control select2 type" data-placeholder="<?php _e('Choose Type', 'ali2woo-lite'); ?>">
                                                            <option value="simple" <?php if ($product['product_type'] == "simple"): ?>selected="selected"<?php endif; ?>><?php _ex('Simple/Variable Product', 'Setting option', 'ali2woo-lite'); ?></option>
                                                            <option value="external" <?php if ($product['product_type'] == "external"): ?>selected="selected"<?php endif; ?>><?php _ex('External/Affiliate Product', 'Setting option', 'ali2woo-lite'); ?></option>
                                                        </select>
                                                    </div>
                                                    <div class="col-md-4 input-block js-build-wrapper">
                                                        <div><label><?php _e('Categories', 'ali2woo-lite'); ?>:</label></div>
                                                        <select class="form-control select2 categories" data-placeholder="<?php _e('Choose Categories', 'ali2woo-lite'); ?>" multiple="multiple">
                                                            <option></option>
                                                    ...
                                                    <div class="col-md-4 input-block js-choosen-parent">
                                                        <div><label><?php _e('Tags', 'ali2woo-lite'); ?>:</label></div>
                                                        <select name="tags" class="form-control select2-tags tags" data-placeholder="<?php _e('Enter Tags', 'ali2woo-lite'); ?>" multiple="multiple">
                                ...
                                <div class="tabs-content" rel="specs">
                                    <?php $attribute_values_separator = a2wl_get_setting('attribute_values_separator'); ?>
                                    <div class="specs-wrap">
                                        <table class="specs-table">
                                            <thead>
                                                <tr>
                                                    <th></th>
                                                    <th><?php _e('Name', 'ali2woo-lite'); ?></th>
                                                    <th><?php _e('Value', 'ali2woo-lite'); ?></th>
                                                </tr>
                                            </thead>
                                    ...
                                    <div id="variants-images-container-<?php echo $product['import_id']; ?>" class="variants-wrap">
                                        <div class="variants-actions">
                                            <table style="width: 100%;">
                                                <tr>
                                                    <td>
                                                        <label for="disable-price-change-<?php echo $product['import_id']; ?>"><?php _e('Prevent product price from auto-updating', 'ali2woo-lite'); ?></label>
                                                    ...
                                                    <td>
                                                        <label for="disable-quantity-change-<?php echo $product['import_id']; ?>"><?php _e('Prevent product quantity from auto-updating', 'ali2woo-lite'); ?></label>
                                        ...
                                        <table class="variants-table">
                                            <thead>
                                                <tr>
                                                    <th colspan="2" class="nowrap"><input type="checkbox" class="check-all-var form-control" <?php if (!$product['skip_vars']): ?> checked="checked"<?php endif; ?>><?php _e('Use all', 'ali2woo-lite'); ?></th>
                                                    <th><?php _e('SKU', 'ali2woo-lite'); ?></th>
                                                    ...
                                                    <?php endforeach; ?>
                                                    <th><?php _e('Cost', 'ali2woo-lite'); ?></th>
                                                    <th><?php _e('Shipping', 'ali2woo-lite'); ?></th>
                                                    <th><?php _e('Price', 'ali2woo-lite'); ?></th>
                                                    <th><?php _e('Compared At Price', 'ali2woo-lite'); ?></th>
                                                    <th><?php _e('Profit', 'ali2woo-lite'); ?></th>
                                                    <th><?php _e('Inventory', 'ali2woo-lite'); ?></th>
                                                </tr>
                                                <tr>
                                                    <td colspan="<?php echo (4 + count($product['sku_products']['attributes'])); ?>"></td>
                                                    <td>
                                                        <a href="#" class="shipping-country"><?php echo isset($product['shipping_to_country'])?$product['shipping_to_country_name']:__('Select country', 'ali2woo-lite'); ?></a>
                                                    </td>
                                                    <td>
                                                        <div class="price-edit-selector edit-price">
                                                            ...
                                                            <button type="button" class="btn btn-sm btn-default dropdown-toggle btn-icon-right" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                                <?php _e('Change All Prices', 'ali2woo-lite'); ?> <span class="caret"></span>
                                                            </button>
                                                            <ul class="dropdown-menu dropdown-sm">
                                                                <li><a href="javascript:void(0)" class="set-new-value"><?php _e('Set New Value', 'ali2woo-lite'); ?></a></li>
                                                                <li><a href="javascript:void(0)" class="multiply-by-value"><?php _e('Multiply by', 'ali2woo-lite'); ?></a></li>
                                                            </ul>
                                                        </div>  
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <div class="price-edit-selector edit-quantity">
                                                            <div class="price-box-top price-box-right">
                                                                <div class="container-flex">
                                                                    <div>
                                                                        <input type="text" class="form-control simple-value" placeholder="<?php _e('Enter Value', 'ali2woo-lite'); ?>">
                                                                        <input type="text" class="form-control random-from" placeholder="<?php _e('From', 'ali2woo-lite'); ?>">
                                                                        <input type="text" class="form-control random-to" placeholder="<?php _e('To', 'ali2woo-lite'); ?>">
                                                                    </div>
                                                                    <div>
                                                                        <button class="apply btn btn-default margin-small-left">Apply</button>
                                                                    </div>
                                                            ...
                                                            <button type="button" class="btn btn-sm btn-default dropdown-toggle btn-icon-right" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                                <?php _e('Change All Inv.', 'ali2woo-lite'); ?> <span class="caret"></span>
                                                            </button>
                                                            <ul class="dropdown-menu dropdown-sm dropdown-right">
                                                                <li><a href="javascript:void(0)" class="set-new-quantity"><?php _e('Set New Value', 'ali2woo-lite'); ?></a></li>
                                                                <li><a href="javascript:void(0)" class="random-value"><?php _e('Random Value', 'ali2woo-lite'); ?></a></li>
                                                            </ul>
                                                        </div>
                                                    </td>
                                                </tr>
                                            ...
                                            <tbody>
                                                ...
                                                <?php foreach ($product['sku_products']['variations'] as $i => $var): ?>
                                                    ...
                                                    <tr data-id="<?php echo $var['id']; ?>" class="var_data">
                                                        ...
                                                        <td>
                                                            <?php if (isset($var['image'])): ?><img class="border-img lazy-in-container" style="max-width: 100px; max-height: 100px; margin: 5px" src="<?php echo A2WL()->plugin_url() . '/assets/img/blank_image.png'; ?>" data-id="<?php echo md5($var['image']);?>" data-original="<?php echo isset($product['tmp_edit_images'][md5($var['image'])]['attachment_url']) ? $product['tmp_edit_images'][md5($var['image'])]['attachment_url'] : a2wl_image_url($var['image']); ?>" data-img="<?php echo isset($product['tmp_edit_images'][md5($var['image'])]['attachment_url']) ? $product['tmp_edit_images'][md5($var['image'])]['attachment_url'] : a2wl_image_url($var['image']); ?>" data-toggle="popover-hover"><?php endif; ?>
                                    ...
                                    <div id="images-container-<?php echo $product['import_id']; ?>" class="images-wrap">
                                        <?php if (!empty($product['gallery_images'])): ?>
                                            <div class="images-blog-title">
                                                ...
                                                <label for="check-all-gallery-image-id-<?php echo $product['import_id'];?>"><?php _e('Gallery images', 'ali2woo-lite'); ?></label>
                                            </div>
                                                    ...
                                                    <div class="col-xs-3">
                                                        <div id="<?php echo $img_id; ?>" class="image<?php if (!in_array($img_id, $product['skip_images'])): ?> selected<?php endif; ?>">
                                                            ...
                                                            <?php if (isset($product['tmp_move_images'][$img_id])): ?>
                                                                <div class="cancel-image-action"><a href="#" data-action="move#<?php echo $product['tmp_move_images'][$img_id]; ?>"><?php _e('Cancel move', 'ali2woo-lite'); ?></a></div>
                                                            <?php elseif (isset($product['tmp_copy_images'][$img_id])): ?>
                                                                <div class="cancel-image-action"><a href="#" data-action="copy#<?php echo $product['tmp_copy_images'][$img_id]; ?>"><?php _e('Cancel copy', 'ali2woo-lite'); ?></a></div>
                                                            <?php endif; ?>
                                                        </div>
                                                    </div>
                                                <?php endforeach; ?>
                                        ...
                                        <?php if (!empty($product['variant_images'])): ?>
                                            <div class="images-blog-title">
                                                ...
                                                <label for="check-all-variant-image-id-<?php echo $product['import_id'];?>"><?php _e('Variations images', 'ali2woo-lite'); ?></label>
                                            </div>
                                        ...
                                        <?php if (!empty($product['description_images'])): ?>
                                            <div class="images-blog-title">
                                                ...
                                                <label for="check-all-description-image-id-<?php echo $product['import_id'];?>"><?php _e('Description images', 'ali2woo-lite'); ?></label>
                                                <div class="images-action">
                                                    <select class="form-control description-images-action">
                                                        <option value="" disabled="disabled" selected="selected"><?php _e('Action', 'ali2woo-lite'); ?></option>
                                                        <option value="move"><?php _e('Move checked images to gallery', 'ali2woo-lite'); ?></option>
                                                        <option value="copy"><?php _e('Copy checked images to gallery', 'ali2woo-lite'); ?></option>
                                                    </select>
                                                </div>
                                            </div>
    ...
    <script>
        var a2w_fulfillment_prefship = '<?php echo a2wl_get_setting('fulfillment_prefship');?>';
        ...
        (function ($) {
            ...
            $('.product .nav-tabs a').click(function () {
                ...
                if ($(this).attr("rel") === 'variants') {
                    ...
                    var tmp_data = $(product).data();
                    if(!tmp_data.shipping){
                        a2wl_load_shipping_info($(product).attr('data-id'), tmp_data.country, 'import', function(state, items){
                            if (state != 'error') {
                                $(product).data({...tmp_data, shipping: items});

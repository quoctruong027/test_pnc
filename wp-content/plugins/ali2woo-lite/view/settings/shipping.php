<?php
$a2w_local_currency = strtoupper(a2wl_get_setting('local_currency'));
?>
<form method="post" enctype='multipart/form-data'>
    <input type="hidden" name="setting_form" value="1"/>
    <div class="panel panel-primary mt20">
        <div class="panel-heading">
            <h3 class="panel-title"><?php _ex('Shipping settings', 'Setting title', 'ali2woo-lite'); ?></h3>
            <span class="pull-right">
                <a href="#" class="reset-shipping-meta btn _a2wfv"><?php _ex('Reset product shipping meta', 'Setting title', 'ali2woo-lite'); ?></a>
            </span>
        </div>
        ...
        <div class="panel-body _a2wfv">
            <div class="row">
                <div class="col-md-4">
                    <label>
                        <strong><?php _ex('Default shipping class', 'Setting title', 'ali2woo-lite'); ?></strong>
                    </label>
                    <div class="info-box" data-toggle="tooltip" title="<?php _ex('Assigned a shipping class to the product when importing', 'setting description', 'ali2woo-lite'); ?>"></div>
                </div>
                <div class="col-md-8">
                    <div class="form-group input-block no-margin">
                        <?php $default_shipping_class = a2wl_get_setting('default_shipping_class'); ?>
                        <select name="a2wl_default_shipping_class" id="a2wl_default_shipping_class" class="form-control small-input">
            ...
            <div class="row">
                <div class="col-md-4">
                    <label>
                        <strong><?php _ex('Default Shipping Country', 'Setting title', 'ali2woo-lite'); ?></strong>
                    </label>
                    <div class="info-box" data-toggle="tooltip" title="<?php _ex('Set the Default option for Country drop-down selection in Frontend (Cart and Checkout pages)', 'setting description', 'ali2woo-lite'); ?>"></div>
                </div>
                <div class="col-md-8">
                    <?php $cur_a2w_aliship_shipto = a2wl_get_setting('aliship_shipto'); ?>
                    <div class="form-group input-block no-margin">
            ...
            <div class="row">
                <div class="col-md-4">
                    <label>
                        <strong><?php _ex('Use Aliexpress Shipping', 'Setting title', 'ali2woo-lite'); ?></strong>
                    </label>
                    <div class="info-box" data-toggle="tooltip" title="<?php _ex('Show the shipping drop-down selection in Frontend (Cart, Checkout and Order page)', 'setting description', 'ali2woo-lite'); ?>"></div>
                </div>
                <div class="col-md-8">
                    <div class="form-group input-block no-margin">
                        <input type="checkbox" class="form-control small-input" id="a2wl_aliship_frontend" name="a2wl_aliship_frontend" <?php if (a2wl_get_setting('aliship_frontend')): ?>value="yes" checked<?php endif; ?> />
                    </div>
                </div>
            </div>
    ...
    <div class="global-pricing mt20"> 
        <div class="panel panel-primary mt20 _a2wfv">
            <div class="panel-heading">
                <h3 class="display-inline"><?php _ex('Global shipping rules', 'Setting title', 'ali2woo-lite'); ?><div class="info-box" data-placement="left" data-toggle="tooltip" title="<?php _ex('Please note that you can disable Global rules for specific shipping methods if needed. Just go to "Shipping List" page, then choose "specific method" and set  "Enable price rule" to "no".', 'Setting tip', 'ali2woo-lite'); ?>"></div></h3>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3 col-md-3 vertical-align">
                        <div class="input-group price-dropdown-group">
                            ...
                            <input name="default_rule[value]" type="text" class="form-control value" value="<?php echo $default_formula->value; ?>" <?php if (!a2wl_get_setting('aliship_frontend')): ?> disabled <?php endif; ?>>

                            <div class="input-group-btn">
                                <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" <?php if (!a2wl_get_setting('aliship_frontend')): ?> disabled <?php endif; ?>>
    ...
    (function ($) {
        ...
        $(".reset-shipping-meta").on("click", function () {
            if(!$(".reset-shipping-meta").hasClass('processing')){
                ...
                var data = {'action': 'a2wl_reset_shipping_meta'};

<?php
$a2wl_pricing_rules_type = a2wl_get_setting('pricing_rules_type', 'sale_price_as_base');  
$a2wl_use_extended_price_markup = a2wl_get_setting('use_extended_price_markup');
$a2wl_use_compared_price_markup = a2wl_get_setting('use_compared_price_markup');
    ...
    <div class="pricing-rules-type">
        <div class="panel panel-primary">
            <div class="panel-heading">
                <h3 class="panel__header-title"><?php _e('Pricing rules modes', 'ali2woo-lite'); ?></h3>
            </div>
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div id="pricing_rules_type_description" class="grey-color mb20"><?php echo $pricing_rules_types[$a2wl_pricing_rules_type]['description']; ?></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body p20 border-bottom js-default-prices"  <?php if ($a2wl_use_extended_price_markup): ?>style="display: none;" <?php else: ?>style="display: block;"<?php endif; ?>>
            ...
            <div class="row pt20 compared">
                ...
                <div class="col-sm-10 vertical-align switch-col" <?php if ($a2wl_use_compared_price_markup): ?>style="display:none;"<?php endif; ?>>
                    <span class="grey-color" style="">Set your compared at pricing rules</span>
                </div> 
                <div class="col-sm-2 vertical-align switch-col" <?php if (!$a2wl_use_compared_price_markup): ?>style="display:none;"<?php endif; ?>>
                    <h3>Product cost</h3>
                </div>                            
                <div class="col-sm-1 vertical-align switch-col" <?php if (!$a2wl_use_compared_price_markup): ?>style="display:none;"<?php endif; ?>>
                ...
                <div class="col-sm-3 col-md-3 vertical-align switch-col" <?php if (!$a2wl_use_compared_price_markup): ?>style="display:none;"<?php endif; ?>>
                    <div class="input-group price-dropdown-group">
                        ...
                        <thead>
                            <tr class="border-bottom">
                                ...
                                <th width="25%" style="white-space: nowrap;">
                                    <input class="use_compared_price_markup" type="checkbox" <?php if ($a2wl_use_compared_price_markup): ?>checked="checked"<?php endif; ?>><span>Compared at price markup</span>
                                </th>
                                <th>&nbsp;</th>
                            </tr>
                        </thead>
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-8 col-lg-10">
                        <div class="input-wrap" <?php if (!$a2wl_use_compared_price_markup): ?>style="display:none;"<?php endif; ?>>
...
<div class="container-fluid">
    <div class="row pt20 border-top">
        <div class="col-sm-12">
            <input class="btn btn-success mt20" type="submit" id="save-price-rules" value="<?php _e('Save settings', 'ali2woo-lite'); ?>"/>
        </div>
    </div>
</div>
...
<script>
    ...
    jQuery(function ($) {
        $("#a2wl_pricing_rules_type").change(function () {
        ...
        function a2wl_apply_import_pricing_rules(type, page, on_done_calback){
            var data = {'action': 'a2wl_apply_pricing_rules', 'type':type,'scope':'import', 'import_page':page};
        ...
        function a2wl_apply_shop_pricing_rules(type, page, on_done_calback){
            var data = {'action': 'a2wl_apply_pricing_rules', 'type':type,'scope':'shop', 'page':page};
            jQuery.post(ajaxurl, data).done(function (response) {
                var json = jQuery.parseJSON(response);
                if(json.state==='ok'){
                    $(".modal-apply-pricing-rules .status").html(json.info);
            ...
            if (use_extended_price_markup) {
                ...
                if (check_price_rules()) {
                    ...
                    if ($('.js-advanced-prices table .input-group.has-error').length === 0) {
                        if (check_cents()) {
                            var data = {'action': 'a2wl_update_price_rules', 

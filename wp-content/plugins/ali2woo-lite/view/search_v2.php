                ...
                <div class="search-panel-advanced" <?php if ($adv_search): ?>style="display: block;"<?php endif; ?>>
                    <div class="search-panel-row">
                        ...
                        <div class="search-panel-col size-2-3">
                            <label><?php _e("Special filters", 'ali2woo-lite'); ?></label>
                            <div class="container-flex flex-wrap">
                                <div class="opt">
                                    <label for="a2wl_freeshipping"><?php _e("Free shipping", 'ali2woo-lite'); ?></label>
                                ...
                                <div class="opt">
                                    <label for="a2wl_return"><?php _e("Free return", 'ali2woo-lite'); ?></label>
                                ...
                                <div class="opt">
                                    <label for="a2wl_popular"><?php _e("Popular products", 'ali2woo-lite'); ?></label>

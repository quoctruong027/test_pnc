...
if (!function_exists('a2wl_error_handler')) {
    ...
    function a2wl_error_handler($errno, $errstr, $errfile, $errline) {
        ...
        a2wl_error_log(strip_tags("$typestr: " . $errstr . " in " . $errfile . " on line " . $errline));
...
if (!function_exists('a2wl_init_error_handler')) {
    ...
    function a2wl_init_error_handler() {
        $old_error_handler = set_error_handler('a2wl_error_handler');
...
if (!function_exists('a2wl_remote_get')) {
    ...
    function a2wl_remote_get($url, $args = array()) {
        ...
        try {
            ...
            if (function_exists('mbstring_binary_safe_encoding')) {
                ...
                a2wl_error_log('WARNING! function mbstring_binary_safe_encoding is not exist!');
            }

            $requests_response = Requests::get($url, $headers, $args);

            // Convert the response into an array
            $http_response = new A2WL_Requests_Response($requests_response);
            ...
            if (function_exists('reset_mbstring_encoding')) {
                ...
                a2wl_error_log('WARNING! function reset_mbstring_encoding is not exist!');
            }
...
if (!function_exists('a2wl_remote_post')) {
    ...
    function a2wl_remote_post($url, $data = array(), $args = array()) {
        $def_args = array('headers' => array('Accept-Encoding' => ''), 'timeout' => 30, 'useragent' => 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:60.0) Gecko/20100101 Firefox/60.0', 'verify' => false, 'sslverify' => false, 'verifyname' => false);
...
if (!function_exists('a2wl_set_transient')) {
    ...
    function a2wl_set_transient($transient, $value, $expiration = 0, $use_cache = false) {
...
if (!function_exists('a2wl_image_url')) {
    function a2wl_image_url($image_url) {
        if(a2wl_get_setting('use_cdn', false)){
            return A2WL()->plugin_url() . '/includes/cdn.php?url=' . $image_url;
        }else{
            return $image_url;
        }
    }
...
if (!function_exists('a2wl_error_log')) {
    function a2wl_error_log($message) {
        A2WL_Logs::getInstance()->write($message);
        error_log($message);
    }
}
...
if (!function_exists('a2wl_print_throwable')) {
    function a2wl_print_throwable($throwable) {
        a2wl_error_log('PHP Error:  '.$throwable->getMessage().' in '.$throwable->getFile().':'.$throwable->getLine().PHP_EOL.'Stack trace:'.PHP_EOL.$throwable->getTraceAsString());
    }
}

...
/**
 * Description of A2WL_WooCommerceOrderItem
 *
 * @author MA_GROUP
 */
if (!class_exists('A2WL_WooCommerceOrderItem')):

	class A2WL_WooCommerceOrderItem {
		private $orderItem;
        ...
        public function get_A2WL_ShippingTitle()
        {
            $shipping_title= '';
        ...
        public function get_A2WL_ShippingCode()
        {
            $shipping_code= '';

            if (isset($this->orderItem['item_meta']['a2wl_shipping_code'])) {

                if (is_array($this->orderItem['item_meta']['a2wl_shipping_code'])) {
                    $shipping_code = $this->orderItem['item_meta']['a2wl_shipping_code'][0];
                } else {
                    $shipping_code = $this->orderItem['item_meta']['a2wl_shipping_code'];
                }
            }

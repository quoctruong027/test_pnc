...
/* * class
 * Description of A2WL_AbstractController
 *
 * @author andrey
 * 
 * @position: 1
...
if (!class_exists('A2WL_AbstractController')) {

    abstract class A2WL_AbstractController {
        private $model = array();
        private $views = array();
        ...
        public function show_view() {
            ...
            foreach ($this->views as $v) {
                ...
                $theme_view_path = get_template_directory() . '/ali2woo-lite/';

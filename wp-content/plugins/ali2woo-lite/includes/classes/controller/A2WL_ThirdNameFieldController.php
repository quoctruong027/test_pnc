...
/**
 * Description of A2WL_ThirdNameFieldController
 *
 * @author Mikhail
 * 
 * @autoload: a2wl_init
 */
if (!class_exists('A2WL_ThirdNameFieldController')) {

    class A2WL_ThirdNameFieldController {
        
        private $third_name_key = 'third_name';

        public function __construct() {
            
            if (a2wl_get_setting('order_third_name')){
        ...
        public function add_field_to_checkout($address_fields) {
            ...
            $thrid_name_field =  array(
                'label'     => __('Middle name', 'ali2woo-lite'),
                'required'  => true,

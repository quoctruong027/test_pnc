...
/**
 * Description of A2WL_AttachmentController
 *
 * @author Andrey
 * 
 * @autoload: a2wl_init
 */
if (!class_exists('A2WL_AttachmentController')) {

    class A2WL_AttachmentController {
        ...
        function get_attachment_url($url, $id) {
            ...
            if (!get_post_meta($id, '_wp_a2wl_attached_file', true)) {
                return $url;
            }
        ...
        function calculate_image_srcset($sources, $size_array, $image_src, $image_meta, $attachment_id) {
            // if not a2w attached return to default function
            if (!$sources || !get_post_meta($attachment_id, '_wp_a2wl_attached_file', true)) {
                return $sources;
            }

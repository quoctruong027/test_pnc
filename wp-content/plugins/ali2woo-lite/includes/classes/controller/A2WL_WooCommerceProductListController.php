<?php
/* * class
 * Description of A2WL_WooCommerceProductListController
 *
 * @author MA_GROUP
 * 
 * @autoload: a2wl_init
 */
if (!class_exists('A2WL_WooCommerceProductListController')) {

    class A2WL_WooCommerceProductListController {
        ...
        function assets() {
            ...
            wp_localize_script('a2wl-wc-pl-script', 'a2wl_wc_pl_script', 
                array('lang' => $lang_data, 
                      'lang_cookies'=>A2WL_AliexpressLocalizator::getInstance()->getLocaleCookies(false),

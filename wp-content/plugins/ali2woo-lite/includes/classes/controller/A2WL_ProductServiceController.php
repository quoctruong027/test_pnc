<?php
/**
 * Description of A2WL_ProductServiceController
 *
 * @author Andrey
 * 
 * @autoload: a2wl_init
 */
if (!class_exists('A2WL_ProductServiceController')) {

    class A2WL_ProductServiceController {
        ...
        public function delete_post_action($post_id) {
            ...
            A2WL_Utils::delete_post_images($post_id);
        ...
        public function woocommerce_after_add_to_cart_form() {
            ...
            if ($product && $product->is_type('external')):
                ?><script id="a2wl_external_fix">jQuery('input[name="ulp"]').val(jQuery('input[name="ulp"]').val().split('{dot}').join('.'));jQuery('#a2wl_external_fix').remove();</script><?php
            endif;
        }*/

...
/**
 * Description of A2WL_ReviewBackendController
 *
 * @author MA_GROUP
 * 
 * @autoload: true
 */
if (!class_exists('A2WL_ReviewBackendController')) {

    class A2WL_ReviewBackendController {
        ...
        public function row_actions($actions, $comment) {
            if (A2WL_Review::get_comment_photos($comment->comment_ID)) {
        ...
        public function ajax_remove_reviews() {
            ...
            try {
                $comments = A2WL_Review::get_all_review_ids();
                A2WL_Review::remove_reviews_by_ids($comments);
        ...
        public function ajax_remove_product_reviews(){
            ...
            if (!$post_id) {
                echo json_encode(A2WL_ResultBuilder::buildError("Product related with this ID not found"));
                wp_die();
            }
            ...
            try {
                ...
                $comments = A2WL_Review::get_product_review_ids($post_id);
                A2WL_Review::remove_reviews_by_ids($comments);
                restore_error_handler();
            } catch (Throwable $e) {
                a2wl_print_throwable($e);
        ...
        public function ajax_get_comment_photos() {
            ...
            $photos = A2WL_Review::get_comment_photos($comment_id);
            if ($photos) {
        ...
        public function ajax_save_comment_photos() {
            ...
            if (is_numeric($comment_id) && is_array($photos)) {
                ...
                A2WL_Review::save_comment_photos($comment_id, $photos);
            } else {
                $result['state'] = 'error';

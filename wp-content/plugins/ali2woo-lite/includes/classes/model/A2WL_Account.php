...
/**
 * Description of A2WL_Account
 *
 * @author Andrey
 */
if (!class_exists('A2WL_Account')) {
    ...
    class A2WL_Account {
        ...
        protected function __construct() {
            $this->account_type = a2wl_get_setting('account_type');
            $this->custom_account = a2wl_get_setting('use_custom_account');
            $this->account_data = a2wl_get_setting('account_data');
        }
        
        public function set_account_type($account_type) {
            $this->account_type = $account_type;
            a2wl_set_setting('account_type', $this->account_type);
        }

        public function use_custom_account($use_custom_account = false) {
            $this->custom_account = $use_custom_account;
            a2wl_set_setting('use_custom_account', $this->custom_account);
        }
        ...
        public function save_aliexpress_account($appkey, $secretkey, $trackingid) {
            ...
            a2wl_set_setting('account_data', $this->account_data);
        }
        ...
        public function build_params(){
            if (a2wl_check_defined('A2WL_ITEM_PURCHASE_CODE')) {
                $item_purchase_code = A2WL_ITEM_PURCHASE_CODE;
            }else{
                $item_purchase_code = a2wl_get_setting('item_purchase_code');
            }
        ...
        public function is_activated(){
            $item_purchase_code = a2wl_check_defined('A2WL_ITEM_PURCHASE_CODE')?A2WL_ITEM_PURCHASE_CODE:a2wl_get_setting('item_purchase_code');

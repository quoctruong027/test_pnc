...
if (!class_exists('A2WL_Json_Api_Configurator')) {
class A2WL_Json_Api_Configurator {

    private function __construct() { }

    public static function init($root_menu_slug) {
        $configurator = new A2WL_Json_Api_Configurator();
    ...
    public function activation() {
        ...
        global $wp_rewrite;
        add_filter('rewrite_rules_array', array(new A2WL_Json_Api_Configurator(),'json_api_rewrites'));
    ...
    function json_api_init() {
        ...
        $a2wl_json_api = new A2WL_JSON_API(empty($this->root_menu_slug)?'':$this->root_menu_slug);
    }
    ...
    function json_api_class_warning() {
        echo "<div id=\"json-api-warning\" class=\"updated fade\"><p>Oops, A2WL_JSON_API class not found. If you've defined a A2WL_JSON_API_DIR constant, double check that the path is correct.</p></div>";
    }

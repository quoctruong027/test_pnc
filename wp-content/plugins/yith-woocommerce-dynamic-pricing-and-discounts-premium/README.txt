...
== Changelog ==
= 1.7.2 - Released on 4 Nov 2020 =
* New: Support for WordPress 5.6
* New: Support for WooCommerce 4.7
* Update: Plugin Framework
* Fix: Fixed some php warnings

= 1.7.1 - Released on 13 Oct 2020 =
* New: Support for WooCommerce 4.6
* Update: Plugin Framework

= 1.7.0 - Released on 17 Sep 2020 =
* New: Support for WooCommerce 4.5
* Update: Plugin Framework
* Fix: Fixed variable products with the same price issue
* Fix: Quantity table and Visual Composer

= 1.6.9 - Released on 24 Aug 2020 =
* Update: Plugin Framework
* Fix: Fixed issues with YITH WooCommerce Membership

= 1.6.8 - Released on 11 Aug 2020 =
* Update: Plugin Framework
* Fix: Issue on related products

= 1.6.7 - Released on 10 Aug 2020 =
* New: Support for WordPress 5.5
* New: Support for WooCommerce 4.4
* Update: Plugin Framework
* Fix: issue with showing discounted price in cart if taxes are enabled
* Fix: issue with hiding discounted price on related products if "show in loop" option is turned off on single product page
* Fix: Integration with YITH Subscription 2.0.3
* Dev: New filters 'yith_ywdpd_get_price_exclusion_rule' and 'ywdpd_table_orientation'

= 1.6.6 - Released on 8 June 2020 =
* Fix: Fixed issue with percentage amount
* Fix: Fixed Exclusion rule issues

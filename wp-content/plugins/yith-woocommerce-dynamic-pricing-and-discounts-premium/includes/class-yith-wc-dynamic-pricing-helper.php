		...
		public function validate_apply_to( $key_rule, $rule, $cart_item_key, $cart_item ) {
			...
			if ( $is_valid ) {
				...
				if ( version_compare( WC()->version, '4.4.0', '<' ) ) {
					...
					$discount['default_price'] = ( WC()->cart->get_tax_price_display_mode() === 'excl' ) ? yit_get_price_excluding_tax( $product ) : yit_get_price_including_tax( $product );
				}

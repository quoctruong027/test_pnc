...
if ( ! class_exists( 'XT_Framework_System_Status' ) ) {
	...
	class XT_Framework_System_Status {
		...
		public function __construct( &$core ) {
			...
			$this->core->framework_loader()->add_filter( $this->core->framework_prefix( 'admin_tabs' ), $this, 'add_system_status_tab', 1, 1 );
			$this->core->framework_loader()->add_filter( $this->core->framework_prefix( 'global_menu_badges'), $this, 'global_menu_badges', 1, 1 );
			$this->core->framework_loader()->add_action( 'admin_init', $this, 'check_system_status' );
			$this->core->framework_loader()->add_action( 'upgrader_process_complete', $this, 'flush_cache', 10, 2 );
			$this->core->framework_loader()->add_action( 'after_switch_theme', $this, 'flush_cache', 10, 2 );
        ...
        public function flush_cache($flushSystemInfo = true) {
		    ...
		    if($flushSystemInfo) {
                delete_transient('xt_framework_system_info');
            }
		...
		public function enqueue_assets() {
			...
			wp_enqueue_script( $this->core->framework_prefix('jquery-tiptip'), xtfw_dir_url( XTFW_DIR_ASSETS ) . '/js/jquery.tiptip'.XTFW_SCRIPT_SUFFIX.'.js', array( 'jquery' ), XTFW_VERSION, true );
			wp_add_inline_script( $this->core->framework_prefix('jquery-tiptip'), "
				...
				<?php if ( ! isset( $_GET['xt-framework-phpinfo'] ) || $_GET['xt-framework-phpinfo'] != 'true' ): ?>
                    ...
                    <?php if($this->core->has_modules()):?>
                        <table class="widefat striped xt-plugins-table">
                            <thead>
                                <tr>
                                    <th>
                                        <?php echo esc_html('Module Name', 'xt-framework');?>
                                    </th>
                                    <th>
                                        <?php echo esc_html('Loaded From', 'xt-framework');?>
                                    </th>
                                    <th>
                                        <?php echo esc_html('Shared By', 'xt-framework');?>
                                    </th>
                                </tr>
                            </thead>
                            <tbody>
                            <?php foreach ( $this->core->modules()->all() as $module ) : ?>
                                <tr>
                                    <th class="requirement-name">
                                        <a href="<?php echo $module->admin_url(); ?>">
                                            <?php echo $module->name(); ?>
                                        </a>
                                    </th>
                                    <td class="requirement-value hide-on-mobile">
                                        <?php echo str_replace(WP_PLUGIN_DIR, "", $module->path()); ?>
                                    </td>
                                    <td class="requirement-value">
                    ...
                    <table class="widefat striped active-theme" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td style="width: 3%" class="help"><?php echo xtfw_help_tip( esc_html__( 'The name of the current active theme.', 'xt-framework') ); /* phpcs:ignore WordPress.XSS.EscapeOutput.OutputNotEscaped */ ?></td>
                        ...
                        <tr>
                            ...
                            <td class="help"><?php echo xtfw_help_tip( esc_html__( 'The installed version of the current active theme.', 'xt-framework') ); /* phpcs:ignore WordPress.XSS.EscapeOutput.OutputNotEscaped */ ?></td>
                            <td>
								<?php
                        ...
                        <tr>
                            ...
                            <td class="help"><?php echo xtfw_help_tip( esc_html__( 'The theme developers URL.', 'xt-framework') ); /* phpcs:ignore WordPress.XSS.EscapeOutput.OutputNotEscaped */ ?></td>
                        ...
                        <tr>
                            ...
                            <td class="help"><?php echo xtfw_help_tip( esc_html__( 'Displays whether or not the current theme is a child theme.', 'xt-framework') ); /* phpcs:ignore WordPress.XSS.EscapeOutput.OutputNotEscaped */ ?></td>
                            <td>
								<?php
						...
						<?php if ( $this->_theme['is_child_theme'] ) : ?>
                            <tr>
                                ...
                                <td class="help"><?php echo xtfw_help_tip( esc_html__( 'The name of the parent theme.', 'xt-framework') ); /* phpcs:ignore WordPress.XSS.EscapeOutput.OutputNotEscaped */ ?></td>
                            ...
                            <tr>
                                ...
                                <td class="help"><?php echo xtfw_help_tip( esc_html__( 'The installed version of the parent theme.', 'xt-framework') ); /* phpcs:ignore WordPress.XSS.EscapeOutput.OutputNotEscaped */ ?></td>
                                <td>
									<?php
                            ...
                            <tr>
                                ...
                                <td class="help"><?php echo xtfw_help_tip( esc_html__( 'The parent theme developers URL.', 'xt-framework') ); /* phpcs:ignore WordPress.XSS.EscapeOutput.OutputNotEscaped */ ?></td>
                        ...
                        <tr>
                            ...
                            <td class="help"><?php echo xtfw_help_tip( esc_html__( 'Displays whether or not the current active theme declares WooCommerce support.', 'xt-framework') ); /* phpcs:ignore WordPress.XSS.EscapeOutput.OutputNotEscaped */ ?></td>
                            <td>
								<?php
                    ...
                    <h3 id="template-overrides">
                        ...
                        <span class="info-link">
                            <a href="https://docs.xplodedthemes.com/article/127-template-structure" target="_blank">
                                <?php echo xtfw_help_tip(esc_html__( 'Click here to learn how to override plugin templates within your theme', 'xt-framework')); ?>
                            </a>
                        </span>
                        <?php if ( $this->_theme['templates']['outdated'] > 0) : ?>
                    ...
                    <?php if ( ! empty( $this->_theme['templates']['overrides'] ) ) :

                        foreach ($this->_theme['templates']['overrides'] as $plugin_name => $data) : ?>
                        <table class="widefat striped template-overrides" cellspacing="0">
                            <thead>
                                <tr>
                                    <th class="requirement-name" style="width: 25%;font-weight: bold;vertical-align: top;" data-export-label="Overrides">
                                        ...
                                        <?php if(!empty($data['outdated'])): ?>
                                            <mark class="error"><?php echo sprintf( _n( '%s outdated template', '%s outdated templates', $data['outdated'], 'xt-framework' ), number_format_i18n( $data['outdated'] ) ); ?> </mark>
                                        <?php endif; ?>

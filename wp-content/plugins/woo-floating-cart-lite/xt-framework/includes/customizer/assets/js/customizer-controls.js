...
( function ( api, $ ) {
    ...
    api.bind("ready", function() {
        ...
        // Disable transitions while using Xirki slider
        $(document.body).on('mouseenter', '.customize-control-xirki-slider', function() {
            $('html').addClass('xtfw-no-transitions');
        });
        $(document.body).on('mouseleave', '.customize-control-xirki-slider', function() {
            $('html').removeClass('xtfw-no-transitions');
        });

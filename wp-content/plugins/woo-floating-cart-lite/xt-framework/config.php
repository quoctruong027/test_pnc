...
if ( ! defined( 'XTFW_DIR_PLUGIN_SETTINGS' ) ) {
	define( 'XTFW_DIR_PLUGIN_SETTINGS', XTFW_DIR_INCLUDES . '/plugin-settings' );
}
if ( ! defined( 'XTFW_DIR_PLUGIN_SETTINGS_ASSETS' ) ) {
	define( 'XTFW_DIR_PLUGIN_SETTINGS_ASSETS', XTFW_DIR_PLUGIN_SETTINGS . '/assets' );
}

		...
		public function __construct() {
			if ( 'yes' === get_wc_pif_option( 'enabled', 'yes' ) ) {
				...
				if ( 'disable' !== $position ) {
                    ...
                    add_action( 'add_input_field', array( $this, 'add_before_product_input_fields_to_frontend' ), $priority );
				}
				...
				if ( 'disable' !== $position ) {
                    ...
                    add_action( 'add_input_field', array( $this, 'add_after_product_input_fields_to_frontend' ), $priority );
				}

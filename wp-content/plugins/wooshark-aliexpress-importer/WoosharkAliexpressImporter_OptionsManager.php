...
class WoosharkAliexpressImporter_OptionsManager
{
    ...
    public function settingsPage()
    {
        ...
        ?>
            ...
            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist" style="padding-top:5px;margin-top:8px; background-color:5px; background-color:#626ca4; border-top-left-radius:10px; border-top-right-radius:14px">
                <li class="nav-item active">
                    <a class="nav-link active" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true">AliExpress import</a>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link" id="go-pro-tab" data-toggle="pill" href="#go-pro" role="tab" aria-controls="go-pro" aria-selected="true" style="color:red">Go Pro </a>
                </li>
            ...
            <div class="tab-content" id="pills-tabContent" style="background-color:#f3f5f6">
                    ...
                    <div class="wrap">
                        ...
                        <div style="margin-top:10px; background-color:white" class="alert alert-danger alert-dismissible fade show" role="alert" id="section-2">
                            ...
                            <div class="alert alert-default alert-dismissible fade show" role="alert" id="section-1" style="text-align:right; ">
                                ...
                                <strong style="FONT-SIZE: 2REM;">Save time and efforts by getting the chrome extension from here <a targer="_blank" href="https://chrome.google.com/webstore/detail/wooshark-for-aliexpress-w/djllcpoailebhlpeligendbbhommfnin"> <i class="fas fa-download fa-1x"></i> </a></strong>
                ...
                <div class="tab-pane fade" id="go-pro" role="tabpanel" aria-labelledby="go-pro-products">
                    ...
                    <button class="btn btn-primary" style="width:20%; margin-left:40%; margin-top:15px; "><a class="fa fa-star fa-3x" style="color:white" href="https://wooshark.com/aliexpress" target="_blank"> GO PRO from here</a> </button>

...
class StatusChange extends Base {
	...
	public function __construct() {
		...
		$this->trigger_description = sprintf( __( 'Advanced: triggers every time an order changes status.<br />Consider using with a Filter.<br />See the <a href="%1$s" target="_blank">Advanced Zaps documentation</a> for more information.', 'woocommerce-zapier' ), 'https://om4.io/woocommerce-zapier-documentation/legacy/#advanced-zaps' );

...
use OM4\WooCommerceZapier\Plugin\Subscriptions\ResourceDefinition as SubscriptionsResource;
		...
		$this->container->add(
			...
			function() {
				return new SubscriptionsPlugin(
					$this->container->get( FeatureChecker::class ),
					$this->container->get( Logger::class ),
					$this->container->get( SubscriptionsResource::class )
				);
			}
		);
		...
		$this->container->add(
			...
			function () {
				return new ListTable(
					$this->container->get( TaskDataStore::class ),
					$this->container->get( WebhookTopics::class ),
					$this->container->get( FeatureChecker::class ),
					$this->container->get( ResourceManager::class )
				);
			}

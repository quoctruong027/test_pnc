...
class Plugin {
	...
	const MINIMUM_SUPPORTED_WOOCOMMERCE_VERSION = '3.5.0';

	/** URL to the documentation for this plugin. */
	const DOCUMENTATION_URL = 'https://om4.io/woocommerce-zapier-documentation/';
	...
	public function before_woocommerce_init() {
		...
		$this->container->get( WebhookTopics::class )->initialise();
	}

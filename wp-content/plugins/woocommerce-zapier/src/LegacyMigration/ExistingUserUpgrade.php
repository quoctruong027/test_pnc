...
class ExistingUserUpgrade {
	 ...
	 */
	const MIGRATION_GUIDE_URL = 'https://om4.io/woocommerce-zapier-documentation/migration/';
	 ...
	 */
	const MIGRATION_DEADLINE = '30 April 2021';
	 ...
	 */
	public function __construct( Logger $logger, Settings $settings, WordPressDB $wp_db, UpgradedToVersion2Notice $upgraded_to_v2_notice, LegacyFeedsDeletedNotice $legacy_feeds_deleted_notice ) {
		$this->logger                      = $logger;

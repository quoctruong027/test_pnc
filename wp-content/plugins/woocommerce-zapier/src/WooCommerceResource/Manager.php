...
use OM4\WooCommerceZapier\WooCommerceResource\Coupon\ResourceDefinition as CouponResource;
use OM4\WooCommerceZapier\WooCommerceResource\Customer\ResourceDefinition as CustomerResource;
use OM4\WooCommerceZapier\WooCommerceResource\Order\ResourceDefinition as OrderResource;
use OM4\WooCommerceZapier\WooCommerceResource\Product\ResourceDefinition as ProductResource;
use ReflectionClass;
...
class Manager {
	...
	public function initialise() {
		 ...
		 * @since 2.0.0
		 *
		 * @param string[] $additional_resources Array of fully qualified class name(s).
		 */
	...
	/**
	 * Get the Resource Definition for the specified resource name.
	 *
	 * @param string $resource_type Resource key/type (coupon, customer, order, etc).
	 *
	 * @return Base|false Resource definition, or false if resource definition doesn't exist.
	 */

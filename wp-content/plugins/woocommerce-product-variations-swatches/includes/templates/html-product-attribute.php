...
<div data-taxonomy="<?php echo esc_attr( $attribute->get_taxonomy() ); ?>"
     class="woocommerce_attribute vi-wpvs-attribute-wrap wc-metabox closed <?php echo esc_attr( $metabox_class ); ?>" rel="<?php echo esc_attr( $attribute_position ); ?>">
    <h3>
        <a href="#" class="remove_row delete vi-wpvs-attribute-row-remove"><?php esc_html_e( 'Remove', 'woocommerce-product-variations-swatches' ); ?></a>
        <div class="handlediv" title="<?php esc_attr_e( 'Click to toggle', 'woocommerce-product-variations-swatches' ); ?>"></div>
        <div class="tips sort" data-tip="<?php esc_attr_e( 'Drag and drop to set admin attribute order', 'woocommerce-product-variations-swatches' ); ?>"></div>
        ...
        <div class="vi-wpvs-attribute-content vi-wpvs-attribute-content-taxonomy">
            <div class="vi-wpvs-attribute-info-wrap">
                ...
                <div class="enable_variation show_if_variable">
                    <label>
                        <input type="checkbox" class="checkbox" <?php checked( $attribute->get_variation(), true ); ?> name="attribute_variation[<?php echo esc_attr( $i ); ?>]" value="1"/>
            ...
            <div class="vi-wpvs-attribute-value-wrap-wrap">
				...
				if ( $all_terms ) {
					foreach ( $all_terms as $k => $term ) {
						...
						$term_class .= in_array( $term->term_id, $attribute_options ) ? '' : ' vi-wpvs-hidden';
						?>
                        <div class="<?php echo esc_attr( $term_class ); ?>"
                            ...
                            <div class="vi-wpvs-attribute-value-content-wrap vi-wpvs-attribute-value-content-close">
								...
								$term_img_src           = $terms_img_id ? wp_get_attachment_image_url( $terms_img_id, 'woocommerce_thumbnail', true ) : wc_placeholder_img_src();
								?>
                                <div class="vi-wpvs-attribute-value-content-color-wrap <?php echo $vi_attribute_type === 'color' ? '' : esc_attr( 'vi-wpvs-hidden' ) ?>">
                                    <table cellpadding="0" cellspacing="0">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name="vi_attribute_color_separator[<?php echo esc_attr( $i ); ?>][<?php echo esc_attr( $term->term_id ); ?>]"
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <input type="text"
                                                                           ...
                                                                           name="vi_attribute_colors[<?php echo esc_attr( $i ); ?>][<?php echo esc_attr( $term->term_id ); ?>][]"
                                ...
                                <div class="vi-wpvs-attribute-value-content-image-wrap <?php echo $vi_attribute_type === 'image' ? '' : esc_attr( 'vi-wpvs-hidden' ) ?>">
                                    <table cellpadding="0" cellspacing="0">
                                        <tr>
                                            ...
                                            <td>
                                                <input type="hidden"
                                                       name="vi_attribute_images[<?php echo esc_attr( $i ); ?>][<?php echo esc_attr( $term->term_id ); ?>]"
							...
							<?php
							if ( in_array( $term->term_id, $attribute_options ) ) {
								?>
            ...
            <div class="vi-wpvs-attribute-content">
                ...
                <div class="vi-wpvs-attribute-info-wrap vi-wpvs-attribute-info-custom-wrap vi-wpvs-hidden">
                    ...
                    <div class="vi-wpvs-attribute-profile">
                        <select name="vi_attribute_profile[<?php echo esc_attr( $i ); ?>]" title="<?php esc_attr_e( 'Choose swatches profile', 'woocommerce-product-variations-swatches' ); ?>">
                            <option value="0" <?php selected( $vi_attribute_profile, '0' ) ?>>
								<?php esc_html_e( 'Global profile', 'woocommerce-product-variations-swatches' ); ?>
                            </option>
							<?php
                                                ...
                                                <td>
                                                    <table cellspacing="0" cellpadding="0"
														...
														if ( $attribute_colors && is_array( $attribute_colors ) && count( $attribute_colors ) ) {
															...
															$attribute_color = isset( $vi_default_colors[ strtolower( $attribute_option ) ] ) ? $vi_default_colors[ strtolower( $attribute_option ) ] : '';
															?>
                                                            <tr>
                                                                <td>
                                                                    <input type="text"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="vi-attribute-image-wrap vi-attribute-edit-image-wrap vi-wpvs-term-image-upload-img">
                                                        <span class="vi-attribute-edit-image-preview vi-attribute-image-preview">
                                                            <?php
                                                            echo $attribute_img_id ? wp_kses_post( wp_get_attachment_image( $attribute_img_id ) ) : wp_kses_post( wc_placeholder_img() );
                                                            ?>
                                                        </span>
                                                        <div><?php esc_html_e( 'Upload / Add image', 'woocommerce-product-variations-swatches' ); ?></div>
                                                    </div>

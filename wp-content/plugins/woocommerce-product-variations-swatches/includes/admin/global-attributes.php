...
class VIWPVS_WOOCOMMERCE_PRODUCT_VARIATIONS_SWATCHES_Admin_Global_Attributes {
	...
	public function global_attribute_edit_form_fields() {
		...
		switch ( $attribute_type ) {
			case 'color':
				$terms_color = isset( $vi_wpvs_terms_settings['color'] ) ? $vi_wpvs_terms_settings['color'] : array();
                ...
                <tr class="form-field term-description-wrap vi-wpvs-swatches-setting-wrap">
                    <th scope="row">
			...
			case 'image':
                ...
                <tr class="form-field term-description-wrap vi-wpvs-swatches-setting-wrap">
                    ...
                    <td>
                        <input type="hidden" name="vi_wpvs_term_image" id="vi_wpvs_term_image"
                        ...
                        <div class="vi-wpvs-term-image-wrap vi-wpvs-term-edit-image-wrap vi-wpvs-term-image-upload-img">
	                        <span class="vi-wpvs-term-edit-image-preview vi-wpvs-term-image-preview">
                                <?php
                                if ( $terms_img ) {
	                                echo wp_kses_post( wp_get_attachment_image( $terms_img ) );
                                } else {
			...
			case 'image':
                ...
                <div class="vi-wpvs-swatches-setting-wrap">
                    ...
                    <div class="form-field term-description-wrap">
                        ...
                        <input type="hidden" name="vi_wpvs_term_image" id="vi_wpvs_term_image" value="">

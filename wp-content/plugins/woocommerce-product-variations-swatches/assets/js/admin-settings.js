    ...
    function handleCheckBox() {
        ...
        jQuery('input[type="checkbox"]').unbind().on('change', function () {
            if (jQuery(this).prop('checked')) {
                ...
                if (jQuery(this).hasClass('vi-wpvs-product-list-add-to-cart-checkbox')) {
                    jQuery('.vi-wpvs-product-list-atc-enable').removeClass('vi-wpvs-hidden');
                }
                if (jQuery(this).hasClass('vi-wpvs-product-list-more-link-enable-checkbox')) {
                    jQuery('.vi-wpvs-product-list-more-link-enable').removeClass('vi-wpvs-hidden');
                }
                if (jQuery(this).hasClass('vi-wpvs-product_list_slider-checkbox')) {

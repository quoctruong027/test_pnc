...
jQuery(document).ready(function () {
    ...
    jQuery('#product_attributes > .toolbar-top').append('<button class="button primary vi_wpvs_global_setting_url"><a href="' + viwpvs_admin_custom_attribute.global_setting_url + '" target="_blank">' + viwpvs_admin_custom_attribute.global_setting_title + '</a></button>');

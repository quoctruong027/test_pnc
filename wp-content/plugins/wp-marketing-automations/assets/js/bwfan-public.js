...
(function ($) {
    ...
    BWFAN_Public = {
        ...
        bwfan_process_email: function (email = '') {
            if (('0' == bwfanParamspublic.bwfan_ab_enable)) {
                return;
            }
    ...
    BWFAN_Public.unsubscribe_event = function () {
        $('#bwfan_unsubscribe').on('click', function (event) {
            ...
            if (0 === recipient.length || 0 === automation_id.length) {
                return;
            }
    ...
    $(document).ready(function () {
        if ('0' != bwfanParamspublic.bwfan_ab_enable) {
            ...
            if ('0' != bwfanParamspublic.bwfan_ab_email_consent) {
            ...
            $(document).on('blur change', '#billing_email,.input-text', BWFAN_Public.bwfan_get_checkout_data);
        }
    });

...
?>
            ...
            <div class="bwfan-row">
                <div class="bwfan-input-form clearfix">
                    <div class="bwfan-col-sm-12">
                        <label for="" class="bwfan-label-title"><?php esc_html_e( 'Which Event should run this Automation?', 'wp-marketing-automations' ); ?></label>
                    </div>
                    <div class="bwfan-input-form clearfix bwfan-mb-0">
                        <div class="bwfan-col-sm-12">
                            <select required id="" class="bwfan-input-wrapper bwfan-selected-source" name="source">
    ...
    <script type="text/html" id="tmpl-single-event">
        <div class="clearfix">
            <div class="bwfan-row">
                <div class="bwfan-input-form clearfix bwfan-mt-15">
                    <div class="bwfan-input-form bwfan-mb20 clearfix">
                        <div class="bwfan-col-sm-12">
                            <select required id="" class="bwfan-input-wrapper bwfan-selected-trigger" name="event">
                    ...
                    <div class="bwfan-input-form bwfan-row-sep bwfan-mb0"></div>
                    <div class="bwfan-input-form bwfan-mb0 clearfix">
                        <div class="bwfan-col-sm-12">

...
$heading = __( 'Scheduled Tasks', 'wp-marketing-automations' );
$status  = filter_input( INPUT_GET, 'status' );
$table   = new BWFAN_Tasks_Table();
?>
    <div class="wrap bwfan_global bwfan_global_settings bwfan_page_tasks">
        ...
        <div class="bwfan_heading_inline"><?php esc_html_e( $heading ); ?></div>
        <div id="poststuff">
            <div class="inside">
                <div class="bwfan_clearfix">
                    <div class="bwfan_page_left_wrap">
                        <form action="" method="get">
							...
							$table->data = $table->get_tasks_table_data();
							$table->prepare_items();
							$table->display();
							?>

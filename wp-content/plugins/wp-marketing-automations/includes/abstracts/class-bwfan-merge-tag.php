...
abstract class BWFAN_Merge_Tag {
	...
	public function get_preview() {
		?>
        <textarea class="bwfan-preview-merge-tag bwfan-input-wrapper" readonly></textarea>
		<?php
	...
	public function get_copy_button() {
		?>
        <span class="bwfan-use-merge-tag"><?php esc_html_e( 'Copy To Clipboard', 'wp-marketing-automations' ); ?></span>

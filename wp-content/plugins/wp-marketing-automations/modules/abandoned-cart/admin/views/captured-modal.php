...
?>
<script type="text/template" id="tmpl-bwfan-abandoned-popup">
    ...
    <div id="bwfan-abandoned-section ">
        ...
        <table cellspacing="0" class="bwfan-abandoned-items-table" dir="<?php echo is_rtl() ? 'rtl' : 'ltr'; ?>">
            ...
            <tr>
                ...
                <td>
                    {{data.currency}}{{data.discount}} <?php echo ( bwfan_is_woocommerce_active() && wc_tax_enabled() ) ? esc_html( '(inc.tax)', 'wp-marketing-automations' ) : ''; ?>
                </td>
            </tr>
            <# }
            #>
            <tr>
                <td colspan="2" style="<?php echo is_rtl() ? 'text-align:right;' : 'text-align:left;'; ?>">Total:</td>
...
<div class="bwfan_izimodal_default" style="display: none" id="modal-show-abandoned-cart-details">

...
class WFACP_Compatibility_With_WC_Parcel {
	...
	public function __construct() {
		...
		add_action( 'wfacp_internal_css', [ $this, 'get_instance' ] );
	...
	public function internal_css( $selected_template_slug ) {
		...
		if ( $selected_template_slug === 'embed_forms_2' ) {
			?>

            <style>
                body #wfacp-e-form .wfacp_main_form.woocommerce table.mypa-delivery-option-table {
                    table-layout: unset;
                }

                body #wfacp-e-form .wfacp_main_form.woocommerce #mypa-delivery-option-form table tbody tr > td:first-child {
                    display: table-cell !important;
                    width: 20px !important;
                }

                body #wfacp-e-form .wfacp_main_form.woocommerce #mypa-delivery-option-form label {
        ...
        <style>
            body .wfacp_main_form.woocommerce #mypa-delivery-option-form table {
                border: none;
            }

            body .wfacp_main_form.woocommerce form .form-row-third.first.wfacp-col-left-third.wfacp_wc_parcel {
                width: 33.33%;
                margin-left: 0;
                margin-right: 0;
            }

            div#mypa-delivery-option-form label {
                padding: 0 !important;
            }
            ...
            body .wfacp_main_form.woocommerce form .form-row-third.wfacp-col-left-third.wfacp_wc_parcel {


                margin-right: 0;
            }

            body .wfacp_main_form.woocommerce #mypa-load {
                margin: 0 0 25px;
                padding: 0 12px;;
                clear: both;
            }

            body .wfacp_main_form.woocommerce #mypa-delivery-option-form h1,
            body .wfacp_main_form.woocommerce #mypa-delivery-option-form h2,
            body .wfacp_main_form.woocommerce #mypa-delivery-option-form h3,
            body .wfacp_main_form.woocommerce #mypa-delivery-option-form h4,
            body .wfacp_main_form.woocommerce #mypa-delivery-option-form h5,
            body .wfacp_main_form.woocommerce #mypa-delivery-option-form h6 {
                margin: 0 0 10px;
            }
            ...
            body .wfacp_main_form.woocommerce #mypa-message h3 {
                margin: 0;
                font-size: 18px;
                line-height: 1.5;
            }

            body .wfacp_main_form.woocommerce #mypa-delivery-option-form input[type="radio"] {
                position: relative;
                top: auto;
                margin: 0;
            }

            body .wfacp_main_form.woocommerce #mypa-delivery-option-form label {
                padding-left: 0;
                font-weight: normal;
            }

            body .wfacp_main_form.woocommerce #mypa-delivery-option-form table tbody tr > td:first-child {
                padding-bottom: 0;
            }


            body .wfacp_main_form.woocommerce #mypa-delivery-option-form table tbody tr > td {
                padding-bottom: 10px;
            }

            body .wfacp_main_form.woocommerce #mypa-delivery-option-form table tbody select {
                padding: 10px;
                width: 100%;
            }

            body .wfacp_main_form.woocommerce #mypa-delivery-option-form tr td:first-child {
                vertical-align: top;
            }

            div#mypa-delivery-option-form input[type="checkbox"] {
                position: relative;
                left: auto;
                margin: 0;
                right: auto;
            ...
            @media (min-width: 768px) {
                .wfacp_main_form.woocommerce form .form-row-third:not(.wfacp-col-left-third) {
                    margin-right: 0;
                    width: 50%;
                    float: left;
                }

                body .wfacp_main_form.woocommerce p.form-row.wfacp_house_number,
                body .wfacp_main_form.woocommerce p.form-row.wfacp_house_number_suffix {
                    width: 25%;
                    float: left;
                }
            }

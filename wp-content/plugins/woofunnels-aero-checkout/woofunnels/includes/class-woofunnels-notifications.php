...
class WooFunnels_Notifications {
	...
	public function wf_dismiss_link() {
		...
		if ( ( isset( $_POST['noticeGroup'] ) && $_POST['noticeGroup'] !== '' ) && ( isset( $_POST['noticekey'] ) && $_POST['noticekey'] !== '' ) ) { // phpcs:ignore WordPress.Security.NonceVerification.NoNonceVerification

			$noticeGroup     = sanitize_text_field( $_POST['noticeGroup'] ); // phpcs:ignore WordPress.Security.NonceVerification.NoNonceVerification
			$noticekey       = str_replace( 'wf-', '', sanitize_text_field( $_POST['noticekey'] ) ); // phpcs:ignore WordPress.Security.NonceVerification.NoNonceVerification

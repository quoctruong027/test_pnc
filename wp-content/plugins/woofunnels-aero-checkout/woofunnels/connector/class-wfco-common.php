...
class WFCO_Common {
	...
	public static function get_current_trigger() {
		if ( isset( $_GET['page'] ) && 'autonami' === sanitize_text_field( $_GET['page'] ) && isset( $_GET['status'] ) ) { // phpcs:ignore WordPress.Security.NonceVerification.NoNonceVerification
			return sanitize_text_field( $_GET['status'] ); // phpcs:ignore WordPress.Security.NonceVerification.NoNonceVerification
		}

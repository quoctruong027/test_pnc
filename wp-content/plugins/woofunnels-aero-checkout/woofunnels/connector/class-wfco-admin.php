...
class WFCO_Admin {
	...
	public function is_connector_page( $section = '' ) {
		if ( isset( $_GET['page'] ) && 'autonami' === sanitize_text_field( $_GET['page'] ) && '' === $section ) { // phpcs:ignore WordPress.Security.NonceVerification.NoNonceVerification
			return true;
		}

		if ( isset( $_GET['page'] ) && 'autonami' === sanitize_text_field( $_GET['page'] ) && isset( $_GET['section'] ) && $_GET['section'] === $section ) { // phpcs:ignore WordPress.Security.NonceVerification.NoNonceVerification
			return true;
		}
	...
	public function connector_page() {
		if ( isset( $_GET['page'] ) && 'autonami' === sanitize_text_field( $_GET['page'] ) ) {  // phpcs:ignore WordPress.Security.NonceVerification.NoNonceVerification
	...
	public function maybe_remove_all_notices_on_page() {
		if ( isset( $_GET['page'] ) && 'autonami' === sanitize_text_field( $_GET['page'] ) && isset( $_GET['section'] ) ) {  // phpcs:ignore WordPress.Security.NonceVerification.NoNonceVerification

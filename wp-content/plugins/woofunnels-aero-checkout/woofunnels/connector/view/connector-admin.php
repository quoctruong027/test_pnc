                    ...
                    <div class="wfco_connector_listing_wrap wfco_clearfix">
                        <div class="wfco-row">
                            <form method="GET">
                                ...
                                <input type="hidden" name="status" value="<?php echo( isset( $_GET['status'] ) ? sanitize_text_field( $_GET['status'] ) : '' ); // phpcs:ignore WordPress.Security.NonceVerification.NoNonceVerification ?>"/>
								<?php

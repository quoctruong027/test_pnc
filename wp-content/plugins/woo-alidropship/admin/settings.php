...
class VI_WOO_ALIDROPSHIP_Admin_Settings {
	...
	public function page_callback() {
        ...
        <div class="wrap woo-alidropship">
            <h2><?php esc_html_e( 'Dropshipping and Fulfillment for AliExpress and WooCommerce Settings', 'woo-alidropship' ) ?></h2>
			<?php
            ...
            <form method="post" action="" class="vi-ui form">
                ...
                <div class="vi-ui attached tabular menu">
                    ...
                    <div class="item <?php self::set_params( 'tab-item', true ) ?>" data-tab="product_update">
						<?php esc_html_e( 'Product Updating', 'woo-alidropship' ) ?>
                    </div>
                        ...
                        <tr>
                            <th>
                                <label for="<?php self::set_params( 'download_description_images', true ) ?>">
									<?php esc_html_e( 'Download description images', 'woo-alidropship' ) ?>
                                </label>
                            </th>
                            <td>
                                <div class="vi-ui toggle checkbox">
                                    ...
                                    <label><?php esc_html_e( 'Also download images in product description if any', 'woo-alidropship' ) ?></label>
                                </div>
                            </td>
                        </tr>
                        <tr>
                ...
                <div class="vi-ui bottom attached tab segment" data-tab="price">
                    ...
                    <div class="vi-ui segment">
                        ...
                        <span class="<?php self::set_params( 'price_rule_add', true ) ?> vi-ui button positive tiny"><?php esc_html_e( 'Add', 'woo-alidropship' ) ?></span>
                        <span class="<?php self::set_params( 'price_rule_remove', true ) ?> vi-ui button negative tiny"><?php esc_html_e( 'Remove last level', 'woo-alidropship' ) ?></span>
                    </div>
                    <div class="vi-ui segment">
                        <table class="form-table">
                            <tbody>
                                            ...
                                            <div class="field <?php self::set_params( 'error-message-parent', true ); ?>">
                                                <div class="vi-ui left labeled input fluid">
                                                    ...
                                                    <input
                                                            ...
                                                            min="0"
                                                            value="<?php echo $format_price_rule['from'] ?>"
                                            ...
                                            <div class="field <?php self::set_params( 'error-message-parent', true ); ?>">
                                                <div class="vi-ui left labeled input fluid">
                                                    ...
                                                    <input
                                                            ...
                                                            min="0"
                                                            step="<?php echo esc_attr( $decimals_unit ) ?>"
                                                            value="<?php echo $format_price_rule['to'] ?>"
                                            ...
                                            <div class="field <?php self::set_params( 'error-message-parent', true ); ?>">
                                                <div class="vi-ui <?php echo esc_attr( $label_class ) ?> labeled input fluid">
                                                    ...
                                                    <input
                                                            ...
                                                            step="1"
                                                            min="0"
                                                            value="<?php echo $format_price_rule['value_from'] ?>"
                                            ...
                                            <div class="field <?php self::set_params( 'error-message-parent', true ); ?>">
                                                <div class="vi-ui <?php echo esc_attr( $label_class ) ?> labeled input fluid">
                                                    ...
                                                    <input
                                                            ...
                                                            step="1"
                                                            min="0"
                                                            value="<?php echo $format_price_rule['value_to'] ?>"
                                    ...
                                    <td class="<?php echo esc_attr( self::set( array(
                                        ...
                                        <div class="vi-ui <?php echo esc_attr( $label_class ) ?> labeled input fluid">
                                            <label for="amount"
                                                   class="vi-ui label <?php self::set_params( 'format_price_rules_label_fraction', true ); ?>"><?php echo esc_html__( $label_fraction ) ?></label>
                                            <input type="text"
                                                   value="<?php echo $format_price_rule['value'] ?>"
                ...
                <div class="vi-ui bottom attached tab segment <?php self::set_params( 'tab-content', true ) ?>"
                    ...
                    <div class="vi-ui message positive">
						<?php esc_html_e( 'Config what the plugin will do when you update product manually with the chrome extension', 'woo-alidropship' ) ?>
                    </div>
                    <table class="form-table">
                        <tbody>
                        <tr>
                            <th>
                                <label for="<?php self::set_params( 'update_product_auto', true ) ?>"><?php esc_html_e( 'Update product automatically', 'woo-alidropship' ) ?></label>
                            <td>
                                <a class="vi-ui button" target="_blank"
                                   href="https://1.envato.market/PeXrM"><?php esc_html_e( 'Upgrade This Feature', 'woo-alidropship' ) ?></a>
                            </td>
                ...
                <p class="<?php echo esc_attr( self::set( 'save-settings-container' ) ) ?>">
                    <button type="submit"
                            ...
                            name="<?php echo esc_attr( self::set( 'save-settings', true ) ) ?>"><i
                                class="save icon"></i><?php esc_html_e( 'Save', 'woo-alidropship' ) ?></button>
                </p>
            </form>
